...
#define pp_cxx_cv_qualifier_seq(PP, T)   pp_c_type_qualifier_list(PP, T)
#define pp_cxx_cv_qualifiers(PP, CV, FT) pp_c_cv_qualifiers(PP, CV, FT)
...
#define pp_cxx_tree_identifier(PP, T) pp_c_tree_identifier(PP, T)
