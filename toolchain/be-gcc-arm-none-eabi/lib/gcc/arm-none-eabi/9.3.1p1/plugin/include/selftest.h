...
#define SELFTEST_LOCATION (::selftest::location(__FILE__, __LINE__, __FUNCTION__))
...
extern void fail(const location &loc, const char *msg) ATTRIBUTE_NORETURN;
...
extern void assert_streq(const location &loc, const char *desc_val1, const char *desc_val2,
                         const char *val1, const char *val2);

/* Implementation detail of ASSERT_STR_CONTAINS.  */

extern void assert_str_contains(const location &loc, const char *desc_haystack,
                                const char *desc_needle, const char *val_haystack,
                                const char *val_needle);

/* Implementation detail of ASSERT_STR_STARTSWITH.  */

extern void assert_str_startswith(const location &loc, const char *desc_str,
                                  const char *desc_prefix, const char *val_str,
...
{
      public:
        temp_source_file(const location &loc, const char *suffix, const char *content);
};
...
extern void for_each_line_table_case(void (*testcase)(const line_table_case &));
...
#define ASSERT_TRUE(EXPR) ASSERT_TRUE_AT(SELFTEST_LOCATION, (EXPR))
...
#define ASSERT_FALSE(EXPR) ASSERT_FALSE_AT(SELFTEST_LOCATION, (EXPR))
...
#define ASSERT_EQ(VAL1, VAL2) ASSERT_EQ_AT((SELFTEST_LOCATION), (VAL1), (VAL2))
...
#define ASSERT_KNOWN_EQ(VAL1, VAL2) ASSERT_KNOWN_EQ_AT((SELFTEST_LOCATION), (VAL1), (VAL2))
...
#define ASSERT_MAYBE_NE(VAL1, VAL2) ASSERT_MAYBE_NE_AT((SELFTEST_LOCATION), (VAL1), (VAL2))
...
#define ASSERT_GT(LHS, RHS) ASSERT_GT_AT((SELFTEST_LOCATION), (LHS), (RHS))
...
#define ASSERT_LT(LHS, RHS) ASSERT_LT_AT((SELFTEST_LOCATION), (LHS), (RHS))
...
#define ASSERT_STREQ(VAL1, VAL2)                                                                   \
        SELFTEST_BEGIN_STMT                                                                        \
        ::selftest::assert_streq(SELFTEST_LOCATION, #VAL1, #VAL2, (VAL1), (VAL2));                 \
        SELFTEST_END_STMT
...
#define ASSERT_STREQ_AT(LOC, VAL1, VAL2)                                                           \
        SELFTEST_BEGIN_STMT                                                                        \
        ::selftest::assert_streq((LOC), #VAL1, #VAL2, (VAL1), (VAL2));                             \
        SELFTEST_END_STMT
...
#define ASSERT_STR_CONTAINS(HAYSTACK, NEEDLE)                                                      \
        SELFTEST_BEGIN_STMT                                                                        \
        ::selftest::assert_str_contains(SELFTEST_LOCATION, #HAYSTACK, #NEEDLE, (HAYSTACK),         \
                                        (NEEDLE));                                                 \
        SELFTEST_END_STMT
...
#define ASSERT_STR_CONTAINS_AT(LOC, HAYSTACK, NEEDLE)                                              \
        SELFTEST_BEGIN_STMT                                                                        \
        ::selftest::assert_str_contains(LOC, #HAYSTACK, #NEEDLE, (HAYSTACK), (NEEDLE));            \
        SELFTEST_END_STMT
...
#define ASSERT_STR_STARTSWITH(STR, PREFIX)                                                         \
        SELFTEST_BEGIN_STMT                                                                        \
        ::selftest::assert_str_startswith(SELFTEST_LOCATION, #STR, #PREFIX, (STR), (PREFIX));      \
        SELFTEST_END_STMT
