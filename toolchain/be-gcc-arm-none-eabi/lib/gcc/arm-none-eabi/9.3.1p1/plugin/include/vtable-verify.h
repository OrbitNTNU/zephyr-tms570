...
struct registration_hasher : nofree_ptr_hash<struct vtable_registration> {
        ...
        static inline bool equal(const vtable_registration *, const vtable_registration *);
};
...
extern bool vtbl_map_node_registration_find(struct vtbl_map_node *, tree, unsigned);
extern bool vtbl_map_node_registration_insert(struct vtbl_map_node *, tree, unsigned);
