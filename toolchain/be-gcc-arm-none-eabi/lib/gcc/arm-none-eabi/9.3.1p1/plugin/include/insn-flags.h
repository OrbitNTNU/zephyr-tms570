...
#define HAVE_cmpsi2_addneg                                                                         \
        (TARGET_32BIT && (INTVAL(operands[2]) == trunc_int_for_mode(-INTVAL(operands[3]), SImode)))
...
#define HAVE_andsi_not_shiftsi_si_scc_no_reuse                                                     \
...
#define HAVE_extzv_t2                                                                              \
        (arm_arch_thumb2 && IN_RANGE(INTVAL(operands[3]), 0, 31) &&                                \
...
#define HAVE_arm_rev16si2                                                                          \
        (arm_arch6 && aarch_rev16_shleft_mask_imm_p(operands[3], SImode) &&                        \
         aarch_rev16_shright_mask_imm_p(operands[2], SImode))
#define HAVE_arm_rev16si2_alt                                                                      \
        (arm_arch6 && aarch_rev16_shleft_mask_imm_p(operands[3], SImode) &&                        \
         aarch_rev16_shright_mask_imm_p(operands[2], SImode))
...
#define HAVE_btruncdf2                                                                             \
        ((TARGET_HARD_FLOAT && TARGET_VFP5 && TARGET_VFP_DOUBLE) && (TARGET_VFP_DOUBLE))
#define HAVE_ceildf2                                                                               \
        ((TARGET_HARD_FLOAT && TARGET_VFP5 && TARGET_VFP_DOUBLE) && (TARGET_VFP_DOUBLE))
#define HAVE_floordf2                                                                              \
        ((TARGET_HARD_FLOAT && TARGET_VFP5 && TARGET_VFP_DOUBLE) && (TARGET_VFP_DOUBLE))
#define HAVE_nearbyintdf2                                                                          \
        ((TARGET_HARD_FLOAT && TARGET_VFP5 && TARGET_VFP_DOUBLE) && (TARGET_VFP_DOUBLE))
#define HAVE_rintdf2                                                                               \
        ((TARGET_HARD_FLOAT && TARGET_VFP5 && TARGET_VFP_DOUBLE) && (TARGET_VFP_DOUBLE))
#define HAVE_rounddf2                                                                              \
        ((TARGET_HARD_FLOAT && TARGET_VFP5 && TARGET_VFP_DOUBLE) && (TARGET_VFP_DOUBLE))
...
#define HAVE_lceildfsi2                                                                            \
        ((TARGET_HARD_FLOAT && TARGET_VFP5 && TARGET_VFP_DOUBLE) && (TARGET_VFP_DOUBLE))
#define HAVE_lfloordfsi2                                                                           \
        ((TARGET_HARD_FLOAT && TARGET_VFP5 && TARGET_VFP_DOUBLE) && (TARGET_VFP_DOUBLE))
#define HAVE_lrounddfsi2                                                                           \
        ((TARGET_HARD_FLOAT && TARGET_VFP5 && TARGET_VFP_DOUBLE) && (TARGET_VFP_DOUBLE))
#define HAVE_lceiludfsi2                                                                           \
        ((TARGET_HARD_FLOAT && TARGET_VFP5 && TARGET_VFP_DOUBLE) && (TARGET_VFP_DOUBLE))
#define HAVE_lfloorudfsi2                                                                          \
        ((TARGET_HARD_FLOAT && TARGET_VFP5 && TARGET_VFP_DOUBLE) && (TARGET_VFP_DOUBLE))
#define HAVE_lroundudfsi2                                                                          \
        ((TARGET_HARD_FLOAT && TARGET_VFP5 && TARGET_VFP_DOUBLE) && (TARGET_VFP_DOUBLE))
...
#define HAVE_no_literal_pool_df_immediate                                                          \
        (arm_disable_literal_pool && TARGET_HARD_FLOAT && !arm_const_double_rtx(operands[1]) &&    \
         !(TARGET_VFP_DOUBLE && vfp3_const_double_rtx(operands[1])))
#define HAVE_no_literal_pool_sf_immediate                                                          \
        (arm_disable_literal_pool && TARGET_HARD_FLOAT && !vfp3_const_double_rtx(operands[1]))
#define HAVE_thumb1_movsi_symbol_ref                                                               \
...
#define HAVE_ashldi3_neon_noclobber                                                                \
        (TARGET_NEON && reload_completed &&                                                        \
         (!CONST_INT_P(operands[2]) || (INTVAL(operands[2]) >= 0 && INTVAL(operands[2]) < 64)))
...
#define HAVE_ashrdi3_neon_imm_noclobber                                                            \
        (TARGET_NEON && reload_completed && INTVAL(operands[2]) > 0 && INTVAL(operands[2]) <= 64)
#define HAVE_lshrdi3_neon_imm_noclobber                                                            \
        (TARGET_NEON && reload_completed && INTVAL(operands[2]) > 0 && INTVAL(operands[2]) <= 64)
...
#define HAVE_neon_vceqv8qi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V8QImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgtv8qi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V8QImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgev8qi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V8QImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vclev8qi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V8QImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcltv8qi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V8QImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vceqv16qi_insn                                                                   \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V16QImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgtv16qi_insn                                                                   \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V16QImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgev16qi_insn                                                                   \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V16QImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vclev16qi_insn                                                                   \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V16QImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcltv16qi_insn                                                                   \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V16QImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vceqv4hi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4HImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgtv4hi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4HImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgev4hi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4HImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vclev4hi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4HImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcltv4hi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4HImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vceqv8hi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V8HImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgtv8hi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V8HImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgev8hi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V8HImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vclev8hi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V8HImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcltv8hi_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V8HImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vceqv2si_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V2SImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgtv2si_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V2SImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgev2si_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V2SImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vclev2si_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V2SImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcltv2si_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V2SImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vceqv4si_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4SImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgtv4si_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4SImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgev4si_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4SImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vclev4si_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4SImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcltv4si_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4SImode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vceqv2sf_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V2SFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgtv2sf_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V2SFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgev2sf_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V2SFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vclev2sf_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V2SFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcltv2sf_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V2SFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vceqv4sf_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4SFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgtv4sf_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4SFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgev4sf_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4SFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vclev4sf_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4SFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcltv4sf_insn                                                                    \
        (TARGET_NEON &&                                                                            \
         !(GET_MODE_CLASS(V4SFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
...
#define HAVE_neon_vceqv8hf_fp16insn                                                                \
        (TARGET_NEON_FP16INST &&                                                                   \
         !(GET_MODE_CLASS(V8HFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgtv8hf_fp16insn                                                                \
        (TARGET_NEON_FP16INST &&                                                                   \
         !(GET_MODE_CLASS(V8HFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgev8hf_fp16insn                                                                \
        (TARGET_NEON_FP16INST &&                                                                   \
         !(GET_MODE_CLASS(V8HFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vclev8hf_fp16insn                                                                \
        (TARGET_NEON_FP16INST &&                                                                   \
         !(GET_MODE_CLASS(V8HFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcltv8hf_fp16insn                                                                \
        (TARGET_NEON_FP16INST &&                                                                   \
         !(GET_MODE_CLASS(V8HFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vceqv4hf_fp16insn                                                                \
        (TARGET_NEON_FP16INST &&                                                                   \
         !(GET_MODE_CLASS(V4HFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgtv4hf_fp16insn                                                                \
        (TARGET_NEON_FP16INST &&                                                                   \
         !(GET_MODE_CLASS(V4HFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcgev4hf_fp16insn                                                                \
        (TARGET_NEON_FP16INST &&                                                                   \
         !(GET_MODE_CLASS(V4HFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vclev4hf_fp16insn                                                                \
        (TARGET_NEON_FP16INST &&                                                                   \
         !(GET_MODE_CLASS(V4HFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
#define HAVE_neon_vcltv4hf_fp16insn                                                                \
        (TARGET_NEON_FP16INST &&                                                                   \
         !(GET_MODE_CLASS(V4HFmode) == MODE_VECTOR_FLOAT && !flag_unsafe_math_optimizations))
...
#define HAVE_neon_vabdv4hf_3                                                                       \
        ((TARGET_NEON && flag_unsafe_math_optimizations) && (TARGET_NEON_FP16INST))
#define HAVE_neon_vabdv8hf_3                                                                       \
        ((TARGET_NEON && flag_unsafe_math_optimizations) && (TARGET_NEON_FP16INST))
...
#define HAVE_atomic_compare_and_swap32qi_1                                                         \
        ((TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER) && (TARGET_32BIT))
#define HAVE_atomic_compare_and_swap32hi_1                                                         \
        ((TARGET_HAVE_LDREXBH && TARGET_HAVE_MEMORY_BARRIER) && (TARGET_32BIT))
#define HAVE_atomic_compare_and_swapt1qi_1                                                         \
        ((TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER) && (TARGET_THUMB1))
#define HAVE_atomic_compare_and_swapt1hi_1                                                         \
        ((TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER) && (TARGET_THUMB1))
#define HAVE_atomic_compare_and_swap32si_1                                                         \
        ((TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER) && (TARGET_32BIT))
#define HAVE_atomic_compare_and_swap32di_1                                                         \
        ((TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER) &&             \
         (TARGET_32BIT))
#define HAVE_atomic_compare_and_swapt1si_1                                                         \
        ((TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER) && (TARGET_THUMB1))
#define HAVE_atomic_compare_and_swapt1di_1                                                         \
        ((TARGET_HAVE_LDREX && TARGET_HAVE_MEMORY_BARRIER) && (TARGET_THUMB1))
...
#define HAVE_atomic_adddi  (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_subdi  (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_ordi   (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_xordi  (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_anddi  (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
...
#define HAVE_atomic_fetch_adddi                                                                    \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_subdi                                                                    \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_ordi                                                                     \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_xordi                                                                    \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_fetch_anddi                                                                    \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
...
#define HAVE_atomic_fetch_nanddi                                                                   \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
...
#define HAVE_atomic_add_fetchdi                                                                    \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_sub_fetchdi                                                                    \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_or_fetchdi                                                                     \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_xor_fetchdi                                                                    \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
#define HAVE_atomic_and_fetchdi                                                                    \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
...
#define HAVE_atomic_nand_fetchdi                                                                   \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
...
#define HAVE_arm_store_exclusivedi                                                                 \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
...
#define HAVE_movv2di                     (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2DImode)))
#define HAVE_movv2si                     (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SImode)))
#define HAVE_movv4hi                     (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4HImode)))
#define HAVE_movv8qi                     (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8QImode)))
#define HAVE_movv2sf                     (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SFmode)))
#define HAVE_movv4si                     (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SImode)))
#define HAVE_movv8hi                     (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8HImode)))
#define HAVE_movv16qi                    (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V16QImode)))
#define HAVE_movv4sf                     (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SFmode)))
#define HAVE_addv2di3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V2DImode != V2SFmode && V2DImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2DImode)))
#define HAVE_addv2si3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V2SImode != V2SFmode && V2SImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SImode)))
#define HAVE_addv4hi3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V4HImode != V2SFmode && V4HImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4HImode)))
#define HAVE_addv8qi3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V8QImode != V2SFmode && V8QImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8QImode)))
#define HAVE_addv2sf3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V2SFmode != V2SFmode && V2SFmode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SFmode)))
#define HAVE_addv4si3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V4SImode != V2SFmode && V4SImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SImode)))
#define HAVE_addv8hi3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V8HImode != V2SFmode && V8HImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8HImode)))
#define HAVE_addv16qi3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V16QImode != V2SFmode && V16QImode != V4SFmode) || flag_unsafe_math_optimizations)) || \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V16QImode)))
#define HAVE_addv4sf3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V4SFmode != V2SFmode && V4SFmode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SFmode)))
#define HAVE_subv2di3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V2DImode != V2SFmode && V2DImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2DImode)))
#define HAVE_subv2si3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V2SImode != V2SFmode && V2SImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SImode)))
#define HAVE_subv4hi3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V4HImode != V2SFmode && V4HImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4HImode)))
#define HAVE_subv8qi3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V8QImode != V2SFmode && V8QImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8QImode)))
#define HAVE_subv2sf3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V2SFmode != V2SFmode && V2SFmode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SFmode)))
#define HAVE_subv4si3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V4SImode != V2SFmode && V4SImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SImode)))
#define HAVE_subv8hi3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V8HImode != V2SFmode && V8HImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8HImode)))
#define HAVE_subv16qi3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V16QImode != V2SFmode && V16QImode != V4SFmode) || flag_unsafe_math_optimizations)) || \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V16QImode)))
#define HAVE_subv4sf3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V4SFmode != V2SFmode && V4SFmode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SFmode)))
#define HAVE_mulv2si3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V2SImode != V2SFmode && V2SImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (V2SImode == V4HImode && TARGET_REALLY_IWMMXT))
#define HAVE_mulv4hi3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V4HImode != V2SFmode && V4HImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (V4HImode == V4HImode && TARGET_REALLY_IWMMXT))
#define HAVE_mulv8qi3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V8QImode != V2SFmode && V8QImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (V8QImode == V4HImode && TARGET_REALLY_IWMMXT))
#define HAVE_mulv2sf3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V2SFmode != V2SFmode && V2SFmode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (V2SFmode == V4HImode && TARGET_REALLY_IWMMXT))
#define HAVE_mulv4si3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V4SImode != V2SFmode && V4SImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (V4SImode == V4HImode && TARGET_REALLY_IWMMXT))
#define HAVE_mulv8hi3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V8HImode != V2SFmode && V8HImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (V8HImode == V4HImode && TARGET_REALLY_IWMMXT))
#define HAVE_mulv16qi3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V16QImode != V2SFmode && V16QImode != V4SFmode) || flag_unsafe_math_optimizations)) || \
         (V16QImode == V4HImode && TARGET_REALLY_IWMMXT))
#define HAVE_mulv4sf3                                                                              \
        ((TARGET_NEON &&                                                                           \
          ((V4SFmode != V2SFmode && V4SFmode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (V4SFmode == V4HImode && TARGET_REALLY_IWMMXT))
#define HAVE_sminv2si3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V2SImode != V2SFmode && V2SImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SImode)))
#define HAVE_sminv4hi3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V4HImode != V2SFmode && V4HImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4HImode)))
#define HAVE_sminv8qi3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V8QImode != V2SFmode && V8QImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8QImode)))
#define HAVE_sminv2sf3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V2SFmode != V2SFmode && V2SFmode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SFmode)))
#define HAVE_sminv4si3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V4SImode != V2SFmode && V4SImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SImode)))
#define HAVE_sminv8hi3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V8HImode != V2SFmode && V8HImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8HImode)))
#define HAVE_sminv16qi3                                                                            \
        ((TARGET_NEON &&                                                                           \
          ((V16QImode != V2SFmode && V16QImode != V4SFmode) || flag_unsafe_math_optimizations)) || \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V16QImode)))
#define HAVE_sminv4sf3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V4SFmode != V2SFmode && V4SFmode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SFmode)))
#define HAVE_uminv2si3  (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SImode)))
#define HAVE_uminv4hi3  (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4HImode)))
#define HAVE_uminv8qi3  (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8QImode)))
#define HAVE_uminv4si3  (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SImode)))
#define HAVE_uminv8hi3  (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8HImode)))
#define HAVE_uminv16qi3 (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V16QImode)))
#define HAVE_smaxv2si3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V2SImode != V2SFmode && V2SImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SImode)))
#define HAVE_smaxv4hi3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V4HImode != V2SFmode && V4HImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4HImode)))
#define HAVE_smaxv8qi3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V8QImode != V2SFmode && V8QImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8QImode)))
#define HAVE_smaxv2sf3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V2SFmode != V2SFmode && V2SFmode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SFmode)))
#define HAVE_smaxv4si3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V4SImode != V2SFmode && V4SImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SImode)))
#define HAVE_smaxv8hi3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V8HImode != V2SFmode && V8HImode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8HImode)))
#define HAVE_smaxv16qi3                                                                            \
        ((TARGET_NEON &&                                                                           \
          ((V16QImode != V2SFmode && V16QImode != V4SFmode) || flag_unsafe_math_optimizations)) || \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V16QImode)))
#define HAVE_smaxv4sf3                                                                             \
        ((TARGET_NEON &&                                                                           \
          ((V4SFmode != V2SFmode && V4SFmode != V4SFmode) || flag_unsafe_math_optimizations)) ||   \
         (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SFmode)))
#define HAVE_umaxv2si3                  (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V2SImode)))
#define HAVE_umaxv4hi3                  (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4HImode)))
#define HAVE_umaxv8qi3                  (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8QImode)))
#define HAVE_umaxv4si3                  (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V4SImode)))
#define HAVE_umaxv8hi3                  (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V8HImode)))
#define HAVE_umaxv16qi3                 (TARGET_NEON || (TARGET_REALLY_IWMMXT && VALID_IWMMXT_REG_MODE(V16QImode)))
...
#define HAVE_divv2sf3                   (TARGET_NEON && !optimize_size && flag_reciprocal_math)
#define HAVE_divv4sf3                   (TARGET_NEON && !optimize_size && flag_reciprocal_math)
...
#define HAVE_reduc_plus_scal_v16qi                                                                 \
        (TARGET_NEON && (!false || flag_unsafe_math_optimizations) && !BYTES_BIG_ENDIAN)
#define HAVE_reduc_plus_scal_v8hi                                                                  \
        (TARGET_NEON && (!false || flag_unsafe_math_optimizations) && !BYTES_BIG_ENDIAN)
#define HAVE_reduc_plus_scal_v4si                                                                  \
        (TARGET_NEON && (!false || flag_unsafe_math_optimizations) && !BYTES_BIG_ENDIAN)
#define HAVE_reduc_plus_scal_v4sf                                                                  \
        (TARGET_NEON && (!true || flag_unsafe_math_optimizations) && !BYTES_BIG_ENDIAN)
...
#define HAVE_reduc_smin_scal_v16qi                                                                 \
        (TARGET_NEON && (!false || flag_unsafe_math_optimizations) && !BYTES_BIG_ENDIAN)
#define HAVE_reduc_smin_scal_v8hi                                                                  \
        (TARGET_NEON && (!false || flag_unsafe_math_optimizations) && !BYTES_BIG_ENDIAN)
#define HAVE_reduc_smin_scal_v4si                                                                  \
        (TARGET_NEON && (!false || flag_unsafe_math_optimizations) && !BYTES_BIG_ENDIAN)
#define HAVE_reduc_smin_scal_v4sf                                                                  \
        (TARGET_NEON && (!true || flag_unsafe_math_optimizations) && !BYTES_BIG_ENDIAN)
...
#define HAVE_reduc_smax_scal_v16qi                                                                 \
        (TARGET_NEON && (!false || flag_unsafe_math_optimizations) && !BYTES_BIG_ENDIAN)
#define HAVE_reduc_smax_scal_v8hi                                                                  \
        (TARGET_NEON && (!false || flag_unsafe_math_optimizations) && !BYTES_BIG_ENDIAN)
#define HAVE_reduc_smax_scal_v4si                                                                  \
        (TARGET_NEON && (!false || flag_unsafe_math_optimizations) && !BYTES_BIG_ENDIAN)
#define HAVE_reduc_smax_scal_v4sf                                                                  \
        (TARGET_NEON && (!true || flag_unsafe_math_optimizations) && !BYTES_BIG_ENDIAN)
...
#define HAVE_atomic_loaddi                                                                         \
        ((TARGET_HAVE_LDREXD || TARGET_HAVE_LPAE || TARGET_HAVE_LDACQEXD) && ARM_DOUBLEWORD_ALIGN)
...
#define HAVE_atomic_compare_and_swapdi                                                             \
        (TARGET_HAVE_LDREXD && ARM_DOUBLEWORD_ALIGN && TARGET_HAVE_MEMORY_BARRIER)
...
static inline rtx gen_pic_offset_arm(rtx ARG_UNUSED(a), rtx ARG_UNUSED(b), rtx ARG_UNUSED(c))
{
        return 0;
}
