...
static inline bool hsa_gen_requested_p(void)
{
#ifndef ENABLE_HSA
        return false;
#endif
...
struct hsa_symbol {
        /* Constructor.  */
        hsa_symbol(BrigType16_t type, BrigSegment8_t segment, BrigLinkage8_t linkage,
...
template <> template <> inline bool is_a_helper<hsa_op_immed *>::test(hsa_op_base *p)
{
...
template <> template <> inline bool is_a_helper<hsa_op_immed *>::test(hsa_op_with_type *p)
{
        return p->m_kind == BRIG_KIND_OPERAND_CONSTANT_BYTES;
}
...
template <> template <> inline bool is_a_helper<hsa_op_reg *>::test(hsa_op_base *p)
{
...
template <> template <> inline bool is_a_helper<hsa_op_reg *>::test(hsa_op_with_type *p)
{
        return p->m_kind == BRIG_KIND_OPERAND_REGISTER;
}
...
class hsa_op_address : public hsa_op_base
{
      public:
        ...
        hsa_op_address(hsa_symbol *sym, hsa_op_reg *reg, HOST_WIDE_INT offset = 0);
...
template <> template <> inline bool is_a_helper<hsa_op_address *>::test(hsa_op_base *p)
{
...
template <> template <> inline bool is_a_helper<hsa_op_code_ref *>::test(hsa_op_base *p)
{
...
template <> template <> inline bool is_a_helper<hsa_op_code_list *>::test(hsa_op_base *p)
{
...
template <> template <> inline bool is_a_helper<hsa_op_operand_list *>::test(hsa_op_base *p)
{
...
class hsa_insn_basic
{
      public:
        ...
        hsa_insn_basic(unsigned nops, int opc, BrigType16_t t, hsa_op_base *arg0 = NULL,
                       hsa_op_base *arg1 = NULL, hsa_op_base *arg2 = NULL,
...
template <> template <> inline bool is_a_helper<hsa_insn_phi *>::test(hsa_insn_basic *p)
{
...
class hsa_insn_br : public hsa_insn_basic
{
      public:
        hsa_insn_br(unsigned nops, int opc, BrigType16_t t, BrigWidth8_t width,
                    hsa_op_base *arg0 = NULL, hsa_op_base *arg1 = NULL, hsa_op_base *arg2 = NULL,
                    hsa_op_base *arg3 = NULL);
...
template <> template <> inline bool is_a_helper<hsa_insn_br *>::test(hsa_insn_basic *p)
{
        return p->m_opcode == BRIG_OPCODE_BARRIER || p->m_opcode == BRIG_OPCODE_BR;
}
...
class hsa_insn_cbr : public hsa_insn_br
{
      ...
      private:
        /* Make the default constructor inaccessible.  */
        hsa_insn_cbr() : hsa_insn_br(0, BRIG_OPCODE_CBR, BRIG_TYPE_B1, BRIG_WIDTH_1)
        {
        }
};
...
template <> template <> inline bool is_a_helper<hsa_insn_cbr *>::test(hsa_insn_basic *p)
{
...
template <> template <> inline bool is_a_helper<hsa_insn_sbr *>::test(hsa_insn_basic *p)
{
...
{
      public:
        hsa_insn_cmp(BrigCompareOperation8_t cmp, BrigType16_t t, hsa_op_base *arg0 = NULL,
                     hsa_op_base *arg1 = NULL, hsa_op_base *arg2 = NULL);
...
template <> template <> inline bool is_a_helper<hsa_insn_cmp *>::test(hsa_insn_basic *p)
{
...
class hsa_insn_mem : public hsa_insn_basic
{
      ...
      protected:
        hsa_insn_mem(unsigned nops, int opc, BrigType16_t t, hsa_op_base *arg0 = NULL,
                     hsa_op_base *arg1 = NULL, hsa_op_base *arg2 = NULL, hsa_op_base *arg3 = NULL);
...
template <> template <> inline bool is_a_helper<hsa_insn_mem *>::test(hsa_insn_basic *p)
{
        return (p->m_opcode == BRIG_OPCODE_LD || p->m_opcode == BRIG_OPCODE_ST);
}
...
class hsa_insn_atomic : public hsa_insn_mem
{
      public:
        hsa_insn_atomic(int nops, int opc, enum BrigAtomicOperation aop, BrigType16_t t,
                        BrigMemoryOrder memorder, hsa_op_base *arg0 = NULL,
                        hsa_op_base *arg1 = NULL, hsa_op_base *arg2 = NULL,
                        hsa_op_base *arg3 = NULL);
...
template <> template <> inline bool is_a_helper<hsa_insn_atomic *>::test(hsa_insn_basic *p)
{
        return (p->m_opcode == BRIG_OPCODE_ATOMIC || p->m_opcode == BRIG_OPCODE_ATOMICNORET);
}
...
template <> template <> inline bool is_a_helper<hsa_insn_signal *>::test(hsa_insn_basic *p)
{
        return (p->m_opcode == BRIG_OPCODE_SIGNAL || p->m_opcode == BRIG_OPCODE_SIGNALNORET);
}
...
{
      public:
        hsa_insn_seg(int opc, BrigType16_t destt, BrigType16_t srct, BrigSegment8_t seg,
...
template <> template <> inline bool is_a_helper<hsa_insn_seg *>::test(hsa_insn_basic *p)
{
        return (p->m_opcode == BRIG_OPCODE_STOF || p->m_opcode == BRIG_OPCODE_FTOS);
}
...
class hsa_internal_fn
{
      public:
        ...
        hsa_internal_fn(const hsa_internal_fn *f)
                : m_fn(f->m_fn), m_type_bit_size(f->m_type_bit_size), m_offset(f->m_offset)
        {
        }
...
template <> template <> inline bool is_a_helper<hsa_insn_call *>::test(hsa_insn_basic *p)
{
...
template <> template <> inline bool is_a_helper<hsa_insn_arg_block *>::test(hsa_insn_basic *p)
{
...
template <> template <> inline bool is_a_helper<hsa_insn_comment *>::test(hsa_insn_basic *p)
{
...
{
      public:
        hsa_insn_queue(int nops, int opcode, BrigSegment segment, BrigMemoryOrder memory_order,
                       hsa_op_base *arg0 = NULL, hsa_op_base *arg1 = NULL, hsa_op_base *arg2 = NULL,
                       hsa_op_base *arg3 = NULL);
...
template <> template <> inline bool is_a_helper<hsa_insn_queue *>::test(hsa_insn_basic *p)
{
...
{
      public:
        hsa_insn_srctype(int nops, BrigOpcode opcode, BrigType16_t destt, BrigType16_t srct,
                         hsa_op_base *arg0, hsa_op_base *arg1, hsa_op_base *arg2);
...
template <> template <> inline bool is_a_helper<hsa_insn_srctype *>::test(hsa_insn_basic *p)
{
        return (p->m_opcode == BRIG_OPCODE_POPCOUNT || p->m_opcode == BRIG_OPCODE_FIRSTBIT ||
...
{
      public:
        hsa_insn_packed(int nops, BrigOpcode opcode, BrigType16_t destt, BrigType16_t srct,
                        hsa_op_base *arg0, hsa_op_base *arg1, hsa_op_base *arg2);
...
template <> template <> inline bool is_a_helper<hsa_insn_packed *>::test(hsa_insn_basic *p)
{
        return (p->m_opcode == BRIG_OPCODE_COMBINE || p->m_opcode == BRIG_OPCODE_EXPAND);
}
...
template <> template <> inline bool is_a_helper<hsa_insn_cvt *>::test(hsa_insn_basic *p)
{
...
{
      public:
        hsa_insn_alloca(hsa_op_with_type *dest, hsa_op_with_type *size, unsigned alignment = 0);
...
template <> template <> inline bool is_a_helper<hsa_insn_alloca *>::test(hsa_insn_basic *p)
{
...
static inline hsa_bb *hsa_bb_for_bb(basic_block bb)
{
...
inline hashval_t hsa_noop_symbol_hasher::hash(const value_type item)
{
...
inline bool hsa_noop_symbol_hasher::equal(const value_type a, const compare_type b)
{
...
{
      public:
        hsa_function_representation(tree fdecl, bool kernel_p, unsigned ssa_names_count,
...
inline hsa_function_summary::hsa_function_summary()
        : m_kind(HSA_INVALID), m_bound_function(NULL), m_gpu_implementation_p(false)
{
}
...
{
      public:
        hsa_summary_t(symbol_table *table) : function_summary<hsa_function_summary *>(table)
        {
        ...
        void link_functions(cgraph_node *gpu, cgraph_node *host, hsa_function_kind kind,
...
{
      public:
        omp_simple_builtin(const char *name, const char *warning_message, bool sorry,
                           hsa_op_immed *return_value = NULL)
...
inline hashval_t hsa_internal_fn_hasher::hash(const value_type item)
{
        return item->m_fn;
}
...
inline bool hsa_internal_fn_hasher::equal(const value_type a, const compare_type b)
{
...
static inline bool hsa_gpu_implementation_p(tree decl)
{
