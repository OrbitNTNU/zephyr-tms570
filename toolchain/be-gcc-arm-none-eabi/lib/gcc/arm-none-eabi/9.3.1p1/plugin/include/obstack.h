...
#define __PTR_ALIGN(B, P, A)                                                                       \
        __BPTR_ALIGN(sizeof(ptrdiff_t) < sizeof(void *) ? (B) : (char *)0, P, A)
...
extern int _obstack_begin(struct obstack *, _OBSTACK_SIZE_T, _OBSTACK_SIZE_T, void *(*)(size_t),
                          void (*)(void *));
...
#define obstack_empty_p(h)                                                                         \
        ((h)->chunk->prev == 0 &&                                                                  \
         (h)->next_free ==                                                                         \
                 __PTR_ALIGN((char *)(h)->chunk, (h)->chunk->contents, (h)->alignment_mask))
...
#define obstack_make_room(h, length)                                                               \
        ((h)->temp.i = (length),                                                                   \
         ((obstack_room(h) < (h)->temp.i) ? (_obstack_newchunk(h, (h)->temp.i), 0) : 0), (void)0)

#define obstack_grow(h, where, length)                                                             \
        ((h)->temp.i = (length),                                                                   \
         ((obstack_room(h) < (h)->temp.i) ? (_obstack_newchunk((h), (h)->temp.i), 0) : 0),         \
         memcpy((h)->next_free, where, (h)->temp.i), (h)->next_free += (h)->temp.i, (void)0)

#define obstack_grow0(h, where, length)                                                            \
        ((h)->temp.i = (length),                                                                   \
         ((obstack_room(h) < (h)->temp.i + 1) ? (_obstack_newchunk((h), (h)->temp.i + 1), 0) : 0), \
         memcpy((h)->next_free, where, (h)->temp.i), (h)->next_free += (h)->temp.i,                \
         *((h)->next_free)++ = 0, (void)0)

#define obstack_1grow(h, datum)                                                                    \
        (((obstack_room(h) < 1) ? (_obstack_newchunk((h), 1), 0) : 0), obstack_1grow_fast(h, datum))

#define obstack_ptr_grow(h, datum)                                                                 \
        (((obstack_room(h) < sizeof(char *)) ? (_obstack_newchunk((h), sizeof(char *)), 0) : 0),   \
...
#define obstack_ptr_grow_fast(h, aptr)                                                             \
        (((const void **)((h)->next_free += sizeof(void *)))[-1] = (aptr), (void)0)

#define obstack_int_grow_fast(h, aint)                                                             \
        (((int *)((h)->next_free += sizeof(int)))[-1] = (aint), (void)0)
...
#define obstack_free(h, obj)                                                                       \
        ((h)->temp.p = (void *)(obj),                                                              \
         (((h)->temp.p > (void *)(h)->chunk && (h)->temp.p < (void *)(h)->chunk_limit)             \
