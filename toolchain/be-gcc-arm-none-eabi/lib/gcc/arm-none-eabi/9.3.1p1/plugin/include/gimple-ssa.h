...
/* Artificial variable used for the virtual operand FUD chain.  */
static inline tree gimple_vop(const struct function *fun)
{
...
static inline use_operand_p gimple_vuse_op(const gimple *g)
{
...
static inline def_operand_p gimple_vdef_op(gimple *g)
{
...
static inline void update_stmt(gimple *s)
{
        if (gimple_has_ops(s)) {
...
static inline void update_stmt_if_modified(gimple *s)
{
...
static inline void update_stmt_fn(struct function *fn, gimple *s)
{
        if (gimple_has_ops(s)) {
                gimple_set_modified(s, true);
