...
extern machine_mode default_promote_function_mode_always_promote(const_tree, machine_mode, int *,
                                                                 const_tree, int);
...
extern unsigned HOST_WIDE_INT default_shift_truncation_mask(machine_mode);
...
extern bool hook_pass_by_reference_must_pass_in_stack(cumulative_args_t, machine_mode mode,
                                                      const_tree, bool);
extern bool hook_callee_copies_named(cumulative_args_t ca, machine_mode, const_tree, bool);
...
extern HOST_WIDE_INT constant_alignment_word_strings(const_tree, HOST_WIDE_INT);
extern HOST_WIDE_INT default_vector_alignment(const_tree);

extern poly_uint64 default_preferred_vector_alignment(const_tree);
extern bool default_builtin_vector_alignment_reachable(const_tree, bool);
extern bool default_builtin_support_vector_misalignment(machine_mode mode, const_tree, int, bool);
...
extern unsigned default_add_stmt_cost(void *, int, enum vect_cost_for_stmt, struct _stmt_vec_info *,
...
extern bool hook_bool_CUMULATIVE_ARGS_mode_tree_bool_false(cumulative_args_t, machine_mode,
                                                           const_tree, bool);
extern bool hook_bool_CUMULATIVE_ARGS_mode_tree_bool_true(cumulative_args_t, machine_mode,
                                                          const_tree, bool);
extern int hook_int_CUMULATIVE_ARGS_mode_tree_bool_0(cumulative_args_t, machine_mode, tree, bool);
extern void hook_void_CUMULATIVE_ARGS_tree(cumulative_args_t, tree);
extern const char *hook_invalid_arg_for_unprototyped_fn(const_tree, const_tree, const_tree);
extern void default_function_arg_advance(cumulative_args_t, machine_mode, const_tree, bool);
...
extern rtx default_function_arg(cumulative_args_t, machine_mode, const_tree, bool);
extern rtx default_function_incoming_arg(cumulative_args_t, machine_mode, const_tree, bool);
extern unsigned int default_function_arg_boundary(machine_mode, const_tree);
extern unsigned int default_function_arg_round_boundary(machine_mode, const_tree);
...
extern reg_class_t default_ira_change_pseudo_allocno_class(int, reg_class_t, reg_class_t);
...
extern reg_class_t default_secondary_reload(bool, rtx, reg_class_t, machine_mode,
...
extern bool default_addr_space_valid_pointer_mode(scalar_int_mode, addr_space_t);
extern bool default_addr_space_legitimate_address_p(machine_mode, rtx, bool, addr_space_t);
extern rtx default_addr_space_legitimize_address(rtx, rtx, machine_mode, addr_space_t);
...
extern int default_register_move_cost(machine_mode, reg_class_t, reg_class_t);
...
extern bool default_use_by_pieces_infrastructure_p(unsigned HOST_WIDE_INT, unsigned int,
                                                   enum by_pieces_operation, bool);
extern int default_compare_by_pieces_branch_ratio(machine_mode);

extern void default_print_patchable_function_entry(FILE *, unsigned HOST_WIDE_INT, bool);
...
extern section *default_function_section(tree decl, enum node_frequency freq, bool startup,
                                         bool exit);
extern unsigned int default_dwarf_poly_indeterminate_value(unsigned int, unsigned int *, int *);
...
extern bool can_use_doloop_if_innermost(const widest_int &, const widest_int &, unsigned int, bool);
...
extern bool default_optab_supported_p(int, machine_mode, machine_mode, optimization_type);
extern unsigned int default_max_noce_ifcvt_seq_cost(edge);
extern bool default_noce_conversion_profitable_p(rtx_insn *, struct noce_if_info *);
extern unsigned int default_min_arithmetic_precision(void);

extern enum flt_eval_method default_excess_precision(enum excess_precision_type ATTRIBUTE_UNUSED);
...
extern void default_remove_extra_call_preserved_regs(rtx_insn *, HARD_REG_SET *);
