...
struct GTY((desc("0"), tag("0"), chain_next("RTX_NEXT (&%h)"),
...
template <> template <> inline bool is_a_helper<rtx_expr_list *>::test(rtx rt)
{
...
template <> template <> inline bool is_a_helper<rtx_insn_list *>::test(rtx rt)
{
...
template <> template <> inline bool is_a_helper<rtx_sequence *>::test(rtx rt)
{
        return rt->code == SEQUENCE;
}

template <> template <> inline bool is_a_helper<const rtx_sequence *>::test(const_rtx rt)
{
        return rt->code == SEQUENCE;
}
...
#define RTX_NEXT(X)                                                                                \
        (rtx_next[GET_CODE(X)] == 0 ? NULL : *(rtx *)(((char *)X) + rtx_next[GET_CODE(X)]))

/* FIXME: the "NEXT_INSN (PREV_INSN (X)) == X" condition shouldn't be needed.
 */
#define RTX_PREV(X)                                                                                \
        ((INSN_P(X) || NOTE_P(X) || JUMP_TABLE_DATA_P(X) || BARRIER_P(X) || LABEL_P(X)) &&         \
                         PREV_INSN(as_a<rtx_insn *>(X)) != NULL &&                                 \
                         NEXT_INSN(PREV_INSN(as_a<rtx_insn *>(X))) == X                            \
                 ? PREV_INSN(as_a<rtx_insn *>(X))                                                  \
                 : NULL)
...
#if TARGET_SUPPORTS_WIDE_INT
#define CONST_SCALAR_INT_P(X) (CONST_INT_P(X) || CONST_WIDE_INT_P(X))
#else
...
template <> template <> inline bool is_a_helper<rtx_insn *>::test(rtx rt)
{
        return (INSN_P(rt) || NOTE_P(rt) || JUMP_TABLE_DATA_P(rt) || BARRIER_P(rt) || LABEL_P(rt));
}

template <> template <> inline bool is_a_helper<const rtx_insn *>::test(const_rtx rt)
{
        return (INSN_P(rt) || NOTE_P(rt) || JUMP_TABLE_DATA_P(rt) || BARRIER_P(rt) || LABEL_P(rt));
}

template <> template <> inline bool is_a_helper<rtx_debug_insn *>::test(rtx rt)
{
        return DEBUG_INSN_P(rt);
}

template <> template <> inline bool is_a_helper<rtx_nonjump_insn *>::test(rtx rt)
{
        return NONJUMP_INSN_P(rt);
}

template <> template <> inline bool is_a_helper<rtx_jump_insn *>::test(rtx rt)
{
        return JUMP_P(rt);
}

template <> template <> inline bool is_a_helper<rtx_jump_insn *>::test(rtx_insn *insn)
{
        return JUMP_P(insn);
}

template <> template <> inline bool is_a_helper<rtx_call_insn *>::test(rtx rt)
{
        return CALL_P(rt);
}

template <> template <> inline bool is_a_helper<rtx_call_insn *>::test(rtx_insn *insn)
{
        return CALL_P(insn);
}

template <> template <> inline bool is_a_helper<rtx_jump_table_data *>::test(rtx rt)
{
        return JUMP_TABLE_DATA_P(rt);
}

template <> template <> inline bool is_a_helper<rtx_jump_table_data *>::test(rtx_insn *insn)
{
        return JUMP_TABLE_DATA_P(insn);
}

template <> template <> inline bool is_a_helper<rtx_barrier *>::test(rtx rt)
{
        return BARRIER_P(rt);
}

template <> template <> inline bool is_a_helper<rtx_code_label *>::test(rtx rt)
{
        return LABEL_P(rt);
}

template <> template <> inline bool is_a_helper<rtx_code_label *>::test(rtx_insn *insn)
{
        return LABEL_P(insn);
}

template <> template <> inline bool is_a_helper<rtx_note *>::test(rtx rt)
{
        return NOTE_P(rt);
}

template <> template <> inline bool is_a_helper<rtx_note *>::test(rtx_insn *insn)
{
        return NOTE_P(insn);
}
...
#define SWAPPABLE_OPERANDS_P(X)                                                                    \
        ((1 << GET_RTX_CLASS(GET_CODE(X))) &                                                       \
         ((1 << RTX_COMM_ARITH) | (1 << RTX_COMM_COMPARE) | (1 << RTX_COMPARE)))
...
#define RTL_CHECK2(RTX, N, C1, C2)                                                                 \
        __extension__(*({                                                                          \
                ...
                if (_n < 0 || _n >= GET_RTX_LENGTH(_code))                                         \
                        rtl_check_failed_bounds(_rtx, _n, __FILE__, __LINE__, __FUNCTION__);       \
                if (GET_RTX_FORMAT(_code)[_n] != C1 && GET_RTX_FORMAT(_code)[_n] != C2)            \
...
#define RTL_CHECKC3(RTX, N, C1, C2, C3)                                                            \
        __extension__(*({                                                                          \
                ...
                if (_code != (C1) && _code != (C2) && _code != (C3))                               \
                        rtl_check_failed_code3(_rtx, (C1), (C2), (C3), __FILE__, __LINE__,         \
                                               __FUNCTION__);                                      \
                &_rtx->u.fld[_n];                                                                  \
        }))
...
#define RTVEC_ELT(RTVEC, I)                                                                        \
        __extension__(*({                                                                          \
                __typeof(RTVEC) const _rtvec = (RTVEC);                                            \
                const int _i = (I);                                                                \
                if (_i < 0 || _i >= GET_NUM_ELEM(_rtvec))                                          \
                        rtvec_check_failed_bounds(_rtvec, _i, __FILE__, __LINE__, __FUNCTION__);   \
                &_rtvec->elem[_i];                                                                 \
        }))
...
#define XWINT(RTX, N)                                                                              \
        __extension__(*({                                                                          \
                ...
                if (GET_RTX_FORMAT(_code)[_n] != 'w')                                              \
                        rtl_check_failed_type1(_rtx, _n, 'w', __FILE__, __LINE__, __FUNCTION__);   \
                &_rtx->u.hwint[_n];                                                                \
        }))
...
#define CWI_ELT(RTX, I)                                                                            \
        __extension__(*({                                                                          \
                ...
                const int _i = (I);                                                                \
                if (_i < 0 || _i >= _max)                                                          \
                        cwi_check_failed_bounds(_cwi, _i, __FILE__, __LINE__, __FUNCTION__);       \
                &_cwi->u.hwiv.elem[_i];                                                            \
        }))
...
#define XCMWINT(RTX, N, C, M)                                                                      \
        __extension__(*({                                                                          \
                ...
                if (GET_CODE(_rtx) != (C) || GET_MODE(_rtx) != (M))                                \
                        rtl_check_failed_code_mode(_rtx, (C), (M), false, __FILE__, __LINE__,      \
                                                   __FUNCTION__);                                  \
                &_rtx->u.hwint[N];                                                                 \
        }))
...
#define XCNMPRV(RTX, C, M)                                                                         \
        __extension__({                                                                            \
                __typeof(RTX) const _rtx = (RTX);                                                  \
                if (GET_CODE(_rtx) != (C) || GET_MODE(_rtx) == (M))                                \
                        rtl_check_failed_code_mode(_rtx, (C), (M), true, __FILE__, __LINE__,       \
                                                   __FUNCTION__);                                  \
                &_rtx->u.rv;                                                                       \
        })
...
#define REG_CHECK(RTX)                                                                             \
        __extension__({                                                                            \
                ...
                if (GET_CODE(_rtx) != REG)                                                         \
                        rtl_check_failed_code1(_rtx, REG, __FILE__, __LINE__, __FUNCTION__);       \
                &_rtx->u.reg;                                                                      \
        })
...
#define BLOCK_SYMBOL_CHECK(RTX)                                                                    \
        __extension__({                                                                            \
                ...
                if ((flags & SYMBOL_FLAG_HAS_BLOCK_INFO) == 0)                                     \
                        rtl_check_failed_block_symbol(__FILE__, __LINE__, __FUNCTION__);           \
                &_symbol->u.block_sym;                                                             \
        })
...
extern void rtl_check_failed_type1(const_rtx, int, int, const char *, int,
                                   const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void rtl_check_failed_type2(const_rtx, int, int, int, const char *, int,
                                   const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void rtl_check_failed_code1(const_rtx, enum rtx_code, const char *, int,
                                   const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void rtl_check_failed_code2(const_rtx, enum rtx_code, enum rtx_code, const char *, int,
                                   const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void rtl_check_failed_code3(const_rtx, enum rtx_code, enum rtx_code, enum rtx_code,
                                   const char *, int,
                                   const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void rtl_check_failed_code_mode(const_rtx, enum rtx_code, machine_mode, bool, const char *,
                                       int, const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void rtl_check_failed_block_symbol(const char *, int,
                                          const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
...
#define RTL_FLAG_CHECK1(NAME, RTX, C1)                                                             \
        __extension__({                                                                            \
                __typeof(RTX) const _rtx = (RTX);                                                  \
                if (GET_CODE(_rtx) != C1)                                                          \
                        rtl_check_failed_flag(NAME, _rtx, __FILE__, __LINE__, __FUNCTION__);       \
                _rtx;                                                                              \
        })
...
#define RTL_FLAG_CHECK3(NAME, RTX, C1, C2, C3)                                                     \
        __extension__({                                                                            \
                __typeof(RTX) const _rtx = (RTX);                                                  \
                if (GET_CODE(_rtx) != C1 && GET_CODE(_rtx) != C2 && GET_CODE(_rtx) != C3)          \
                        rtl_check_failed_flag(NAME, _rtx, __FILE__, __LINE__, __FUNCTION__);       \
                _rtx;                                                                              \
        })
...
#define RTL_FLAG_CHECK5(NAME, RTX, C1, C2, C3, C4, C5)                                             \
        __extension__({                                                                            \
                __typeof(RTX) const _rtx = (RTX);                                                  \
                if (GET_CODE(_rtx) != C1 && GET_CODE(_rtx) != C2 && GET_CODE(_rtx) != C3 &&        \
                    GET_CODE(_rtx) != C4 && GET_CODE(_rtx) != C5)                                  \
                        rtl_check_failed_flag(NAME, _rtx, __FILE__, __LINE__, __FUNCTION__);       \
                _rtx;                                                                              \
        })
...
#define RTL_FLAG_CHECK6(NAME, RTX, C1, C2, C3, C4, C5, C6)                                         \
        __extension__({                                                                            \
                __typeof(RTX) const _rtx = (RTX);                                                  \
                if (GET_CODE(_rtx) != C1 && GET_CODE(_rtx) != C2 && GET_CODE(_rtx) != C3 &&        \
                    GET_CODE(_rtx) != C4 && GET_CODE(_rtx) != C5 && GET_CODE(_rtx) != C6)          \
                        rtl_check_failed_flag(NAME, _rtx, __FILE__, __LINE__, __FUNCTION__);       \
                _rtx;                                                                              \
        })
...
extern void rtl_check_failed_flag(const char *, const_rtx, const char *, int,
                                  const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
...
{
        return RTL_INSN_CHAIN_FLAG_CHECK("INSN_UID", (insn))->u2.insn_uid;
}
...
#define RTL_LOCATION(X) (INSN_P(X) ? INSN_LOCATION(as_a<rtx_insn *>(X)) : UNKNOWN_LOCATION)
...
inline scalar_int_mode rtx_jump_table_data::get_data_mode() const
{
...
inline rtx_jump_table_data *jump_table_for_label(const rtx_code_label *label)
{
        return safe_dyn_cast<rtx_jump_table_data *>(NEXT_INSN(label));
}

#define RTX_FRAME_RELATED_P(RTX)                                                                   \
        (RTL_FLAG_CHECK6("RTX_FRAME_RELATED_P", (RTX), DEBUG_INSN, INSN, CALL_INSN, JUMP_INSN,     \
                         BARRIER, SET)                                                             \
                 ->frame_related)
...
#define NOTE_MARKER_P(INSN)                                                                        \
        (NOTE_P(INSN) &&                                                                           \
         (NOTE_KIND(INSN) == NOTE_INSN_BEGIN_STMT || NOTE_KIND(INSN) == NOTE_INSN_INLINE_ENTRY))
...
#define PAT_VAR_LOCATION_STATUS(PAT)                                                               \
        (RTL_FLAG_CHECK1("PAT_VAR_LOCATION_STATUS", PAT, VAR_LOCATION)->u2.var_location_status)
...
#define DEBUG_BIND_INSN_P(INSN)   (DEBUG_INSN_P(INSN) && (GET_CODE(PATTERN(INSN)) == VAR_LOCATION))
/* Evaluate to TRUE if INSN is a debug insn that denotes a program
   source location marker.  */
#define DEBUG_MARKER_INSN_P(INSN) (DEBUG_INSN_P(INSN) && (GET_CODE(PATTERN(INSN)) != VAR_LOCATION))
/* Evaluate to the marker kind.  */
#define INSN_DEBUG_MARKER_KIND(INSN)                                                               \
        (GET_CODE(PATTERN(INSN)) == DEBUG_MARKER                                                   \
                 ? (GET_MODE(PATTERN(INSN)) == VOIDmode  ? NOTE_INSN_BEGIN_STMT                    \
                    : GET_MODE(PATTERN(INSN)) == BLKmode ? NOTE_INSN_INLINE_ENTRY                  \
                                                         : (enum insn_note) - 1)                   \
                 : (enum insn_note) - 1)
...
static inline rtx_insn *label_ref_label(const_rtx ref)
{
...
static inline void set_label_ref_label(rtx ref, rtx_insn *label)
{
...
static inline unsigned int rhs_regno(const_rtx x)
{
        return REG_CHECK(x)->regno;
}

/* Return the final register in REG X plus one.  */
static inline unsigned int END_REGNO(const_rtx x)
{
...
static inline void set_regno_raw(rtx x, unsigned int regno, unsigned int nregs)
{
...
#define CONST_POLY_INT_COEFFS(RTX)                                                                 \
        (RTL_FLAG_CHECK1("CONST_POLY_INT_COEFFS", (RTX), CONST_POLY_INT)->u.cpi.coeffs)
...
#define CONST_VECTOR_NPATTERNS(RTX)                                                                \
        (RTL_FLAG_CHECK1("CONST_VECTOR_NPATTERNS", (RTX), CONST_VECTOR)->u2.const_vector.npatterns)
...
inline unsigned int const_vector_encoded_nelts(const_rtx x)
{
...
static inline bool always_void_p(enum rtx_code code)
{
        return code == SET;
}
...
static inline void init_costs_to_max(struct full_rtx_costs *c)
{
        c->speed = MAX_COST;
        c->size = MAX_COST;
}
...
static inline void init_costs_to_zero(struct full_rtx_costs *c)
{
        c->speed = 0;
        c->size = 0;
}
...
static inline bool costs_lt_p(struct full_rtx_costs *a, struct full_rtx_costs *b, bool speed)
{
        if (speed) {
                return (a->speed < b->speed || (a->speed == b->speed && a->size < b->size));
        } else {
                return (a->size < b->size || (a->size == b->size && a->speed < b->speed));
        }
}

/* Increase both members of the full_rtx_costs structure C by the
   cost of N insns.  */
static inline void costs_add_n_insns(struct full_rtx_costs *c, int n)
{
...
inline subreg_shape::subreg_shape(machine_mode inner_mode_in, poly_uint16 offset_in,
                                  machine_mode outer_mode_in)
        : inner_mode(inner_mode_in), offset(offset_in), outer_mode(outer_mode_in)
{
}

inline bool subreg_shape::operator==(const subreg_shape &other) const
{
        return (inner_mode == other.inner_mode && known_eq(offset, other.offset) &&
...
inline unsigned HOST_WIDE_INT subreg_shape::unique_id() const
{
        {
...
static inline subreg_shape shape_of_subreg(const_rtx x)
{
        return subreg_shape(GET_MODE(SUBREG_REG(x)), SUBREG_BYTE(x), GET_MODE(x));
}
...
namespace wi
{
template <> struct int_traits<rtx_mode_t> {
...
inline unsigned int wi::int_traits<rtx_mode_t>::get_precision(const rtx_mode_t &x)
{
        return GET_MODE_PRECISION(as_a<scalar_mode>(x.second));
}

inline wi::storage_ref
wi::int_traits<rtx_mode_t>::decompose(HOST_WIDE_INT *, unsigned int precision, const rtx_mode_t &x)
{
...
inline wi::hwi_with_prec wi::shwi(HOST_WIDE_INT val, machine_mode mode)
{
...
inline wide_int wi::min_value(machine_mode mode, signop sgn)
{
...
/* Produce the largest number that is represented in MODE.  The precision
   is taken from MODE and the sign from SGN.  */
inline wide_int wi::max_value(machine_mode mode, signop sgn)
{
...
namespace wi
{
typedef poly_int<NUM_POLY_INT_COEFFS, generic_wide_int<wide_int_ref_storage<false, false>>>
...
inline wi::rtx_to_poly_wide_ref const_poly_int_value(const_rtx x)
{
...
inline bool poly_int_rtx_p(const_rtx x)
{
...
inline wi::rtx_to_poly_wide_ref wi::to_poly_wide(const_rtx x, machine_mode mode)
{
...
inline poly_int64 rtx_to_poly_int64(const_rtx x)
{
        if (CONST_POLY_INT_P(x)) {
                poly_int64 res;
                for (unsigned int i = 0; i < NUM_POLY_INT_COEFFS; ++i) {
...
inline bool poly_int_rtx_p(const_rtx x, poly_int64_pod *res)
{
        if (CONST_INT_P(x)) {
                *res = INTVAL(x);
                return true;
...
extern void get_full_rtx_cost(rtx, machine_mode, enum rtx_code, int, struct full_rtx_costs *);
extern poly_uint64 subreg_lsb(const_rtx);
extern poly_uint64 subreg_lsb_1(machine_mode, machine_mode, poly_uint64);
extern poly_uint64 subreg_size_offset_from_lsb(poly_uint64, poly_uint64, poly_uint64);
...
inline poly_uint64 subreg_offset_from_lsb(machine_mode outer_mode, machine_mode inner_mode,
                                          poly_uint64 lsb_shift)
{
        return subreg_size_offset_from_lsb(GET_MODE_SIZE(outer_mode), GET_MODE_SIZE(inner_mode),
                                           lsb_shift);
}

extern unsigned int subreg_regno_offset(unsigned int, machine_mode, poly_uint64, machine_mode);
extern bool subreg_offset_representable_p(unsigned int, machine_mode, poly_uint64, machine_mode);
extern unsigned int subreg_regno(const_rtx);
extern int simplify_subreg_regno(unsigned int, machine_mode, poly_uint64, machine_mode);
...
extern void decompose_address(struct address_info *, rtx *, machine_mode, addr_space_t,
                              enum rtx_code);
...
#define SUBREG_PROMOTED_SET(RTX, VAL)                                                              \
        do {                                                                                       \
                rtx const _rtx = RTL_FLAG_CHECK1("SUBREG_PROMOTED_SET", (RTX), SUBREG);            \
                switch (VAL) {                                                                     \
                case SRP_POINTER:                                                                  \
                        _rtx->volatil = 0;                                                         \
                        _rtx->unchanging = 0;                                                      \
...
#define SUBREG_PROMOTED_SIGN(RTX)                                                                  \
        ((RTL_FLAG_CHECK1("SUBREG_PROMOTED_SIGN", (RTX), SUBREG)->volatil)                         \
                 ? 1                                                                               \
                 : (RTX)->unchanging - 1)
...
#define MEM_COPY_ATTRIBUTES(LHS, RHS)                                                              \
        (MEM_VOLATILE_P(LHS) = MEM_VOLATILE_P(RHS), MEM_NOTRAP_P(LHS) = MEM_NOTRAP_P(RHS),         \
         MEM_READONLY_P(LHS) = MEM_READONLY_P(RHS),                                                \
         MEM_KEEP_ALIAS_SET_P(LHS) = MEM_KEEP_ALIAS_SET_P(RHS),                                    \
         MEM_POINTER(LHS) = MEM_POINTER(RHS), MEM_ATTRS(LHS) = MEM_ATTRS(RHS))
...
#define SCHED_GROUP_P(RTX)                                                                         \
        (RTL_FLAG_CHECK4("SCHED_GROUP_P", (RTX), DEBUG_INSN, INSN, JUMP_INSN, CALL_INSN)->in_struct)
...
#define SYMBOL_REF_FLAGS(RTX)                                                                      \
        (RTL_FLAG_CHECK1("SYMBOL_REF_FLAGS", (RTX), SYMBOL_REF)->u2.symbol_ref_flags)
...
#if (defined(HAVE_PRE_INCREMENT) || defined(HAVE_PRE_DECREMENT) || defined(HAVE_POST_INCREMENT) || \
     defined(HAVE_POST_DECREMENT) || defined(HAVE_PRE_MODIFY_DISP) ||                              \
     defined(HAVE_POST_MODIFY_DISP) || defined(HAVE_PRE_MODIFY_REG) ||                             \
     defined(HAVE_POST_MODIFY_REG))
...
#define FIND_REG_INC_NOTE(INSN, REG)                                                               \
        ((REG) != NULL_RTX && REG_P((REG)) ? find_regno_note((INSN), REG_INC, REGNO(REG))          \
...
static inline int set_rtx_cost(rtx x, bool speed_p)
{
...
static inline void get_full_set_rtx_cost(rtx x, struct full_rtx_costs *c)
{
...
static inline int set_src_cost(rtx x, machine_mode mode, bool speed_p)
{
...
static inline void get_full_set_src_cost(rtx x, machine_mode mode, struct full_rtx_costs *c)
{
...
#define EXTRACT_ARGS_IN_RANGE(SIZE, POS, RANGE)                                                    \
        (IN_RANGE((POS), 0, (unsigned HOST_WIDE_INT)(RANGE)-1) &&                                  \
         IN_RANGE((SIZE), 1, (unsigned HOST_WIDE_INT)(RANGE) - (unsigned HOST_WIDE_INT)(POS)))
...
#define const_wide_int_alloc(NWORDS)                                                               \
        rtx_alloc_v(CONST_WIDE_INT,                                                                \
                    (sizeof(struct hwivec_def) + ((NWORDS)-1) * sizeof(HOST_WIDE_INT)))
...
inline bool const_vec_duplicate_p(const_rtx x)
{
        return (GET_CODE(x) == CONST_VECTOR && CONST_VECTOR_NPATTERNS(x) == 1 &&
...
template <typename T> inline bool const_vec_duplicate_p(T x, T *elt)
{
...
template <typename T> inline bool vec_duplicate_p(T x, T *elt)
{
        if (GET_CODE(x) == VEC_DUPLICATE && !VECTOR_MODE_P(GET_MODE(XEXP(x, 0)))) {
                *elt = XEXP(x, 0);
                return true;
        }
...
template <typename T> inline T unwrap_const_vec_duplicate(T x)
{
        if (const_vec_duplicate_p(x)) {
...
inline bool const_vec_series_p(const_rtx x, rtx *base_out, rtx *step_out)
{
        if (GET_CODE(x) == CONST_VECTOR && CONST_VECTOR_NPATTERNS(x) == 1 &&
            !CONST_VECTOR_DUPLICATE_P(x)) {
...
inline bool vec_series_p(const_rtx x, rtx *base_out, rtx *step_out)
{
...
inline scalar_int_mode subreg_unpromoted_mode(rtx x)
{
...
inline scalar_int_mode subreg_promoted_mode(rtx x)
{
        gcc_checking_assert(SUBREG_PROMOTED_VAR_P(x));
...
inline bool partial_subreg_p(machine_mode outermode, machine_mode innermode)
{
...
inline bool partial_subreg_p(const_rtx x)
{
...
inline bool paradoxical_subreg_p(machine_mode outermode, machine_mode innermode)
{
        /* Modes involved in a subreg must be ordered.  In particular, we must
           always know at compile time whether the subreg is paradoxical.  */
        poly_int64 outer_prec = GET_MODE_PRECISION(outermode);
...
inline bool paradoxical_subreg_p(const_rtx x)
{
        if (GET_CODE(x) != SUBREG) {
                return false;
        }
...
inline poly_uint64 subreg_lowpart_offset(machine_mode outermode, machine_mode innermode)
{
        return subreg_size_lowpart_offset(GET_MODE_SIZE(outermode), GET_MODE_SIZE(innermode));
}
...
inline machine_mode narrower_subreg_mode(machine_mode outermode, machine_mode innermode)
{
...
inline machine_mode wider_subreg_mode(machine_mode outermode, machine_mode innermode)
{
...
inline machine_mode wider_subreg_mode(const_rtx x)
{
...
inline poly_uint64 subreg_highpart_offset(machine_mode outermode, machine_mode innermode)
{
        return subreg_size_highpart_offset(GET_MODE_SIZE(outermode), GET_MODE_SIZE(innermode));
}

extern poly_int64 byte_lowpart_offset(machine_mode, machine_mode);
extern poly_int64 subreg_memory_offset(machine_mode, machine_mode, poly_uint64);
extern poly_int64 subreg_memory_offset(const_rtx);
extern rtx make_safe_from(rtx, rtx);
extern rtx convert_memory_address_addr_space_1(scalar_int_mode, rtx, addr_space_t, bool, bool);
extern rtx convert_memory_address_addr_space(scalar_int_mode, rtx, addr_space_t);
...
#if TARGET_SUPPORTS_WIDE_INT == 0
extern rtx immed_double_const(HOST_WIDE_INT, HOST_WIDE_INT, machine_mode);
#endif
...
extern rtx_jump_insn *emit_jump_insn_before_setloc(rtx, rtx_insn *, location_t);
...
inline bool unsigned_condition_p(enum rtx_code code)
{
...
/* In simplify-rtx.c  */
extern rtx simplify_const_unary_operation(enum rtx_code, machine_mode, rtx, machine_mode);
extern rtx simplify_unary_operation(enum rtx_code, machine_mode, rtx, machine_mode);
extern rtx simplify_const_binary_operation(enum rtx_code, machine_mode, rtx, rtx);
extern rtx simplify_binary_operation(enum rtx_code, machine_mode, rtx, rtx);
extern rtx simplify_ternary_operation(enum rtx_code, machine_mode, machine_mode, rtx, rtx, rtx);
extern rtx simplify_const_relational_operation(enum rtx_code, machine_mode, rtx, rtx);
extern rtx simplify_relational_operation(enum rtx_code, machine_mode, machine_mode, rtx, rtx);
extern rtx simplify_gen_binary(enum rtx_code, machine_mode, rtx, rtx);
extern rtx simplify_gen_unary(enum rtx_code, machine_mode, rtx, machine_mode);
extern rtx simplify_gen_ternary(enum rtx_code, machine_mode, machine_mode, rtx, rtx, rtx);
extern rtx simplify_gen_relational(enum rtx_code, machine_mode, machine_mode, rtx, rtx);
...
extern rtx simplify_replace_fn_rtx(rtx, const_rtx, rtx (*fn)(rtx, const_rtx, void *), void *);
...
extern bool reg_is_clobbered_by_clobber_high(unsigned int, machine_mode, const_rtx);

/* Convenient wrapper for reg_is_clobbered_by_clobber_high.  */
inline bool reg_is_clobbered_by_clobber_high(const_rtx x, const_rtx clobber_high_op)
{
        return reg_is_clobbered_by_clobber_high(REGNO(x), GET_MODE(x), clobber_high_op);
}

/* Overload for refers_to_regno_p for checking a single register.  */
inline bool refers_to_regno_p(unsigned int regnum, const_rtx x, rtx *loc = NULL)
{
...
extern int rtx_equal_p_cb(const_rtx, const_rtx, rtx_equal_p_callback_function);

typedef int (*hash_rtx_callback_function)(const_rtx, machine_mode, rtx *, machine_mode *);
extern unsigned hash_rtx_cb(const_rtx, machine_mode, int *, int *, bool,
...
/* Given an insn and condition, return a canonical description of
   the test being made.  */
extern rtx canonicalize_condition(rtx_insn *, rtx, int, rtx_insn **, rtx, int, int);
...
extern void subreg_get_info(unsigned int, machine_mode, poly_uint64, machine_mode,
                            struct subreg_info *);
...
extern const char *decode_asm_operands(rtx, rtx *, rtx **, const char **, machine_mode *,
                                       location_t *);
...
extern void setup_reg_classes(int, enum reg_class, enum reg_class, enum reg_class);
...
static inline const struct mem_attrs *get_mem_attrs(const_rtx x)
{
...
extern rtx_insn *gen_rtx_INSN(machine_mode mode, rtx_insn *prev_insn, rtx_insn *next_insn,
                              basic_block bb, rtx pattern, int location, int code, rtx reg_notes);
...
extern rtx gen_rtx_VAR_LOCATION(machine_mode, tree, rtx, enum var_init_status);

#ifdef GENERATOR_FILE
#define PUT_MODE(RTX, MODE) PUT_MODE_RAW(RTX, MODE)
#else
static inline void PUT_MODE(rtx x, machine_mode mode)
{
        if (REG_P(x)) {
...
#define REGNO_PTR_FRAME_P(REGNUM)                                                                  \
        ((REGNUM) == STACK_POINTER_REGNUM || (REGNUM) == FRAME_POINTER_REGNUM ||                   \
         (REGNUM) == HARD_FRAME_POINTER_REGNUM || (REGNUM) == ARG_POINTER_REGNUM ||                \
         ((REGNUM) >= FIRST_VIRTUAL_REGISTER && (REGNUM) <= LAST_VIRTUAL_POINTER_REGISTER))
...
extern enum rtx_code reversed_comparison_code_parts(enum rtx_code, const_rtx, const_rtx,
                                                    const rtx_insn *);
...
extern bool validate_subreg(machine_mode, machine_mode, const_rtx, poly_uint64);
...
/* In expr.c */
extern rtx move_by_pieces(rtx, rtx, unsigned HOST_WIDE_INT, unsigned int, memop_ret);
...
extern rtx emit_library_call_value_1(int, rtx, rtx, enum libcall_type, machine_mode, int,
                                     rtx_mode_t *);
...
inline void emit_library_call(rtx fun, libcall_type fn_type, machine_mode outmode)
{
        emit_library_call_value_1(0, fun, NULL_RTX, fn_type, outmode, 0, NULL);
}

inline void emit_library_call(rtx fun, libcall_type fn_type, machine_mode outmode, rtx arg1,
...
inline void emit_library_call(rtx fun, libcall_type fn_type, machine_mode outmode, rtx arg1,
                              machine_mode arg1_mode, rtx arg2, machine_mode arg2_mode)
{
        rtx_mode_t args[] = {rtx_mode_t(arg1, arg1_mode), rtx_mode_t(arg2, arg2_mode)};
        emit_library_call_value_1(0, fun, NULL_RTX, fn_type, outmode, 2, args);
}

inline void emit_library_call(rtx fun, libcall_type fn_type, machine_mode outmode, rtx arg1,
                              machine_mode arg1_mode, rtx arg2, machine_mode arg2_mode, rtx arg3,
...
inline void emit_library_call(rtx fun, libcall_type fn_type, machine_mode outmode, rtx arg1,
                              machine_mode arg1_mode, rtx arg2, machine_mode arg2_mode, rtx arg3,
                              machine_mode arg3_mode, rtx arg4, machine_mode arg4_mode)
{
        rtx_mode_t args[] = {rtx_mode_t(arg1, arg1_mode), rtx_mode_t(arg2, arg2_mode),
                             rtx_mode_t(arg3, arg3_mode), rtx_mode_t(arg4, arg4_mode)};
...
inline rtx emit_library_call_value(rtx fun, rtx value, libcall_type fn_type, machine_mode outmode)
{
...
inline rtx emit_library_call_value(rtx fun, rtx value, libcall_type fn_type, machine_mode outmode,
                                   rtx arg1, machine_mode arg1_mode, rtx arg2,
...
inline rtx emit_library_call_value(rtx fun, rtx value, libcall_type fn_type, machine_mode outmode,
                                   rtx arg1, machine_mode arg1_mode, rtx arg2,
                                   machine_mode arg2_mode, rtx arg3, machine_mode arg3_mode)
{
        rtx_mode_t args[] = {rtx_mode_t(arg1, arg1_mode), rtx_mode_t(arg2, arg2_mode),
                             rtx_mode_t(arg3, arg3_mode)};
...
extern int canon_true_dependence(const_rtx, machine_mode, rtx, const_rtx, rtx);
extern int read_dependence(const_rtx, const_rtx);
extern int anti_dependence(const_rtx, const_rtx);
extern int canon_anti_dependence(const_rtx, bool, const_rtx, machine_mode, rtx);
extern int output_dependence(const_rtx, const_rtx);
extern int canon_output_dependence(const_rtx, bool, const_rtx, machine_mode, rtx);
...
/* In stor-layout.c.  */
extern void get_mode_bounds(scalar_int_mode, int, scalar_int_mode, rtx *, rtx *);
...
/* rtl-error.c */
extern void _fatal_insn_not_found(const_rtx, const char *, int,
                                  const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
...
inline rtx_code load_extend_op(machine_mode mode)
{
...
inline rtx strip_offset_and_add(rtx x, poly_int64_pod *offset)
{
        if (GET_CODE(x) == PLUS) {
...
inline bool word_register_operation_p(const_rtx x)
{
        switch (GET_CODE(x)) {
        case CONST_INT:
        case ROTATE:
