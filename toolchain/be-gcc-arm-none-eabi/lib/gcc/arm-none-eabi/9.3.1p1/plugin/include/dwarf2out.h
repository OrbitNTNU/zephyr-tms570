...
typedef union GTY(()) {
        ...
        struct dw_cfa_location *GTY((tag("dw_cfi_oprnd_cfa_loc"))) dw_cfi_cfa_loc;
} dw_cfi_oprnd;

struct GTY(()) dw_cfi_node {
        enum dwarf_call_frame_info dw_cfi_opc;
        dw_cfi_oprnd GTY((desc("dw_cfi_oprnd1_desc (%1.dw_cfi_opc)"))) dw_cfi_oprnd1;
        dw_cfi_oprnd GTY((desc("dw_cfi_oprnd2_desc (%1.dw_cfi_opc)"))) dw_cfi_oprnd2;
};
...
struct GTY(()) dw_val_node {
        ...
        union dw_val_struct_union {
                ...
                struct dwarf_file_data *GTY((tag("dw_val_class_file_implicit"))) val_file_implicit;
...
extern struct dw_loc_descr_node *build_cfa_loc(dw_cfa_location *, poly_int64);
extern struct dw_loc_descr_node *build_cfa_aligned_loc(dw_cfa_location *, poly_int64,
                                                       HOST_WIDE_INT);
extern struct dw_loc_descr_node *mem_loc_descriptor(rtx, machine_mode mode, machine_mode mem_mode,
...
extern void lookup_cfa_1(dw_cfi_ref cfi, dw_cfa_location *loc, dw_cfa_location *remember);
...
extern enum dw_cfi_oprnd_type dw_cfi_oprnd1_desc(enum dwarf_call_frame_info cfi);
extern enum dw_cfi_oprnd_type dw_cfi_oprnd2_desc(enum dwarf_call_frame_info cfi);
