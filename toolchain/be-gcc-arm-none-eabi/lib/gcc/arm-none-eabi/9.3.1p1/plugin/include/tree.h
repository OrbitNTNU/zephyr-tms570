...
inline combined_fn as_combined_fn(built_in_function fn)
{
...
inline combined_fn as_combined_fn(internal_fn fn)
{
...
inline bool builtin_fn_p(combined_fn code)
{
...
inline built_in_function as_builtin_fn(combined_fn code)
{
...
inline bool internal_fn_p(combined_fn code)
{
        return int(code) >= int(END_BUILTINS);
}
...
inline internal_fn as_internal_fn(combined_fn code)
{
...
#define MARK_TS_TYPED(C) (MARK_TS_BASE(C), tree_contains_struct[C][TS_TYPED] = true)

#define MARK_TS_COMMON(C) (MARK_TS_TYPED(C), tree_contains_struct[C][TS_COMMON] = true)

#define MARK_TS_TYPE_COMMON(C) (MARK_TS_COMMON(C), tree_contains_struct[C][TS_TYPE_COMMON] = true)

#define MARK_TS_TYPE_WITH_LANG_SPECIFIC(C)                                                         \
        (MARK_TS_TYPE_COMMON(C), tree_contains_struct[C][TS_TYPE_WITH_LANG_SPECIFIC] = true)

#define MARK_TS_DECL_MINIMAL(C) (MARK_TS_COMMON(C), tree_contains_struct[C][TS_DECL_MINIMAL] = true)

#define MARK_TS_DECL_COMMON(C)                                                                     \
        (MARK_TS_DECL_MINIMAL(C), tree_contains_struct[C][TS_DECL_COMMON] = true)

#define MARK_TS_DECL_WRTL(C) (MARK_TS_DECL_COMMON(C), tree_contains_struct[C][TS_DECL_WRTL] = true)

#define MARK_TS_DECL_WITH_VIS(C)                                                                   \
        (MARK_TS_DECL_WRTL(C), tree_contains_struct[C][TS_DECL_WITH_VIS] = true)

#define MARK_TS_DECL_NON_COMMON(C)                                                                 \
        (MARK_TS_DECL_WITH_VIS(C), tree_contains_struct[C][TS_DECL_NON_COMMON] = true)
...
#define TREE_CHECK(T, CODE) (tree_check((T), __FILE__, __LINE__, __FUNCTION__, (CODE)))

#define TREE_NOT_CHECK(T, CODE) (tree_not_check((T), __FILE__, __LINE__, __FUNCTION__, (CODE)))
...
#define TREE_NOT_CHECK3(T, CODE1, CODE2, CODE3)                                                    \
        (tree_not_check3((T), __FILE__, __LINE__, __FUNCTION__, (CODE1), (CODE2), (CODE3)))

#define TREE_CHECK4(T, CODE1, CODE2, CODE3, CODE4)                                                 \
        (tree_check4((T), __FILE__, __LINE__, __FUNCTION__, (CODE1), (CODE2), (CODE3), (CODE4)))

#define TREE_NOT_CHECK4(T, CODE1, CODE2, CODE3, CODE4)                                             \
        (tree_not_check4((T), __FILE__, __LINE__, __FUNCTION__, (CODE1), (CODE2), (CODE3), (CODE4)))

#define TREE_CHECK5(T, CODE1, CODE2, CODE3, CODE4, CODE5)                                          \
        (tree_check5((T), __FILE__, __LINE__, __FUNCTION__, (CODE1), (CODE2), (CODE3), (CODE4),    \
                     (CODE5)))

#define TREE_NOT_CHECK5(T, CODE1, CODE2, CODE3, CODE4, CODE5)                                      \
        (tree_not_check5((T), __FILE__, __LINE__, __FUNCTION__, (CODE1), (CODE2), (CODE3),         \
                         (CODE4), (CODE5)))
...
#define OMP_CLAUSE_RANGE_CHECK(T, CODE1, CODE2)                                                    \
        (omp_clause_range_check((T), (CODE1), (CODE2), __FILE__, __LINE__, __FUNCTION__))

/* These checks have to be special cased.  */
#define EXPR_CHECK(T) (expr_check((T), __FILE__, __LINE__, __FUNCTION__))

/* These checks have to be special cased.  */
#define NON_TYPE_CHECK(T) (non_type_check((T), __FILE__, __LINE__, __FUNCTION__))

/* These checks have to be special cased.  */
#define ANY_INTEGRAL_TYPE_CHECK(T) (any_integral_type_check((T), __FILE__, __LINE__, __FUNCTION__))
...
#define TREE_OPERAND_CHECK_CODE(T, CODE, I)                                                        \
        (*(tree_operand_check_code((T), (CODE), (I), __FILE__, __LINE__, __FUNCTION__)))
...
#define TREE_CHAIN(NODE) (CONTAINS_STRUCT_CHECK(NODE, TS_COMMON)->common.chain)
...
extern void tree_contains_struct_check_failed(const_tree, const enum tree_node_structure_enum,
                                              const char *, int,
...
extern void tree_not_check_failed(const_tree, const char *, int, const char *,
                                  ...) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void tree_class_check_failed(const_tree, const enum tree_code_class, const char *, int,
                                    const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void tree_range_check_failed(const_tree, const char *, int, const char *, enum tree_code,
                                    enum tree_code) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void tree_not_class_check_failed(const_tree, const enum tree_code_class, const char *, int,
                                        const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void tree_int_cst_elt_check_failed(int, int, const char *, int,
                                          const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void tree_vec_elt_check_failed(int, int, const char *, int,
                                      const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void phi_node_elt_check_failed(int, int, const char *, int,
                                      const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void tree_operand_check_failed(int, const_tree, const char *, int,
                                      const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void omp_clause_check_failed(const_tree, const char *, int, const char *,
                                    enum omp_clause_code) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void omp_clause_operand_check_failed(int, const_tree, const char *, int,
                                            const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
extern void omp_clause_range_check_failed(const_tree, const char *, int, const char *,
...
#define NUMERICAL_TYPE_CHECK(T)                                                                    \
        TREE_CHECK5(T, INTEGER_TYPE, ENUMERAL_TYPE, BOOLEAN_TYPE, REAL_TYPE, FIXED_POINT_TYPE)
...
#define VECTOR_BOOLEAN_TYPE_P(TYPE)                                                                \
        (TREE_CODE(TYPE) == VECTOR_TYPE && TREE_CODE(TREE_TYPE(TYPE)) == BOOLEAN_TYPE)
...
#define ANY_INTEGRAL_TYPE_P(TYPE)                                                                  \
        (INTEGRAL_TYPE_P(TYPE) || ((TREE_CODE(TYPE) == COMPLEX_TYPE || VECTOR_TYPE_P(TYPE)) &&     \
...
#define COMPLEX_FLOAT_TYPE_P(TYPE)                                                                 \
        (TREE_CODE(TYPE) == COMPLEX_TYPE && TREE_CODE(TREE_TYPE(TYPE)) == REAL_TYPE)

/* Nonzero if TYPE represents a vector integer type.  */

#define VECTOR_INTEGER_TYPE_P(TYPE)                                                                \
        (VECTOR_TYPE_P(TYPE) && TREE_CODE(TREE_TYPE(TYPE)) == INTEGER_TYPE)

/* Nonzero if TYPE represents a vector floating-point type.  */

#define VECTOR_FLOAT_TYPE_P(TYPE) (VECTOR_TYPE_P(TYPE) && TREE_CODE(TREE_TYPE(TYPE)) == REAL_TYPE)
...
#define FLOAT_TYPE_P(TYPE)                                                                         \
        (SCALAR_FLOAT_TYPE_P(TYPE) || ((TREE_CODE(TYPE) == COMPLEX_TYPE || VECTOR_TYPE_P(TYPE)) && \
...
#define TREE_THIS_NOTRAP(NODE)                                                                     \
        (TREE_CHECK5(NODE, INDIRECT_REF, MEM_REF, TARGET_MEM_REF, ARRAY_REF, ARRAY_RANGE_REF)      \
                 ->base.nothrow_flag)
...
#define DECL_BY_REFERENCE(NODE)                                                                    \
        (TREE_CHECK3(NODE, VAR_DECL, PARM_DECL, RESULT_DECL)->decl_common.decl_by_reference_flag)
...
#define DECL_NONSHAREABLE(NODE)                                                                    \
        (TREE_CHECK2(NODE, VAR_DECL, RESULT_DECL)->decl_common.decl_nonshareable_flag)
...
#define TYPE_REVERSE_STORAGE_ORDER(NODE)                                                           \
        (TREE_CHECK4(NODE, RECORD_TYPE, UNION_TYPE, QUAL_UNION_TYPE, ARRAY_TYPE)                   \
                 ->base.u.bits.saturating_flag)

/* In a non-aggregate type, indicates a saturating type.  */
#define TYPE_SATURATING(NODE)                                                                      \
        (TREE_NOT_CHECK4(NODE, RECORD_TYPE, UNION_TYPE, QUAL_UNION_TYPE, ARRAY_TYPE)               \
                 ->base.u.bits.saturating_flag)
...
#define TREE_INT_CST_OFFSET_NUNITS(NODE) (INTEGER_CST_CHECK(NODE)->base.u.int_length.offset)
...
#define FOR_EACH_CONSTRUCTOR_VALUE(V, IX, VAL)                                                     \
        for (IX = 0; (IX >= vec_safe_length(V)) ? false : ((VAL = (*(V))[IX].value), true); (IX)++)
...
#define FOR_EACH_CONSTRUCTOR_ELT(V, IX, INDEX, VAL)                                                \
        for (IX = 0; (IX >= vec_safe_length(V))                                                    \
                             ? false                                                               \
                             : (((void)(VAL = (*V)[IX].value)), (INDEX = (*V)[IX].index), true);   \
             (IX)++)
...
#define IS_EMPTY_STMT(NODE)                                                                        \
        (TREE_CODE(NODE) == NOP_EXPR && VOID_TYPE_P(TREE_TYPE(NODE)) &&                            \
...
#define EXPR_HAS_LOCATION(NODE)        (LOCATION_LOCUS(EXPR_LOCATION(NODE)) != UNKNOWN_LOCATION)
/* The location to be used in a diagnostic about this expression.  Do not
   use this macro if the location will be assigned to other expressions.  */
#define EXPR_LOC_OR_LOC(NODE, LOCUS)   (EXPR_HAS_LOCATION(NODE) ? (NODE)->exp.locus : (LOCUS))
...
#define EXPR_HAS_RANGE(NODE)                                                                       \
        (CAN_HAVE_RANGE_P(NODE) ? EXPR_LOCATION_RANGE(NODE).m_start != UNKNOWN_LOCATION : false)

/* True if a tree is an expression or statement that can have a
   location.  */
#define CAN_HAVE_LOCATION_P(NODE) ((NODE) && EXPR_P(NODE))

static inline source_range get_expr_source_range(tree expr)
{
...
#define OMP_CLAUSES(NODE) TREE_OPERAND(TREE_RANGE_CHECK(NODE, OACC_PARALLEL, OMP_TASKGROUP), 1)
...
#define OMP_CLAUSE_SIZE(NODE)                                                                      \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_RANGE_CHECK(OMP_CLAUSE_CHECK(NODE), OMP_CLAUSE_FROM,         \
                                                  OMP_CLAUSE__CACHE_),                             \
                           1)

#define OMP_CLAUSE_CHAIN(NODE) TREE_CHAIN(OMP_CLAUSE_CHECK(NODE))
#define OMP_CLAUSE_DECL(NODE)                                                                      \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_RANGE_CHECK(OMP_CLAUSE_CHECK(NODE), OMP_CLAUSE_PRIVATE,      \
                                                  OMP_CLAUSE__REDUCTEMP_),                         \
                           0)
#define OMP_CLAUSE_HAS_LOCATION(NODE)                                                              \
        (LOCATION_LOCUS((OMP_CLAUSE_CHECK(NODE))->omp_clause.locus) != UNKNOWN_LOCATION)
...
#define OMP_ATOMIC_MEMORY_ORDER(NODE)                                                              \
        (TREE_RANGE_CHECK(NODE, OMP_ATOMIC, OMP_ATOMIC_CAPTURE_NEW)->base.u.omp_atomic_memory_order)
...
#define OMP_CLAUSE_LASTPRIVATE_STMT(NODE)                                                          \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_LASTPRIVATE), 1)
...
#define OMP_CLAUSE_GANG_EXPR(NODE)                                                                 \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_GANG), 0)
#define OMP_CLAUSE_GANG_STATIC_EXPR(NODE)                                                          \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_GANG), 1)
#define OMP_CLAUSE_ASYNC_EXPR(NODE)                                                                \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_ASYNC), 0)
#define OMP_CLAUSE_WAIT_EXPR(NODE)                                                                 \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_WAIT), 0)
#define OMP_CLAUSE_VECTOR_EXPR(NODE)                                                               \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_VECTOR), 0)
#define OMP_CLAUSE_WORKER_EXPR(NODE)                                                               \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_WORKER), 0)
...
#define OMP_CLAUSE_NUM_WORKERS_EXPR(NODE)                                                          \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_NUM_WORKERS), 0)
#define OMP_CLAUSE_VECTOR_LENGTH_EXPR(NODE)                                                        \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_VECTOR_LENGTH), 0)

#define OMP_CLAUSE_DEPEND_KIND(NODE)                                                               \
        (OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_DEPEND)->omp_clause.subcode.depend_kind)

#define OMP_CLAUSE_DEPEND_SINK_NEGATIVE(NODE) TREE_PUBLIC(TREE_LIST_CHECK(NODE))
...
#define OMP_CLAUSE_REDUCTION_CODE(NODE)                                                            \
        (OMP_CLAUSE_RANGE_CHECK(NODE, OMP_CLAUSE_REDUCTION, OMP_CLAUSE_IN_REDUCTION)               \
                 ->omp_clause.subcode.reduction_code)
#define OMP_CLAUSE_REDUCTION_INIT(NODE)                                                            \
        OMP_CLAUSE_OPERAND(                                                                        \
                OMP_CLAUSE_RANGE_CHECK(NODE, OMP_CLAUSE_REDUCTION, OMP_CLAUSE_IN_REDUCTION), 1)
#define OMP_CLAUSE_REDUCTION_MERGE(NODE)                                                           \
        OMP_CLAUSE_OPERAND(                                                                        \
                OMP_CLAUSE_RANGE_CHECK(NODE, OMP_CLAUSE_REDUCTION, OMP_CLAUSE_IN_REDUCTION), 2)
...
#define OMP_CLAUSE_REDUCTION_PLACEHOLDER(NODE)                                                     \
        OMP_CLAUSE_OPERAND(                                                                        \
                OMP_CLAUSE_RANGE_CHECK(NODE, OMP_CLAUSE_REDUCTION, OMP_CLAUSE_IN_REDUCTION), 3)
#define OMP_CLAUSE_REDUCTION_DECL_PLACEHOLDER(NODE)                                                \
        OMP_CLAUSE_OPERAND(                                                                        \
                OMP_CLAUSE_RANGE_CHECK(NODE, OMP_CLAUSE_REDUCTION, OMP_CLAUSE_IN_REDUCTION), 4)
...
#define OMP_CLAUSE_THREAD_LIMIT_EXPR(NODE)                                                         \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_THREAD_LIMIT), 0)
...
#define OMP_CLAUSE_DIST_SCHEDULE_CHUNK_EXPR(NODE)                                                  \
        OMP_CLAUSE_OPERAND(OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE_DIST_SCHEDULE), 0)
...
#define OMP_CLAUSE_DEFAULTMAP_CATEGORY(NODE)                                                       \
        ((enum omp_clause_defaultmap_kind)(OMP_CLAUSE_DEFAULTMAP_KIND(NODE) &                      \
...
#define OMP_CLAUSE_DEFAULTMAP_SET_KIND(NODE, BEHAVIOR, CATEGORY)                                   \
        (OMP_CLAUSE_DEFAULTMAP_KIND(NODE) = (enum omp_clause_defaultmap_kind)(CATEGORY | BEHAVIOR))
...
#define OMP_CLAUSE__GRIDDIM__DIMENSION(NODE)                                                       \
        (OMP_CLAUSE_SUBCODE_CHECK(NODE, OMP_CLAUSE__GRIDDIM_)->omp_clause.subcode.dimension)
...
#define SET_SSA_NAME_VAR_OR_IDENTIFIER(NODE, VAR)                                                  \
        do {                                                                                       \
                ...
                SSA_NAME_IS_VIRTUAL_OPERAND(NODE) = (var_ && TREE_CODE(var_) == VAR_DECL &&        \
...
#define SSA_NAME_ANTI_RANGE_P(N) SSA_NAME_CHECK(N)->base.static_flag

/* The type of range described by SSA_NAME_RANGE_INFO.  */
#define SSA_NAME_RANGE_TYPE(N) (SSA_NAME_ANTI_RANGE_P(N) ? VR_ANTI_RANGE : VR_RANGE)
...
#define TYPE_MODE(NODE)                                                                            \
        (VECTOR_TYPE_P(TYPE_CHECK(NODE)) ? vector_type_mode(NODE) : (NODE)->type_common.mode)
...
#define TYPE_ALIGN(NODE)                                                                           \
        (TYPE_CHECK(NODE)->type_common.align ? ((unsigned)1) << ((NODE)->type_common.align - 1) : 0)
...
#define TYPE_WARN_IF_NOT_ALIGN(NODE)                                                               \
        (TYPE_CHECK(NODE)->type_common.warn_if_not_align                                           \
                 ? ((unsigned)1) << ((NODE)->type_common.warn_if_not_align - 1)                    \
                 : 0)
...
#define SSA_VAR_P(DECL)                                                                            \
        (TREE_CODE(DECL) == VAR_DECL || TREE_CODE(DECL) == PARM_DECL ||                            \
         TREE_CODE(DECL) == RESULT_DECL || TREE_CODE(DECL) == SSA_NAME)
...
#define TYPE_IDENTIFIER(NODE)                                                                      \
        (TYPE_NAME(NODE) && DECL_P(TYPE_NAME(NODE)) ? DECL_NAME(TYPE_NAME(NODE)) : TYPE_NAME(NODE))
...
#define DECL_PT_UID(NODE)                                                                          \
        (DECL_COMMON_CHECK(NODE)->decl_common.pt_uid == -1u ? (NODE)->decl_minimal.uid             \
...
#define SET_DECL_ALIGN(NODE, X) (DECL_COMMON_CHECK(NODE)->decl_common.align = ffs_hwi(X))
...
#define DECL_WARN_IF_NOT_ALIGN(NODE)                                                               \
        (DECL_COMMON_CHECK(NODE)->decl_common.warn_if_not_align                                    \
                 ? ((unsigned)1) << ((NODE)->decl_common.warn_if_not_align - 1)                    \
                 : 0)
...
#define ALLOCA_FUNCTION_CODE_P(FCODE)                                                              \
        ((FCODE) == BUILT_IN_ALLOCA || (FCODE) == BUILT_IN_ALLOCA_WITH_ALIGN ||                    \
...
#define DECL_HAS_VALUE_EXPR_P(NODE)                                                                \
        (TREE_CHECK3(NODE, VAR_DECL, PARM_DECL, RESULT_DECL)->decl_common.decl_flag_2)
...
#define DECL_ONE_ONLY(NODE)                                                                        \
        (DECL_COMDAT_GROUP(NODE) != NULL_TREE && (TREE_PUBLIC(NODE) || DECL_EXTERNAL(NODE)))
...
#define DECL_LAMBDA_FUNCTION(NODE) (FUNCTION_DECL_CHECK(NODE)->function_decl.lambda_function)
...
inline tree tree_check(tree __t, const char *__f, int __l, const char *__g, tree_code __c)
{
...
inline tree tree_not_check(tree __t, const char *__f, int __l, const char *__g, enum tree_code __c)
{
        if (TREE_CODE(__t) == __c) {
...
inline tree tree_check2(tree __t, const char *__f, int __l, const char *__g, enum tree_code __c1,
                        enum tree_code __c2)
{
        if (TREE_CODE(__t) != __c1 && TREE_CODE(__t) != __c2) {
                tree_check_failed(__t, __f, __l, __g, __c1, __c2, 0);
        }
        return __t;
}

inline tree tree_not_check2(tree __t, const char *__f, int __l, const char *__g,
...
inline tree tree_check3(tree __t, const char *__f, int __l, const char *__g, enum tree_code __c1,
                        enum tree_code __c2, enum tree_code __c3)
{
        if (TREE_CODE(__t) != __c1 && TREE_CODE(__t) != __c2 && TREE_CODE(__t) != __c3) {
                tree_check_failed(__t, __f, __l, __g, __c1, __c2, __c3, 0);
        }
        return __t;
}

inline tree tree_not_check3(tree __t, const char *__f, int __l, const char *__g,
...
inline tree tree_check4(tree __t, const char *__f, int __l, const char *__g, enum tree_code __c1,
                        enum tree_code __c2, enum tree_code __c3, enum tree_code __c4)
{
        if (TREE_CODE(__t) != __c1 && TREE_CODE(__t) != __c2 && TREE_CODE(__t) != __c3 &&
            TREE_CODE(__t) != __c4) {
...
inline tree tree_not_check4(tree __t, const char *__f, int __l, const char *__g,
                            enum tree_code __c1, enum tree_code __c2, enum tree_code __c3,
                            enum tree_code __c4)
{
        if (TREE_CODE(__t) == __c1 || TREE_CODE(__t) == __c2 || TREE_CODE(__t) == __c3 ||
...
inline tree tree_check5(tree __t, const char *__f, int __l, const char *__g, enum tree_code __c1,
                        enum tree_code __c2, enum tree_code __c3, enum tree_code __c4,
                        enum tree_code __c5)
{
        if (TREE_CODE(__t) != __c1 && TREE_CODE(__t) != __c2 && TREE_CODE(__t) != __c3 &&
            TREE_CODE(__t) != __c4 && TREE_CODE(__t) != __c5) {
                tree_check_failed(__t, __f, __l, __g, __c1, __c2, __c3, __c4, __c5, 0);
        }
        return __t;
}

inline tree tree_not_check5(tree __t, const char *__f, int __l, const char *__g,
                            enum tree_code __c1, enum tree_code __c2, enum tree_code __c3,
...
inline tree contains_struct_check(tree __t, const enum tree_node_structure_enum __s,
...
inline tree tree_class_check(tree __t, const enum tree_code_class __class, const char *__f, int __l,
                             const char *__g)
{
...
inline tree tree_range_check(tree __t, enum tree_code __code1, enum tree_code __code2,
                             const char *__f, int __l, const char *__g)
{
...
inline tree omp_clause_subcode_check(tree __t, enum omp_clause_code __code, const char *__f,
                                     int __l, const char *__g)
{
...
inline tree omp_clause_range_check(tree __t, enum omp_clause_code __code1,
                                   enum omp_clause_code __code2, const char *__f, int __l,
                                   const char *__g)
{
        if (TREE_CODE(__t) != OMP_CLAUSE) {
                tree_check_failed(__t, __f, __l, __g, OMP_CLAUSE, 0);
        }
        if ((int)__t->omp_clause.code < (int)__code1 || (int)__t->omp_clause.code > (int)__code2) {
...
inline tree expr_check(tree __t, const char *__f, int __l, const char *__g)
{
...
inline tree non_type_check(tree __t, const char *__f, int __l, const char *__g)
{
        if (TYPE_P(__t)) {
...
inline const HOST_WIDE_INT *tree_int_cst_elt_check(const_tree __t, int __i, const char *__f,
                                                   int __l, const char *__g)
{
        ...
        if (__i < 0 || __i >= __t->base.u.int_length.extended) {
                tree_int_cst_elt_check_failed(__i, __t->base.u.int_length.extended, __f, __l, __g);
        }
        return &CONST_CAST_TREE(__t)->int_cst.val[__i];
}

inline HOST_WIDE_INT *tree_int_cst_elt_check(tree __t, int __i, const char *__f, int __l,
                                             const char *__g)
{
        if (TREE_CODE(__t) != INTEGER_CST) {
                tree_check_failed(__t, __f, __l, __g, INTEGER_CST, 0);
...
inline tree *tree_vec_elt_check(tree __t, int __i, const char *__f, int __l, const char *__g)
{
...
inline tree any_integral_type_check(tree __t, const char *__f, int __l, const char *__g)
{
        if (!ANY_INTEGRAL_TYPE_P(__t)) {
                tree_check_failed(__t, __f, __l, __g, BOOLEAN_TYPE, ENUMERAL_TYPE, INTEGER_TYPE, 0);
        }
        return __t;
}

inline const_tree tree_check(const_tree __t, const char *__f, int __l, const char *__g,
                             tree_code __c)
{
        if (TREE_CODE(__t) != __c) {
                tree_check_failed(__t, __f, __l, __g, __c, 0);
...
inline const_tree tree_not_check(const_tree __t, const char *__f, int __l, const char *__g,
                                 enum tree_code __c)
{
        if (TREE_CODE(__t) == __c) {
                tree_not_check_failed(__t, __f, __l, __g, __c, 0);
...
inline const_tree tree_check2(const_tree __t, const char *__f, int __l, const char *__g,
                              enum tree_code __c1, enum tree_code __c2)
{
        if (TREE_CODE(__t) != __c1 && TREE_CODE(__t) != __c2) {
                tree_check_failed(__t, __f, __l, __g, __c1, __c2, 0);
...
inline const_tree tree_not_check2(const_tree __t, const char *__f, int __l, const char *__g,
                                  enum tree_code __c1, enum tree_code __c2)
{
        if (TREE_CODE(__t) == __c1 || TREE_CODE(__t) == __c2) {
                tree_not_check_failed(__t, __f, __l, __g, __c1, __c2, 0);
...
inline const_tree tree_check3(const_tree __t, const char *__f, int __l, const char *__g,
                              enum tree_code __c1, enum tree_code __c2, enum tree_code __c3)
{
        if (TREE_CODE(__t) != __c1 && TREE_CODE(__t) != __c2 && TREE_CODE(__t) != __c3) {
                tree_check_failed(__t, __f, __l, __g, __c1, __c2, __c3, 0);
...
inline const_tree tree_not_check3(const_tree __t, const char *__f, int __l, const char *__g,
                                  enum tree_code __c1, enum tree_code __c2, enum tree_code __c3)
{
        if (TREE_CODE(__t) == __c1 || TREE_CODE(__t) == __c2 || TREE_CODE(__t) == __c3) {
                tree_not_check_failed(__t, __f, __l, __g, __c1, __c2, __c3, 0);
...
inline const_tree tree_check4(const_tree __t, const char *__f, int __l, const char *__g,
                              enum tree_code __c1, enum tree_code __c2, enum tree_code __c3,
                              enum tree_code __c4)
{
        if (TREE_CODE(__t) != __c1 && TREE_CODE(__t) != __c2 && TREE_CODE(__t) != __c3 &&
...
inline const_tree tree_not_check4(const_tree __t, const char *__f, int __l, const char *__g,
                                  enum tree_code __c1, enum tree_code __c2, enum tree_code __c3,
                                  enum tree_code __c4)
{
        if (TREE_CODE(__t) == __c1 || TREE_CODE(__t) == __c2 || TREE_CODE(__t) == __c3 ||
...
inline const_tree tree_check5(const_tree __t, const char *__f, int __l, const char *__g,
                              enum tree_code __c1, enum tree_code __c2, enum tree_code __c3,
                              enum tree_code __c4, enum tree_code __c5)
{
        if (TREE_CODE(__t) != __c1 && TREE_CODE(__t) != __c2 && TREE_CODE(__t) != __c3 &&
...
inline const_tree tree_not_check5(const_tree __t, const char *__f, int __l, const char *__g,
                                  enum tree_code __c1, enum tree_code __c2, enum tree_code __c3,
                                  enum tree_code __c4, enum tree_code __c5)
{
        if (TREE_CODE(__t) == __c1 || TREE_CODE(__t) == __c2 || TREE_CODE(__t) == __c3 ||
...
inline const_tree contains_struct_check(const_tree __t, const enum tree_node_structure_enum __s,
                                        const char *__f, int __l, const char *__g)
{
        if (tree_contains_struct[TREE_CODE(__t)][__s] != 1) {
                tree_contains_struct_check_failed(__t, __s, __f, __l, __g);
...
inline const_tree tree_class_check(const_tree __t, const enum tree_code_class __class,
                                   const char *__f, int __l, const char *__g)
{
        if (TREE_CODE_CLASS(TREE_CODE(__t)) != __class) {
                tree_class_check_failed(__t, __class, __f, __l, __g);
...
inline const_tree tree_range_check(const_tree __t, enum tree_code __code1, enum tree_code __code2,
                                   const char *__f, int __l, const char *__g)
{
        if (TREE_CODE(__t) < __code1 || TREE_CODE(__t) > __code2) {
                tree_range_check_failed(__t, __f, __l, __g, __code1, __code2);
...
inline const_tree omp_clause_subcode_check(const_tree __t, enum omp_clause_code __code,
                                           const char *__f, int __l, const char *__g)
{
        if (TREE_CODE(__t) != OMP_CLAUSE) {
                tree_check_failed(__t, __f, __l, __g, OMP_CLAUSE, 0);
...
inline const_tree omp_clause_range_check(const_tree __t, enum omp_clause_code __code1,
                                         enum omp_clause_code __code2, const char *__f, int __l,
                                         const char *__g)
{
        if (TREE_CODE(__t) != OMP_CLAUSE) {
...
inline const_tree expr_check(const_tree __t, const char *__f, int __l, const char *__g)
{
        char const __c = TREE_CODE_CLASS(TREE_CODE(__t));
        if (!IS_EXPR_CODE_CLASS(__c)) {
                tree_class_check_failed(__t, tcc_expression, __f, __l, __g);
...
inline const_tree non_type_check(const_tree __t, const char *__f, int __l, const char *__g)
{
        if (TYPE_P(__t)) {
                tree_not_class_check_failed(__t, tcc_type, __f, __l, __g);
        }
...
inline const_tree *tree_vec_elt_check(const_tree __t, int __i, const char *__f, int __l,
                                      const char *__g)
{
        if (TREE_CODE(__t) != TREE_VEC) {
                tree_check_failed(__t, __f, __l, __g, TREE_VEC, 0);
...
inline const_tree *omp_clause_elt_check(const_tree __t, int __i, const char *__f, int __l,
                                        const char *__g)
{
        if (TREE_CODE(__t) != OMP_CLAUSE) {
                tree_check_failed(__t, __f, __l, __g, OMP_CLAUSE, 0);
...
inline const_tree any_integral_type_check(const_tree __t, const char *__f, int __l, const char *__g)
{
        if (!ANY_INTEGRAL_TYPE_P(__t)) {
                tree_check_failed(__t, __f, __l, __g, BOOLEAN_TYPE, ENUMERAL_TYPE, INTEGER_TYPE, 0);
        }
...
static inline int tree_operand_length(const_tree node)
{
...
/* Special checks for TREE_OPERANDs.  */
inline tree *tree_operand_check(tree __t, int __i, const char *__f, int __l, const char *__g)
{
...
inline tree *tree_operand_check_code(tree __t, enum tree_code __code, int __i, const char *__f,
                                     int __l, const char *__g)
{
...
inline const_tree *tree_operand_check(const_tree __t, int __i, const char *__f, int __l,
                                      const char *__g)
{
        const_tree __u = EXPR_CHECK(__t);
        if (__i < 0 || __i >= TREE_OPERAND_LENGTH(__u)) {
...
inline const_tree *tree_operand_check_code(const_tree __t, enum tree_code __code, int __i,
                                           const char *__f, int __l, const char *__g)
{
        if (TREE_CODE(__t) != __code) {
                tree_check_failed(__t, __f, __l, __g, __code, 0);
...
inline bool id_equal(const_tree id, const char *str)
{
        return !strcmp(IDENTIFIER_POINTER(id), str);
}

inline bool id_equal(const char *str, const_tree id)
{
...
inline poly_uint64 TYPE_VECTOR_SUBPARTS(const_tree node)
{
...
inline void SET_TYPE_VECTOR_SUBPARTS(tree node, poly_uint64 subparts)
{
        STATIC_ASSERT(NUM_POLY_INT_COEFFS <= 2);
        ...
        if (NUM_POLY_INT_COEFFS == 2) {
                ...
                VECTOR_TYPE_CHECK(node)->type_common.precision = index + (coeff1 != 0 ? 0x100 : 0);
        } else {
...
static inline bool valid_vector_subparts_p(poly_uint64 subparts)
{
        unsigned HOST_WIDE_INT coeff0 = subparts.coeffs[0];
        if (!pow2p_hwi(coeff0)) {
                return false;
...
inline bool location_wrapper_p(const_tree exp)
{
        ...
        if ((TREE_CODE(exp) == NON_LVALUE_EXPR || TREE_CODE(exp) == VIEW_CONVERT_EXPR) &&
...
inline tree tree_strip_any_location_wrapper(tree exp)
{
...
inline unsigned int vector_cst_encoded_nelts(const_tree t)
{
...
static inline tree build1_loc(location_t loc, enum tree_code code, tree type,
...
static inline tree build2_loc(location_t loc, enum tree_code code, tree type, tree arg0,
                              tree arg1 CXX_MEM_STAT_INFO)
{
...
static inline tree build3_loc(location_t loc, enum tree_code code, tree type, tree arg0, tree arg1,
...
static inline tree build4_loc(location_t loc, enum tree_code code, tree type, tree arg0, tree arg1,
                              tree arg2, tree arg3 CXX_MEM_STAT_INFO)
{
...
static inline tree build5_loc(location_t loc, enum tree_code code, tree type, tree arg0, tree arg1,
                              tree arg2, tree arg3, tree arg4 CXX_MEM_STAT_INFO)
{
        tree t = build5(code, type, arg0, arg1, arg2, arg3, arg4 PASS_MEM_STAT);
        if (CAN_HAVE_LOCATION_P(t)) {
                SET_EXPR_LOCATION(t, loc);
        }
        return t;
...
extern tree build_call_expr_internal_loc(location_t, enum internal_fn, tree, int, ...);
extern tree build_call_expr_internal_loc_array(location_t, enum internal_fn, tree, int,
                                               const tree *);
extern tree maybe_build_call_expr_loc(location_t, combined_fn, tree, int, ...);
...
#define build_varargs_function_type_vec(RET, V)                                                    \
        build_varargs_function_type_array(RET, vec_safe_length(V), vec_safe_address(V))
...
extern inline __attribute__((__gnu_inline__)) HOST_WIDE_INT tree_to_shwi(const_tree t)
{
        gcc_assert(tree_fits_shwi_p(t));
        return TREE_INT_CST_LOW(t);
}

extern inline __attribute__((__gnu_inline__)) unsigned HOST_WIDE_INT tree_to_uhwi(const_tree t)
{
        gcc_assert(tree_fits_uhwi_p(t));
        return TREE_INT_CST_LOW(t);
}
#if NUM_POLY_INT_COEFFS == 1
extern inline __attribute__((__gnu_inline__)) poly_int64 tree_to_poly_int64(const_tree t)
{
        gcc_assert(tree_fits_poly_int64_p(t));
        return TREE_INT_CST_LOW(t);
}

extern inline __attribute__((__gnu_inline__)) poly_uint64 tree_to_poly_uint64(const_tree t)
{
...
inline bool poly_int_tree_p(const_tree t, poly_int64_pod *value)
{
...
inline bool poly_int_tree_p(const_tree t, poly_uint64_pod *value)
{
...
#define build_type_variant(TYPE, CONST_P, VOLATILE_P)                                              \
        build_qualified_type((TYPE), ((CONST_P) ? TYPE_QUAL_CONST : 0) |                           \
...
inline tree size_in_bytes(const_tree t)
{
...
#define SUBSTITUTE_PLACEHOLDER_IN_EXPR(EXP, OBJ)                                                   \
        ((EXP) == 0 || TREE_CONSTANT(EXP) ? (EXP) : substitute_placeholder_in_expr(EXP, OBJ))
...
static inline bool handled_component_p(const_tree t)
{
        switch (TREE_CODE(t)) {
        case COMPONENT_REF:
        case BIT_FIELD_REF:
...
static inline bool reverse_storage_order_for_component_p(tree t)
{
...
static inline bool storage_order_barrier_p(const_tree t)
{
        if (TREE_CODE(t) != VIEW_CONVERT_EXPR) {
                return false;
        }

        if (AGGREGATE_TYPE_P(TREE_TYPE(t)) && TYPE_REVERSE_STORAGE_ORDER(TREE_TYPE(t))) {
                return true;
        }

        tree op = TREE_OPERAND(t, 0);

        if (AGGREGATE_TYPE_P(TREE_TYPE(op)) && TYPE_REVERSE_STORAGE_ORDER(TREE_TYPE(op))) {
                return true;
        }
...
static inline void function_args_iter_init(function_args_iterator *i, const_tree fntype)
{
...
static inline tree *function_args_iter_cond_ptr(function_args_iterator *i)
{
...
static inline tree function_args_iter_cond(function_args_iterator *i)
{
        return (i->next) ? TREE_VALUE(i->next) : NULL_TREE;
}

/* Advance to the next argument.  */
static inline void function_args_iter_next(function_args_iterator *i)
{
...
static inline bool inlined_function_outer_scope_p(const_tree block)
{
...
inline unsigned crc32_unsigned(unsigned chksum, unsigned value)
{
        return crc32_unsigned_n(chksum, value, 4);
}
inline unsigned crc32_byte(unsigned chksum, char byte)
{
...
static inline int struct_ptr_eq(const void *a, const void *b)
{
...
static inline hashval_t struct_ptr_hash(const void *a)
{
        const void *const *x = (const void *const *)a;
        return (intptr_t)*x >> 4;
}
...
static inline bool truth_value_p(enum tree_code code)
{
        return (TREE_CODE_CLASS(code) == tcc_comparison || code == TRUTH_AND_EXPR ||
                code == TRUTH_ANDIF_EXPR || code == TRUTH_OR_EXPR || code == TRUTH_ORIF_EXPR ||
                code == TRUTH_XOR_EXPR || code == TRUTH_NOT_EXPR);
}

/* Return whether TYPE is a type suitable for an offset for
   a POINTER_PLUS_EXPR.  */
static inline bool ptrofftype_p(tree type)
{
        return (INTEGRAL_TYPE_P(type) && TYPE_PRECISION(type) == TYPE_PRECISION(sizetype) &&
...
/* Return true if the argument is a complete type or an array
   ...
   have complete type.  */
static inline bool complete_or_array_type_p(const_tree type)
{
        return COMPLETE_TYPE_P(type) ||
               (TREE_CODE(type) == ARRAY_TYPE && COMPLETE_TYPE_P(TREE_TYPE(type)));
}

/* Return true if the value of T could be represented as a poly_widest_int.  */

inline bool poly_int_tree_p(const_tree t)
{
...
inline poly_uint64 bit_field_size(const_tree t)
{
...
inline poly_uint64 bit_field_offset(const_tree t)
{
...
extern bool int_fits_type_p(const_tree, const_tree) ATTRIBUTE_NONNULL(1)
        ATTRIBUTE_NONNULL(2) ATTRIBUTE_PURE;
...
/* Return simplified tree code of type that is used for canonical type
   merging.  */
inline enum tree_code tree_code_for_canonical_type_merging(enum tree_code code)
{
...
inline bool canonical_type_used_p(const_tree t)
{
        return !(POINTER_TYPE_P(t) || TREE_CODE(t) == ARRAY_TYPE || TREE_CODE(t) == VECTOR_TYPE);
}
...
/* A hash_map of two trees for use with GTY((cache)).  Garbage collection for
   ...
   marked.  */
struct tree_cache_traits : simple_cache_map_traits<default_hash_traits<tree>, tree> {
};
typedef hash_map<tree, tree, tree_cache_traits> tree_cache_map;

/* Initialize the abstract argument list iterator object ITER with the
   arguments from CALL_EXPR node EXP.  */
static inline void init_call_expr_arg_iterator(tree exp, call_expr_arg_iterator *iter)
{
        iter->t = exp;
...
static inline void init_const_call_expr_arg_iterator(const_tree exp,
...
static inline tree next_call_expr_arg(call_expr_arg_iterator *iter)
{
        tree result;
        if (iter->i >= iter->n) {
                return NULL_TREE;
...
static inline const_tree next_const_call_expr_arg(const_call_expr_arg_iterator *iter)
{
        const_tree result;
        if (iter->i >= iter->n) {
                return NULL_TREE;
...
static inline tree first_call_expr_arg(tree exp, call_expr_arg_iterator *iter)
{
        init_call_expr_arg_iterator(exp, iter);
        return next_call_expr_arg(iter);
}

static inline const_tree first_const_call_expr_arg(const_tree exp,
                                                   const_call_expr_arg_iterator *iter)
{
...
static inline bool more_call_expr_args_p(const call_expr_arg_iterator *iter)
{
...
static inline bool is_lang_specific(const_tree t)
{
...
static inline tree builtin_decl_explicit(enum built_in_function fncode)
{
...
static inline void set_builtin_decl(enum built_in_function fncode, tree decl, bool implicit_p)
{
...
static inline void set_builtin_decl_implicit_p(enum built_in_function fncode, bool implicit_p)
{
        size_t uns_fncode = (size_t)fncode;

        gcc_checking_assert(BUILTIN_VALID_P(fncode) && builtin_info[uns_fncode].decl != NULL_TREE);
...
static inline void set_builtin_decl_declared_p(enum built_in_function fncode, bool declared_p)
{
        size_t uns_fncode = (size_t)fncode;
...
static inline bool builtin_decl_implicit_p(enum built_in_function fncode)
{
        size_t uns_fncode = (size_t)fncode;

        gcc_checking_assert(BUILTIN_VALID_P(fncode));
        return (builtin_info[uns_fncode].decl != NULL_TREE && builtin_info[uns_fncode].implicit_p);
}

/* Return whether the standard builtin function was declared.  */

static inline bool builtin_decl_declared_p(enum built_in_function fncode)
{
        size_t uns_fncode = (size_t)fncode;

        gcc_checking_assert(BUILTIN_VALID_P(fncode));
        return (builtin_info[uns_fncode].decl != NULL_TREE && builtin_info[uns_fncode].declared_p);
}
...
static inline bool may_be_aliased(const_tree var)
{
        return (TREE_CODE(var) != CONST_DECL &&
                (TREE_PUBLIC(var) || DECL_EXTERNAL(var) || TREE_ADDRESSABLE(var)) &&
                !((TREE_STATIC(var) || TREE_PUBLIC(var) || DECL_EXTERNAL(var)) &&
                  (TREE_READONLY(var) || (TREE_CODE(var) == VAR_DECL && DECL_NONALIASED(var)))));
}

/* Return pointer to optimization flags of FNDECL.  */
static inline struct cl_optimization *opts_for_fn(const_tree fndecl)
{
...
static inline cl_target_option *target_opts_for_fn(const_tree fndecl)
{
...
template <> struct int_traits<unextended_tree> {
        static const enum precision_type precision_type = VAR_PRECISION;
        static const bool host_dependent_precision = false;
        static const bool is_sign_extended = false;
};

template <int N> class extended_tree
{
      private:
        const_tree m_t;
...
template <int N> struct int_traits<extended_tree<N>> {
...
typedef const poly_int<NUM_POLY_INT_COEFFS, generic_wide_int<widest_extended_tree>>
        tree_to_poly_widest_ref;
typedef const poly_int<NUM_POLY_INT_COEFFS, generic_wide_int<offset_extended_tree>>
        tree_to_poly_offset_ref;
typedef const poly_int<NUM_POLY_INT_COEFFS, generic_wide_int<unextended_tree>>
...
template <int N> struct ints_for<generic_wide_int<extended_tree<N>>, CONST_PRECISION> {
        typedef generic_wide_int<extended_tree<N>> extended;
        static extended zero(const extended &);
};

template <> struct ints_for<generic_wide_int<unextended_tree>, VAR_PRECISION> {
...
typedef generic_wide_int<wi::extended_tree<WIDE_INT_MAX_PRECISION * 2>> widest2_int_cst;
...
inline wi::tree_to_widest_ref wi::to_widest(const_tree t)
{
        return t;
}
...
inline wi::tree_to_offset_ref wi::to_offset(const_tree t)
{
        return t;
}
...
inline wi::tree_to_wide_ref wi::to_wide(const_tree t)
{
...
inline wide_int wi::to_wide(const_tree t, unsigned int prec)
{
        return wide_int::from(wi::to_wide(t), prec, TYPE_SIGN(TREE_TYPE(t)));
}

template <int N> inline wi::extended_tree<N>::extended_tree(const_tree t) : m_t(t)
{
        gcc_checking_assert(TYPE_PRECISION(TREE_TYPE(t)) <= N);
}

template <int N> inline unsigned int wi::extended_tree<N>::get_precision() const
{
        return N;
}

template <int N> inline const HOST_WIDE_INT *wi::extended_tree<N>::get_val() const
{
        return &TREE_INT_CST_ELT(m_t, 0);
}

template <int N> inline unsigned int wi::extended_tree<N>::get_len() const
{
...
inline unsigned int wi::unextended_tree::get_precision() const
{
        return TYPE_PRECISION(TREE_TYPE(m_t));
}

inline const HOST_WIDE_INT *wi::unextended_tree::get_val() const
{
        return &TREE_INT_CST_ELT(m_t, 0);
}

inline unsigned int wi::unextended_tree::get_len() const
{
...
inline wi::tree_to_poly_wide_ref poly_int_cst_value(const_tree x)
{
...
inline wi::tree_to_poly_widest_ref wi::to_poly_widest(const_tree t)
{
        if (POLY_INT_CST_P(t)) {
                poly_int<NUM_POLY_INT_COEFFS, generic_wide_int<widest_extended_tree>> res;
                for (unsigned int i = 0; i < NUM_POLY_INT_COEFFS; ++i) {
...
inline wi::tree_to_poly_offset_ref wi::to_poly_offset(const_tree t)
{
        if (POLY_INT_CST_P(t)) {
                poly_int<NUM_POLY_INT_COEFFS, generic_wide_int<offset_extended_tree>> res;
                for (unsigned int i = 0; i < NUM_POLY_INT_COEFFS; ++i) {
                        res.coeffs[i] = POLY_INT_CST_COEFF(t, i);
                }
                return res;
...
inline wi::tree_to_poly_wide_ref wi::to_poly_wide(const_tree t)
{
        if (POLY_INT_CST_P(t)) {
...
wi::ints_for<generic_wide_int<wi::extended_tree<N>>, wi::CONST_PRECISION>::zero(const extended &x)
{
        return build_zero_cst(TREE_TYPE(x.get_tree()));
}

inline generic_wide_int<wi::unextended_tree>
wi::ints_for<generic_wide_int<wi::unextended_tree>, wi::VAR_PRECISION>::zero(const unextended &x)
{
        return build_zero_cst(TREE_TYPE(x.get_tree()));
}
...
namespace wi
{
template <typename T> bool fits_to_boolean_p(const T &x, const_tree);

template <typename T> bool fits_to_tree_p(const T &x, const_tree);
...
template <typename T> bool wi::fits_to_boolean_p(const T &x, const_tree type)
{
        typedef typename poly_int_traits<T>::int_type int_type;
        return (known_eq(x, int_type(0)) || known_eq(x, int_type(TYPE_UNSIGNED(type) ? 1 : -1)));
}

template <typename T> bool wi::fits_to_tree_p(const T &x, const_tree type)
{
...
inline wide_int wi::min_value(const_tree type)
{
...
/* Produce the largest number that is represented in TYPE.  The precision
   and sign are taken from TYPE.  */
inline wide_int wi::max_value(const_tree type)
{
...
inline bool tree_int_cst_lt(const_tree t1, const_tree t2)
{
...
inline bool tree_int_cst_le(const_tree t1, const_tree t2)
{
        return wi::to_widest(t1) <= wi::to_widest(t2);
}
...
inline int tree_int_cst_compare(const_tree t1, const_tree t2)
{
...
extern tree get_inner_reference(tree, poly_int64_pod *, poly_int64_pod *, tree *, machine_mode *,
                                int *, int *, int *);
...
inline HOST_WIDE_INT int_bit_position(const_tree field)
{
...
inline bool type_with_alias_set_p(const_tree t)
{
...
extern location_t set_source_range(tree expr, source_range src_range);

/* Return true if it makes sense to promote/demote from_type to to_type. */
inline bool desired_pro_or_demotion_p(const_tree to_type, const_tree from_type)
{
...
inline bool type_has_mode_precision_p(const_tree t)
{
...
inline bool fndecl_built_in_p(const_tree node, built_in_class klass)
{
...
inline bool fndecl_built_in_p(const_tree node, int name, built_in_class klass)
{
...
inline bool fndecl_built_in_p(const_tree node, built_in_function name)
{
