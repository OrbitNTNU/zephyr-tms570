...
inline void sreal::normalize_up(int64_t new_sig, signed int new_exp)
{
...
inline void sreal::normalize_down(int64_t new_sig, signed int new_exp)
{
        int last_bit;
        unsigned HOST_WIDE_INT sig = absu_hwi(new_sig);
...
inline void sreal::normalize(int64_t new_sig, signed int new_exp)
{
        unsigned HOST_WIDE_INT sig = absu_hwi(new_sig);
