...
inline tree_vector_builder::tree_vector_builder(tree type, unsigned int npatterns,
...
inline void tree_vector_builder::new_vector(tree type, unsigned int npatterns,
                                            unsigned int nelts_per_pattern)
{
        m_type = type;
        parent::new_vector(TYPE_VECTOR_SUBPARTS(type), npatterns, nelts_per_pattern);
}

/* Return true if elements I1 and I2 are equal.  */

inline bool tree_vector_builder::equal_p(const_tree elt1, const_tree elt2) const
{
...
inline bool tree_vector_builder::allow_steps_p() const
{
...
inline bool tree_vector_builder::integral_p(const_tree elt) const
{
...
inline wide_int tree_vector_builder::step(const_tree elt1, const_tree elt2) const
{
...
inline bool tree_vector_builder::can_elide_p(const_tree elt) const
{
...
inline void tree_vector_builder::note_representative(tree *elt1_ptr, tree elt2)
{
