...
struct double_int {
        ...
        double_int wide_mul_with_sign(double_int, bool unsigned_p, double_int *higher,
                                      bool *overflow) const;
...
inline double_int double_int::from_shwi(HOST_WIDE_INT cst)
{
        double_int r;
...
inline double_int double_int::from_uhwi(unsigned HOST_WIDE_INT cst)
{
        double_int r;
        r.low = cst;
        r.high = 0;
...
inline double_int double_int::from_pair(HOST_WIDE_INT high, unsigned HOST_WIDE_INT low)
{
        double_int r;
        r.low = low;
        r.high = high;
...
inline double_int &double_int::operator++()
{
        *this += double_int_one;
        return *this;
}
...
inline double_int &double_int::operator&=(double_int b)
{
        *this = *this & b;
        return *this;
}
...
inline HOST_WIDE_INT double_int::to_shwi() const
{
...
inline unsigned HOST_WIDE_INT double_int::to_uhwi() const
{
        return low;
}
...
inline bool double_int::fits_uhwi() const
{
        return high == 0;
}
...
inline double_int double_int::operator~() const
{
        double_int result;
        result.low = ~low;
        result.high = ~high;
...
inline double_int double_int::operator|(double_int b) const
{
        double_int result;
...
inline double_int double_int::and_not(double_int b) const
{
        double_int result;
        result.low = low & ~b.low;
        result.high = high & ~b.high;
...
inline bool double_int::is_zero() const
{
        return low == 0 && high == 0;
}
...
inline bool double_int::is_one() const
{
        return low == 1 && high == 0;
}
...
inline bool double_int::is_minus_one() const
{
...
inline bool double_int::is_negative() const
{
        return high < 0;
}
...
inline bool double_int::operator==(double_int cst2) const
{
...
inline int double_int::popcount() const
{
...
namespace wi
{
template <> struct int_traits<double_int> {
...
inline unsigned int wi::int_traits<double_int>::get_precision(const double_int &)
{
        return precision;
}

inline wi::storage_ref wi::int_traits<double_int>::decompose(HOST_WIDE_INT *scratch, unsigned int p,
                                                             const double_int &x)
{
