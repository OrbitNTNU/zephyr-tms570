...
extern hash_map<void *, void *> *duplicate_eh_regions(struct function *, eh_region, int,
                                                      duplicate_eh_regions_map, void *);
...
extern enum eh_personality_kind function_needs_eh_personality(struct function *);

/* Pre-order iteration within the eh_region tree.  */

static inline eh_region ehr_next(eh_region r, eh_region start)
{
        if (r->inner) {
                r = r->inner;
