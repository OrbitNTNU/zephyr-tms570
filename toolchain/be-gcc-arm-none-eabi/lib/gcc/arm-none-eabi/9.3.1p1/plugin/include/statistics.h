...
#define GCC_MEM_STAT_ARGUMENTS                                                                     \
        const char *ARG_UNUSED(_loc_name), int ARG_UNUSED(_loc_line),                              \
                const char *ARG_UNUSED(_loc_function)
...
#define ALONE_CXX_MEM_STAT_INFO                                                                    \
        const char *_loc_name = __builtin_FILE(), int _loc_line = __builtin_LINE(),                \
                   const char *_loc_function = __builtin_FUNCTION()
#else
#define ALONE_CXX_MEM_STAT_INFO                                                                    \
        const char *_loc_name = __FILE__, int _loc_line = __LINE__, const char *_loc_function = NULL
#endif
