...
inline gimple_match_cond::gimple_match_cond(tree cond_in, tree else_value_in)
...
inline gimple_match_cond gimple_match_cond::any_else() const
{
...
inline gimple_match_op::gimple_match_op()
        : cond(gimple_match_cond::UNCOND), type(NULL_TREE), reverse(false), num_ops(0)
{
}
...
inline gimple_match_op::gimple_match_op(const gimple_match_cond &cond_in, code_helper code_in,
                                        tree type_in, unsigned int num_ops_in)
        : cond(cond_in), code(code_in), type(type_in), reverse(false), num_ops(num_ops_in)
{
}
...
inline gimple_match_op::gimple_match_op(const gimple_match_cond &cond_in, code_helper code_in,
                                        tree type_in, tree op0)
        : cond(cond_in), code(code_in), type(type_in), reverse(false), num_ops(1)
{
        ops[0] = op0;
}

inline gimple_match_op::gimple_match_op(const gimple_match_cond &cond_in, code_helper code_in,
                                        tree type_in, tree op0, tree op1)
        : cond(cond_in), code(code_in), type(type_in), reverse(false), num_ops(2)
{
        ops[0] = op0;
        ops[1] = op1;
}
...
inline gimple_match_op::gimple_match_op(const gimple_match_cond &cond_in, code_helper code_in,
                                        tree type_in, tree op0, tree op1, tree op2)
        : cond(cond_in), code(code_in), type(type_in), reverse(false), num_ops(3)
{
        ops[0] = op0;
        ops[1] = op1;
        ops[2] = op2;
...
inline gimple_match_op::gimple_match_op(const gimple_match_cond &cond_in, code_helper code_in,
                                        tree type_in, tree op0, tree op1, tree op2, tree op3)
        : cond(cond_in), code(code_in), type(type_in), reverse(false), num_ops(4)
{
        ops[0] = op0;
        ops[1] = op1;
        ops[2] = op2;
...
inline gimple_match_op::gimple_match_op(const gimple_match_cond &cond_in, code_helper code_in,
                                        tree type_in, tree op0, tree op1, tree op2, tree op3,
                                        tree op4)
        : cond(cond_in), code(code_in), type(type_in), reverse(false), num_ops(5)
{
        ops[0] = op0;
        ops[1] = op1;
        ops[2] = op2;
...
inline void gimple_match_op::set_op(code_helper code_in, tree type_in, unsigned int num_ops_in)
{
        code = code_in;
        type = type_in;
        num_ops = num_ops_in;
...
inline void gimple_match_op::set_op(code_helper code_in, tree type_in, tree op0)
{
        code = code_in;
        type = type_in;
        num_ops = 1;
...
inline void gimple_match_op::set_op(code_helper code_in, tree type_in, tree op0, tree op1)
{
        code = code_in;
        type = type_in;
        num_ops = 2;
...
inline void gimple_match_op::set_op(code_helper code_in, tree type_in, tree op0, tree op1, tree op2)
{
        code = code_in;
        type = type_in;
        num_ops = 3;
...
inline void gimple_match_op::set_value(tree value)
{
...
inline tree gimple_match_op::op_or_null(unsigned int i) const
{
...
inline bool gimple_simplified_result_is_gimple_val(const gimple_match_op *op)
{
