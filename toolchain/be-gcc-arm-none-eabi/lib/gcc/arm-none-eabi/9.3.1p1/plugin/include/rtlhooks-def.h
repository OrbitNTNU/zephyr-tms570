...
#define RTL_HOOKS_INITIALIZER                                                                      \
        {                                                                                          \
                RTL_HOOKS_GEN_LOWPART, RTL_HOOKS_GEN_LOWPART_NO_EMIT,                              \
                        RTL_HOOKS_REG_NONZERO_REG_BITS, RTL_HOOKS_REG_NUM_SIGN_BIT_COPIES,         \
                        RTL_HOOKS_REG_TRUNCATED_TO_MODE                                            \
        }

extern rtx gen_lowpart_general(machine_mode, rtx);
extern rtx reg_nonzero_bits_general(const_rtx, scalar_int_mode, scalar_int_mode,
                                    unsigned HOST_WIDE_INT *);
extern rtx reg_num_sign_bit_copies_general(const_rtx, scalar_int_mode, scalar_int_mode,
                                           unsigned int *);
