...
#define INTTYPE_MINIMUM(t) ((t)(INTTYPE_SIGNED(t) ? (t)1 << (sizeof(t) * CHAR_BIT - 1) : (t)0))
...
#if !defined(HAVE_STRSIGNAL) || (defined(HAVE_DECL_STRSIGNAL) && !HAVE_DECL_STRSIGNAL)
#ifndef strsignal
...
extern void fancy_abort(const char *, int, const char *) ATTRIBUTE_NORETURN ATTRIBUTE_COLD;
#define abort() fancy_abort(__FILE__, __LINE__, __FUNCTION__)

/* Use gcc_assert(EXPR) to test invariants.  */
#if ENABLE_ASSERT_CHECKING
#define gcc_assert(EXPR) ((void)(!(EXPR) ? fancy_abort(__FILE__, __LINE__, __FUNCTION__), 0 : 0))
#elif (GCC_VERSION >= 4005)
#define gcc_assert(EXPR) ((void)(__builtin_expect(!(EXPR), 0) ? __builtin_unreachable(), 0 : 0))
#else
...
#pragma GCC poison ASM_OPEN_PAREN ASM_CLOSE_PAREN FUNCTION_PROLOGUE FUNCTION_EPILOGUE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
        FUNCTION_END_PROLOGUE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   \
                FUNCTION_BEGIN_EPILOGUE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \
                        DECL_MACHINE_ATTRIBUTES COMP_TYPE_ATTRIBUTES INSERT_ATTRIBUTES VALID_MACHINE_DECL_ATTRIBUTE VALID_MACHINE_TYPE_ATTRIBUTE SET_DEFAULT_TYPE_ATTRIBUTES SET_DEFAULT_DECL_ATTRIBUTES MERGE_MACHINE_TYPE_ATTRIBUTES MERGE_MACHINE_DECL_ATTRIBUTES MD_INIT_BUILTINS MD_EXPAND_BUILTIN ASM_OUTPUT_CONSTRUCTOR ASM_OUTPUT_DESTRUCTOR SIGNED_CHAR_SPEC MAX_CHAR_TYPE_SIZE WCHAR_UNSIGNED UNIQUE_SECTION SELECT_SECTION SELECT_RTX_SECTION ENCODE_SECTION_INFO STRIP_NAME_ENCODING ASM_GLOBALIZE_LABEL ASM_OUTPUT_MI_THUNK CONST_COSTS RTX_COSTS DEFAULT_RTX_COSTS ADDRESS_COST MACHINE_DEPENDENT_REORG ASM_FILE_START ASM_FILE_END ASM_SIMPLIFY_DWARF_ADDR INIT_TARGET_OPTABS INIT_SUBTARGET_OPTABS INIT_GOFAST_OPTABS MULSI3_LIBCALL MULDI3_LIBCALL DIVSI3_LIBCALL DIVDI3_LIBCALL UDIVSI3_LIBCALL UDIVDI3_LIBCALL MODSI3_LIBCALL MODDI3_LIBCALL UMODSI3_LIBCALL UMODDI3_LIBCALL BUILD_VA_LIST_TYPE PRETEND_OUTGOING_VARARGS_NAMED STRUCT_VALUE_INCOMING_REGNUM ASM_OUTPUT_SECTION_NAME PROMOTE_FUNCTION_ARGS PROMOTE_FUNCTION_MODE STRUCT_VALUE_INCOMING STRICT_ARGUMENT_NAMING PROMOTE_FUNCTION_RETURN PROMOTE_PROTOTYPES STRUCT_VALUE_REGNUM SETUP_INCOMING_VARARGS EXPAND_BUILTIN_SAVEREGS DEFAULT_SHORT_ENUMS SPLIT_COMPLEX_ARGS MD_ASM_CLOBBERS HANDLE_PRAGMA_REDEFINE_EXTNAME HANDLE_PRAGMA_EXTERN_PREFIX \
                                MUST_PASS_IN_STACK FUNCTION_ARG_PASS_BY_REFERENCE VECTOR_MODE_SUPPORTED_P TARGET_SUPPORTS_HIDDEN FUNCTION_ARG_PARTIAL_NREGS ASM_OUTPUT_DWARF_DTPREL ALLOCATE_INITIAL_VALUE LEGITIMIZE_ADDRESS FRAME_POINTER_REQUIRED CAN_ELIMINATE TRAMPOLINE_TEMPLATE INITIALIZE_TRAMPOLINE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
                                        TRAMPOLINE_ADJUST_ADDRESS STATIC_CHAIN STATIC_CHAIN_INCOMING RETURN_POPS_ARGS UNITS_PER_SIMD_WORD OVERRIDE_OPTIONS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
                                                OPTIMIZATION_OPTIONS CLASS_LIKELY_SPILLED_P USING_SJLJ_EXCEPTIONS TARGET_UNWIND_INFO CAN_DEBUG_WITHOUT_FP UNLIKELY_EXECUTED_TEXT_SECTION_NAME HOT_TEXT_SECTION_NAME                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             \
                                                        LEGITIMATE_CONSTANT_P ALWAYS_STRIP_DOTDOT OUTPUT_ADDR_CONST_EXTRA SMALL_REGISTER_CLASSES ASM_OUTPUT_IDENT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
                                                                ASM_BYTE_OP MEMBER_TYPE_FORCES_BLK LIBGCC2_HAS_SF_MODE LIBGCC2_HAS_DF_MODE LIBGCC2_HAS_XF_MODE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
                                                                        LIBGCC2_HAS_TF_MODE CLEAR_BY_PIECES_P MOVE_BY_PIECES_P SET_BY_PIECES_P                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
                                                                                STORE_BY_PIECES_P TARGET_FLT_EVAL_METHOD HARD_REGNO_CALL_PART_CLOBBERED                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \
                                                                                        HARD_REGNO_MODE_OK MODES_TIEABLE_P FUNCTION_ARG_PADDING                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
                                                                                                SLOW_UNALIGNED_ACCESS HARD_REGNO_NREGS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \
                                                                                                        SECONDARY_MEMORY_NEEDED_MODE SECONDARY_MEMORY_NEEDED                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
                                                                                                                CANNOT_CHANGE_MODE_CLASS TRULY_NOOP_TRUNCATION                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
                                                                                                                        FUNCTION_ARG_OFFSET                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
                                                                                                                                CONSTANT_ALIGNMENT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
...
#pragma GCC poison DECLARE_LIBRARY_RENAMES LIBGCC2_GNU_PREFIX MD_UNWIND_SUPPORT                    \
        MD_FROB_UPDATE_CONTEXT ENABLE_EXECUTE_STACK REG_VALUE_IN_UNWIND_CONTEXT                    \
                ASSUME_EXTENDED_UNWIND_CONTEXT

/* Other obsolete target macros, or macros that used to be in target
   headers and were not used, and may be obsolete or may never have
   been used.  */
#pragma GCC poison INT_ASM_OP ASM_OUTPUT_EH_REGION_BEG CPP_PREDEFINES ASM_OUTPUT_EH_REGION_END ASM_OUTPUT_LABELREF_AS_INT SMALL_STACK DOESNT_NEED_UNWINDER                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
        EH_TABLE_LOOKUP OBJC_SELECTORS_WITHOUT_LABELS OMIT_EH_TABLE EASY_DIV_EXPR IMPLICIT_FIX_EXPR LONGJMP_RESTORE_FROM_STACK MAX_INT_TYPE_SIZE ASM_IDENTIFY_GCC                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
                STDC_VALUE TRAMPOLINE_ALIGN ASM_IDENTIFY_GCC_AFTER_SOURCE SLOW_ZERO_EXTEND SUBREG_REGNO_OFFSET DWARF_LINE_MIN_INSTR_LENGTH TRADITIONAL_RETURN_FLOAT NO_BUILTIN_SIZE_TYPE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
                        NO_BUILTIN_PTRDIFF_TYPE NO_BUILTIN_WCHAR_TYPE NO_BUILTIN_WINT_TYPE BLOCK_PROFILER BLOCK_PROFILER_CODE FUNCTION_BLOCK_PROFILER FUNCTION_BLOCK_PROFILER_EXIT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \
                                MACHINE_STATE_SAVE MACHINE_STATE_RESTORE SCCS_DIRECTIVE SECTION_ASM_OP BYTEORDER ASM_OUTPUT_DEFINE_LABEL_DIFFERENCE_SYMBOL                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
                                        HOST_WORDS_BIG_ENDIAN OBJC_PROLOGUE ALLOCATE_TRAMPOLINE HANDLE_PRAGMA ROUND_TYPE_SIZE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
                                                ROUND_TYPE_SIZE_UNIT CONST_SECTION_ASM_OP CRT_GET_RFIB_TEXT DBX_LBRAC_FIRST DBX_OUTPUT_ENUM DBX_OUTPUT_SOURCE_FILENAME DBX_WORKING_DIRECTORY INSN_CACHE_DEPTH INSN_CACHE_SIZE INSN_CACHE_LINE_WIDTH INIT_SECTION_PREAMBLE NEED_ATEXIT ON_EXIT EXIT_BODY OBJECT_FORMAT_ROSE MULTIBYTE_CHARS MAP_CHARACTER LIBGCC_NEEDS_DOUBLE FINAL_PRESCAN_LABEL DEFAULT_CALLER_SAVES LOAD_ARGS_REVERSED MAX_INTEGER_COMPUTATION_MODE CONVERT_HARD_REGISTER_TO_SSA_P ASM_OUTPUT_MAIN_SOURCE_FILENAME FIRST_INSN_ADDRESS TEXT_SECTION SHARED_BSS_SECTION_ASM_OP PROMOTED_MODE EXPAND_BUILTIN_VA_END LINKER_DOES_NOT_WORK_WITH_DWARF2 FUNCTION_ARG_KEEP_AS_REFERENCE GIV_SORT_CRITERION MAX_LONG_TYPE_SIZE MAX_LONG_DOUBLE_TYPE_SIZE MAX_WCHAR_TYPE_SIZE SHARED_SECTION_ASM_OP INTEGRATE_THRESHOLD FINAL_REG_PARM_STACK_SPACE MAYBE_REG_PARM_STACK_SPACE TRADITIONAL_PIPELINE_INTERFACE DFA_PIPELINE_INTERFACE DBX_OUTPUT_STANDARD_TYPES BUILTIN_SETJMP_FRAME_VALUE SUNOS4_SHARED_LIBRARIES PROMOTE_FOR_CALL_ONLY SPACE_AFTER_L_OPTION NO_RECURSIVE_FUNCTION_CSE DEFAULT_MAIN_RETURN TARGET_MEM_FUNCTIONS EXPAND_BUILTIN_VA_ARG COLLECT_PARSE_FLAG DWARF2_GENERATE_TEXT_SECTION_LABEL WINNING_GDB ASM_OUTPUT_FILENAME ASM_OUTPUT_SOURCE_LINE FILE_NAME_JOINER \
                                                        GDB_INV_REF_REGPARM_STABS_LETTER DBX_MEMPARM_STABS_LETTER PUT_SDB_SRC_FILE STABS_GCC_MARKER DBX_OUTPUT_FUNCTION_END DBX_OUTPUT_GCC_MARKER DBX_FINISH_SYMBOL                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         \
                                                                SDB_GENERATE_FAKE NON_SAVING_SETJMP TARGET_LATE_RTL_PROLOGUE_EPILOGUE CASE_DROPS_THROUGH TARGET_BELL TARGET_BS TARGET_CR                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
                                                                        TARGET_DIGIT0 TARGET_ESC TARGET_FF TARGET_NEWLINE TARGET_TAB TARGET_VT LINK_LIBGCC_SPECIAL DONT_ACCESS_GBLS_AFTER_EPILOGUE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \
                                                                                TARGET_OPTIONS TARGET_SWITCHES EXTRA_CC_MODES FINALIZE_PIC PREDICATE_CODES SPECIAL_MODE_PREDICATES UNALIGNED_WORD_ASM_OP                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
                                                                                        EXTRA_SECTIONS EXTRA_SECTION_FUNCTIONS READONLY_DATA_SECTION TARGET_ASM_EXCEPTION_SECTION TARGET_ASM_EH_FRAME_SECTION SMALL_ARG_MAX ASM_OUTPUT_SHARED_BSS ASM_OUTPUT_SHARED_COMMON ASM_OUTPUT_SHARED_LOCAL ASM_MAKE_LABEL_LINKONCE STACK_CHECK_PROBE_INTERVAL STACK_CHECK_PROBE_LOAD ORDER_REGS_FOR_LOCAL_ALLOC FUNCTION_OUTGOING_VALUE ASM_DECLARE_CONSTANT_NAME MODIFY_TARGET_NAME SWITCHES_NEED_SPACES SWITCH_CURTAILS_COMPILATION                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
                                                                                                SWITCH_TAKES_ARG WORD_SWITCH_TAKES_ARG TARGET_OPTION_TRANSLATE_TABLE HANDLE_PRAGMA_PACK_PUSH_POP                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
                                                                                                        HANDLE_SYSV_PRAGMA HANDLE_PRAGMA_WEAK CONDITIONAL_REGISTER_USAGE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
                                                                                                                FUNCTION_ARG_BOUNDARY MUST_USE_SJLJ_EXCEPTIONS US_SOFTWARE_GOFAST                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
                                                                                                                        USING_SVR4_H SVR4_ASM_SPEC FUNCTION_ARG                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             \
                                                                                                                                FUNCTION_ARG_ADVANCE FUNCTION_INCOMING_ARG IRA_COVER_CLASSES TARGET_VERSION MACHINE_TYPE TARGET_HAS_TARGETCM ASM_OUTPUT_BSS SETJMP_VIA_SAVE_AREA FORBIDDEN_INC_DEC_CLASSES PREFERRED_OUTPUT_RELOAD_CLASS SYSTEM_INCLUDE_DIR STANDARD_INCLUDE_DIR STANDARD_INCLUDE_COMPONENT LINK_ELIMINATE_DUPLICATE_LDIRECTORIES MIPS_DEBUGGING_INFO IDENT_ASM_OP ALL_COP_ADDITIONAL_REGISTER_NAMES DBX_OUTPUT_LBRAC DBX_OUTPUT_NFUN DBX_OUTPUT_RBRAC RANGE_TEST_NON_SHORT_CIRCUIT REAL_VALUE_TRUNCATE REVERSE_CONDEXEC_PREDICATES_P TARGET_ALIGN_ANON_BITFIELDS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           \
                                                                                                                                        TARGET_NARROW_VOLATILE_BITFIELDS IDENT_ASM_OP UNALIGNED_SHORT_ASM_OP UNALIGNED_INT_ASM_OP UNALIGNED_LONG_ASM_OP UNALIGNED_DOUBLE_INT_ASM_OP USE_COMMON_FOR_ONE_ONLY                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
                                                                                                                                                IFCVT_EXTRA_FIELDS IFCVT_INIT_EXTRA_FIELDS CASE_USE_BIT_TESTS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
                                                                                                                                                        FIXUNS_TRUNC_LIKE_FIX_TRUNC GO_IF_MODE_DEPENDENT_ADDRESS DELAY_SLOTS_FOR_EPILOGUE ELIGIBLE_FOR_EPILOGUE_DELAY TARGET_C99_FUNCTIONS TARGET_HAS_SINCOS REG_CLASS_FROM_LETTER CONST_OK_FOR_LETTER_P CONST_DOUBLE_OK_FOR_LETTER_P EXTRA_CONSTRAINT REG_CLASS_FROM_CONSTRAINT REG_CLASS_FOR_CONSTRAINT EXTRA_CONSTRAINT_STR EXTRA_MEMORY_CONSTRAINT EXTRA_ADDRESS_CONSTRAINT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             \
                                                                                                                                                                CONST_DOUBLE_OK_FOR_CONSTRAINT_P CALLER_SAVE_PROFITABLE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
                                                                                                                                                                        LARGEST_EXPONENT_IS_NORMAL ROUND_TOWARDS_ZERO                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
                                                                                                                                                                                SF_SIZE DF_SIZE XF_SIZE TF_SIZE LIBGCC2_TF_CEXT LIBGCC2_LONG_DOUBLE_TYPE_SIZE                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
                                                                                                                                                                                        STRUCT_VALUE EH_FRAME_IN_DATA_SECTION TARGET_FLT_EVAL_METHOD_NON_DEFAULT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
...
#pragma GCC poison LANG_HOOKS_FUNCTION_MARK LANG_HOOKS_FUNCTION_FREE LANG_HOOKS_MARK_TREE LANG_HOOKS_INSERT_DEFAULT_ATTRIBUTES \
        LANG_HOOKS_TREE_INLINING_ESTIMATE_NUM_INSNS LANG_HOOKS_PUSHLEVEL LANG_HOOKS_SET_BLOCK                                  \
                LANG_HOOKS_MAYBE_BUILD_CLEANUP LANG_HOOKS_UPDATE_DECL_AFTER_SAVING LANG_HOOKS_POPLEVEL                         \
                        LANG_HOOKS_TRUTHVALUE_CONVERSION TARGET_PROMOTE_FUNCTION_ARGS TARGET_PROMOTE_FUNCTION_RETURN           \
                                LANG_HOOKS_MISSING_ARGUMENT LANG_HOOKS_HASH_TYPES TARGET_HANDLE_OFAST                          \
                                        TARGET_OPTION_OPTIMIZATION TARGET_IRA_COVER_CLASSES TARGET_HELP                        \
...
#undef VA_CLOSE
#undef VA_START
#pragma GCC poison ANSI_PROTOTYPES PTR_CONST LONG_DOUBLE VPARAMS VA_OPEN VA_FIXEDARG VA_CLOSE      \
        VA_START
#endif /* IN_GCC */
...
static inline char *helper_const_non_const_cast(const char *p)
{
        union {
                const char *const_c;
                char *c;
...
#define GCC_DIAGNOSTIC_PUSH_IGNORED(x)                                                             \
        _Pragma("GCC diagnostic push") _Pragma(GCC_DIAGNOSTIC_STRINGIFY(GCC diagnostic ignored #x))
 ...
 */
#define SIZE_SCALE(x) (((x) < 10 * ONE_K ? (x) : ((x) < 10 * ONE_M ? (x) / ONE_K : (x) / ONE_M)))
