...
class md_reader
{
      public:
        ...
        void record_potential_iterator_use(struct iterator_group *group, rtx x, unsigned int index,
                                           const char *name);
...
extern void fatal_with_file_and_line(const char *, ...) ATTRIBUTE_PRINTF_1 ATTRIBUTE_NORETURN;
