...
extern void set_range_info(tree, enum value_range_kind, const wide_int_ref &, const wide_int_ref &);
extern void set_range_info(tree, const value_range_base &);
/* Gets the value range from SSA.  */
extern enum value_range_kind get_range_info(const_tree, wide_int *, wide_int *);
...
extern bool get_ptr_info_alignment(struct ptr_info_def *, unsigned int *, unsigned int *);
extern void mark_ptr_info_alignment_unknown(struct ptr_info_def *);
extern void set_ptr_info_alignment(struct ptr_info_def *, unsigned int, unsigned int);
...
extern void duplicate_ssa_name_range_info(tree, enum value_range_kind, struct range_info_def *);
...
static inline tree make_ssa_name(tree var, gimple *stmt = NULL)
{
...
static inline tree copy_ssa_name(tree var, gimple *stmt = NULL)
{
...
static inline tree duplicate_ssa_name(tree var, gimple *stmt)
{
...
static inline void release_ssa_name(tree name)
{
...
static inline tree make_temp_ssa_name(tree type, gimple *stmt, const char *name)
{
        tree ssa_name;
