...
static inline unsigned HOST_WIDE_INT least_bit_hwi(unsigned HOST_WIDE_INT x)
{
        return (x & -x);
}
...
static inline bool pow2_or_zerop(unsigned HOST_WIDE_INT x)
{
...
static inline bool pow2p_hwi(unsigned HOST_WIDE_INT x)
{
...
static inline int clz_hwi(unsigned HOST_WIDE_INT x)
{
        if (x == 0) {
...
static inline int ctz_hwi(unsigned HOST_WIDE_INT x)
{
        if (x == 0) {
                return HOST_BITS_PER_WIDE_INT;
        }
...
static inline int ffs_hwi(unsigned HOST_WIDE_INT x)
{
#if HOST_BITS_PER_WIDE_INT == HOST_BITS_PER_LONG
...
static inline int popcount_hwi(unsigned HOST_WIDE_INT x)
{
#if HOST_BITS_PER_WIDE_INT == HOST_BITS_PER_LONG
...
static inline int floor_log2(unsigned HOST_WIDE_INT x)
{
        return HOST_BITS_PER_WIDE_INT - 1 - clz_hwi(x);
}

static inline int ceil_log2(unsigned HOST_WIDE_INT x)
{
        return x == 0 ? 0 : floor_log2(x - 1) + 1;
}

static inline int exact_log2(unsigned HOST_WIDE_INT x)
{
...
#define HOST_WIDE_INT_MIN (HOST_WIDE_INT)(HOST_WIDE_INT_1U << (HOST_BITS_PER_WIDE_INT - 1))
...
static inline int ctz_or_zero(unsigned HOST_WIDE_INT x)
{
        return ffs_hwi(x) - 1;
}
...
static inline HOST_WIDE_INT sext_hwi(HOST_WIDE_INT src, unsigned int prec)
{
...
static inline unsigned HOST_WIDE_INT zext_hwi(unsigned HOST_WIDE_INT src, unsigned int prec)
{
        if (prec == HOST_BITS_PER_WIDE_INT) {
                return src;
        } else {
...
inline HOST_WIDE_INT abs_hwi(HOST_WIDE_INT x)
{
...
inline unsigned HOST_WIDE_INT absu_hwi(HOST_WIDE_INT x)
{
