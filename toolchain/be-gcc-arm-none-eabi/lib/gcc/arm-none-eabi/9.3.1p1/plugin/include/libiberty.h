...
/* HAVE_DECL_* is a three-state macro: undefined, 0 or 1.  If it is
   ...
   is 1, we found it so don't provide any declaration at all.  */
        ...
        defined(__CYGWIN32__) || defined(__MINGW32__) || defined(__DragonFly__) ||                 \
...
extern char *concat(const char *,
                    ...) ATTRIBUTE_MALLOC ATTRIBUTE_RETURNS_NONNULL ATTRIBUTE_SENTINEL;
...
extern char *concat_copy(char *, const char *, ...) ATTRIBUTE_RETURNS_NONNULL
...
extern char *make_relative_prefix(const char *, const char *, const char *) ATTRIBUTE_MALLOC;
...
extern const char *pex_run(struct pex_obj *obj, int flags, const char *executable,
                           char *const *argv, const char *outname, const char *errname, int *err);
...
extern const char *pex_run_in_environment(struct pex_obj *obj, int flags, const char *executable,
...
extern FILE *pex_input_file(struct pex_obj *obj, int flags, const char *in_name);
...
extern const char *pex_one(int flags, const char *executable, char *const *argv, const char *pname,
                           const char *outname, const char *errname, int *status, int *err);
...
__extension__ extern long long int strtoll(const char *nptr, char **endptr, int base);
#endif

#if defined(HAVE_LONG_LONG) && defined(HAVE_DECL_STRTOULL) && !HAVE_DECL_STRTOULL
__extension__ extern unsigned long long int strtoull(const char *nptr, char **endptr, int base);
#endif
...
#define ASTRDUP(X)                                                                                 \
        (__extension__({                                                                           \
                const char *const libiberty_optr = (X);                                            \
...
#define ASTRDUP(X)                                                                                 \
        (libiberty_optr = (X), libiberty_len = strlen(libiberty_optr) + 1,                         \
