...
static inline struct sequence_stack *get_current_sequence(void)
{
...
static inline struct sequence_stack *get_topmost_sequence(void)
{
...
static inline rtx_insn *get_insns(void)
{
...
static inline void set_first_insn(rtx_insn *insn)
{
...
static inline rtx_insn *get_last_insn(void)
{
...
static inline void set_last_insn(rtx_insn *insn)
{
...
static inline int get_max_uid(void)
{
...
extern rtx adjust_address_1(rtx, machine_mode, poly_int64, int, int, int, poly_int64);
extern rtx adjust_automodify_address_1(rtx, machine_mode, rtx, poly_int64, int);
