...
extern void gsi_insert_seq_before_without_update(gimple_stmt_iterator *, gimple_seq,
                                                 enum gsi_iterator_update);
extern void gsi_insert_seq_before(gimple_stmt_iterator *, gimple_seq, enum gsi_iterator_update);
extern void gsi_insert_seq_after_without_update(gimple_stmt_iterator *, gimple_seq,
                                                enum gsi_iterator_update);
extern void gsi_insert_seq_after(gimple_stmt_iterator *, gimple_seq, enum gsi_iterator_update);
...
extern void gsi_insert_before_without_update(gimple_stmt_iterator *, gimple *,
                                             enum gsi_iterator_update);
extern void gsi_insert_before(gimple_stmt_iterator *, gimple *, enum gsi_iterator_update);
extern void gsi_insert_after_without_update(gimple_stmt_iterator *, gimple *,
                                            enum gsi_iterator_update);
extern void gsi_insert_after(gimple_stmt_iterator *, gimple *, enum gsi_iterator_update);
...
static inline gimple_stmt_iterator gsi_start_1(gimple_seq *seq)
{
...
static inline gimple_stmt_iterator gsi_none(void)
{
        gimple_stmt_iterator i;
        i.ptr = NULL;
        i.seq = NULL;
...
static inline gimple_stmt_iterator gsi_last_1(gimple_seq *seq)
{
        gimple_stmt_iterator i;
...
static inline void gsi_next_nondebug(gimple_stmt_iterator *i)
{
        do {
                gsi_next(i);
...
static inline void gsi_prev_nondebug(gimple_stmt_iterator *i)
{
        do {
                gsi_prev(i);
        } while (!gsi_end_p(*i) && is_gimple_debug(gsi_stmt(*i)));
...
static inline gimple_stmt_iterator gsi_start_nondebug(gimple_seq seq)
{
...
static inline gimple_stmt_iterator gsi_start_nondebug_bb(basic_block bb)
{
...
static inline gimple_stmt_iterator gsi_start_nondebug_after_labels_bb(basic_block bb)
{
...
static inline gimple_stmt_iterator gsi_last_nondebug_bb(basic_block bb)
{
...
static inline bool gsi_one_nondebug_before_end_p(gimple_stmt_iterator i)
{
...
static inline void gsi_next_nonvirtual_phi(gphi_iterator *i)
{
        gphi *phi;
...
static inline bool gimple_seq_nondebug_singleton_p(gimple_seq seq)
{
