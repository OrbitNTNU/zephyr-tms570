...
struct cfg_hooks {
        ...
        /* A hook for duplicating loop in CFG, currently this is used
           in loop versioning.  */
        bool (*cfg_hook_duplicate_loop_to_header_edge)(struct loop *, edge, unsigned, sbitmap, edge,
                                                       vec<edge> *, int);
...
static inline void checking_verify_flow_info(void)
{
...
extern edge make_forwarder_block(basic_block, bool (*)(edge), void (*)(basic_block));
...
extern basic_block duplicate_block(basic_block, edge, basic_block, copy_bb_data * = NULL);
...
extern bool cfg_hook_duplicate_loop_to_header_edge(struct loop *loop, edge, unsigned int ndupl,
...
extern void copy_bbs(basic_block *, unsigned, basic_block *, edge *, unsigned, edge *,
