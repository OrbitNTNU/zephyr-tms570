...
extern void asm_fprintf(FILE *file, const char *p, ...) ATTRIBUTE_ASM_FPRINTF(2, 3);
...
extern void assemble_real(REAL_VALUE_TYPE, scalar_float_mode, unsigned, bool = false);
...
#define SECTION_STRINGS                                                                            \
        0x10000                      /* contains zero terminated strings without                   \
                                        embedded zeros */
...
typedef bool (*noswitch_section_callback)(tree decl, const char *name, unsigned HOST_WIDE_INT size,
...
extern section *get_unnamed_section(unsigned int, void (*)(const void *), const void *);
extern section *get_section(const char *, unsigned int, tree);
extern section *get_named_section(tree, const char *, int);
extern section *get_variable_section(tree, bool);
extern void place_block_symbol(rtx);
extern rtx get_section_anchor(struct object_block *, HOST_WIDE_INT, enum tls_model);
extern section *mergeable_constant_section(machine_mode, unsigned HOST_WIDE_INT, unsigned int);
...
extern section *default_select_rtx_section(machine_mode, rtx, unsigned HOST_WIDE_INT);
extern section *default_elf_select_rtx_section(machine_mode, rtx, unsigned HOST_WIDE_INT);
...
extern void default_generate_internal_label(char *, const char *, unsigned long);
extern void default_internal_label(FILE *, const char *, unsigned long);
extern void default_asm_declare_constant_name(FILE *, const char *, const_tree, HOST_WIDE_INT);
