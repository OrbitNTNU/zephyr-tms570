...
#define TARGET_ASM_ALIGNED_INT_OP                                                                  \
        {                                                                                          \
                TARGET_ASM_ALIGNED_HI_OP, TARGET_ASM_ALIGNED_PSI_OP, TARGET_ASM_ALIGNED_SI_OP,     \
                        TARGET_ASM_ALIGNED_PDI_OP, TARGET_ASM_ALIGNED_DI_OP,                       \
                        TARGET_ASM_ALIGNED_PTI_OP, TARGET_ASM_ALIGNED_TI_OP                        \
        }
