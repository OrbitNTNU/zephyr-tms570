...
static inline location_t redirect_edge_var_map_location(edge_var_map *v)
{
        return v->locus;
}
...
static inline void checking_verify_ssa(bool check_modified_stmt, bool check_ssa_operands)
{
        if (flag_checking) {
