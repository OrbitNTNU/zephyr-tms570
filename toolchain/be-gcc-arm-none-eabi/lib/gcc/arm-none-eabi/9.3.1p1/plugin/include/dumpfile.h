...
#define ATTRIBUTE_GCC_DUMP_PRINTF(m, n)                                                            \
        __attribute__((__format__(__gcc_dump_printf__, m, n))) ATTRIBUTE_NONNULL(m)
#else
...
enum dump_flag {
        ...
        MSG_ALL_KINDS = (MSG_OPTIMIZED_LOCATIONS | MSG_MISSED_OPTIMIZATION | MSG_NOTE),
        ...
        MSG_ALL_PRIORITIES =
                (MSG_PRIORITY_USER_FACING | MSG_PRIORITY_INTERNALS | MSG_PRIORITY_REEMITTED),
...
static inline dump_flags_t operator|(dump_flags_t lhs, dump_flags_t rhs)
{
...
static inline dump_flags_t operator~(dump_flags_t flags)
{
...
enum optgroup_flag {
        ...
        OPTGROUP_ALL = (OPTGROUP_IPA | OPTGROUP_LOOP | OPTGROUP_INLINE | OPTGROUP_OMP |
                        OPTGROUP_VEC | OPTGROUP_OTHER)
};

typedef enum optgroup_flag optgroup_flags_t;

static inline optgroup_flags_t operator|(optgroup_flags_t lhs, optgroup_flags_t rhs)
{
...
class dump_user_location_t
{
      ...
      private:
        ...
        dump_user_location_t(profile_count count, location_t loc) : m_count(count), m_loc(loc)
        {
        }
...
#else
                const char *file = __FILE__, int line = __LINE__, const char *function = NULL
#endif
                        )
...
class dump_metadata_t
{
      public:
        dump_metadata_t(dump_flags_t dump_flags,
                ...
                : m_dump_flags(dump_flags), m_impl_location(impl_location)
        {
        }
...
class dump_location_t
{
      public:
        ...
        dump_location_t(const dump_impl_location_t &impl_location = dump_impl_location_t())
                : m_user_location(dump_user_location_t()), m_impl_location(impl_location)
        {
        }
        ...
        dump_location_t(const gimple *stmt,
                        const dump_impl_location_t &impl_location = dump_impl_location_t())
                : m_user_location(dump_user_location_t(stmt)), m_impl_location(impl_location)
        {
        }
        ...
        dump_location_t(const rtx_insn *insn,
                        const dump_impl_location_t &impl_location = dump_impl_location_t())
                : m_user_location(dump_user_location_t(insn)), m_impl_location(impl_location)
        {
        }
        ...
        dump_location_t(const dump_user_location_t &user_location,
                        const dump_impl_location_t &impl_location = dump_impl_location_t())
                : m_user_location(user_location), m_impl_location(impl_location)
        {
        }
        ...
        from_location_t(location_t loc,
                        const dump_impl_location_t &impl_location = dump_impl_location_t())
        {
                return dump_location_t(dump_user_location_t::from_location_t(loc), impl_location);
        }
...
static inline bool dump_enabled_p(void)
{
...
extern void dump_printf(const dump_metadata_t &, const char *, ...) ATTRIBUTE_GCC_DUMP_PRINTF(2, 3);

extern void dump_printf_loc(const dump_metadata_t &, const dump_user_location_t &, const char *,
                            ...) ATTRIBUTE_GCC_DUMP_PRINTF(3, 0);
extern void dump_function(int phase, tree fn);
extern void dump_basic_block(dump_flags_t, basic_block, int);
extern void dump_generic_expr_loc(const dump_metadata_t &, const dump_user_location_t &,
                                  dump_flags_t, tree);
extern void dump_generic_expr(const dump_metadata_t &, dump_flags_t, tree);
extern void dump_gimple_stmt_loc(const dump_metadata_t &, const dump_user_location_t &,
                                 dump_flags_t, gimple *, int);
extern void dump_gimple_stmt(const dump_metadata_t &, dump_flags_t, gimple *, int);
extern void dump_gimple_expr_loc(const dump_metadata_t &, const dump_user_location_t &,
                                 dump_flags_t, gimple *, int);
...
extern void dump_begin_scope(const char *name, const dump_user_location_t &user_location,
...
{
      public:
        auto_dump_scope(const char *name, const dump_user_location_t &user_location,
                        const dump_impl_location_t &impl_location = dump_impl_location_t())
        {
                if (dump_enabled_p()) {
...
#define AUTO_DUMP_SCOPE(NAME, USER_LOC) auto_dump_scope scope(NAME, USER_LOC)
...
class dump_manager
{
      public:
        ...
        unsigned int dump_register(const char *suffix, const char *swtch, const char *glob,
      ...
      private:
        ...
        int opt_info_enable_passes(optgroup_flags_t optgroup_flags, dump_flags_t flags,
                                   const char *filename);
