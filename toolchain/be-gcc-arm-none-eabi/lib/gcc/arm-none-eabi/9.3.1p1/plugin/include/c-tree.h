...
#define C_DECL_ISNT_PROTOTYPE(EXP)                                                                 \
        (EXP == 0 || (!prototype_p(TREE_TYPE(EXP)) && !fndecl_built_in_p(EXP)))
...
extern struct c_declarator *build_array_declarator(location_t, tree, struct c_declspecs *, bool,
                                                   bool);
...
extern tree finish_struct(location_t, tree, tree, tree, struct c_struct_parse_info *);
...
extern tree start_decl(struct c_declarator *, struct c_declspecs *, bool, tree);
extern tree start_struct(location_t, enum tree_code, tree, struct c_struct_parse_info **);
...
extern struct c_expr parser_build_binary_op(location_t, enum tree_code, struct c_expr,
                                            struct c_expr);
extern tree build_conditional_expr(location_t, tree, bool, tree, tree, location_t, tree, tree,
                                   location_t);
...
extern tree c_build_function_call_vec(location_t, vec<location_t>, tree, vec<tree, va_gc> *,
                                      vec<tree, va_gc> *);
