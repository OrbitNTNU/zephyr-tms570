...
inline rtx_vector_builder::rtx_vector_builder(machine_mode mode, unsigned int npatterns,
...
inline void rtx_vector_builder::new_vector(machine_mode mode, unsigned int npatterns,
                                           unsigned int nelts_per_pattern)
{
        m_mode = mode;
...
inline bool rtx_vector_builder::equal_p(rtx elt1, rtx elt2) const
{
...
inline bool rtx_vector_builder::allow_steps_p() const
{
...
inline bool rtx_vector_builder::integral_p(rtx elt) const
{
...
inline wide_int rtx_vector_builder::step(rtx elt1, rtx elt2) const
{
