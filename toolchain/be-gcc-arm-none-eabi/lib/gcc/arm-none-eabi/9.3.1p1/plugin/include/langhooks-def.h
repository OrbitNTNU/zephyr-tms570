...
extern void lhd_print_error_function(diagnostic_context *, const char *, struct diagnostic_info *);
...
extern void lhd_init_options(unsigned int, struct cl_decoded_option *);
extern bool lhd_complain_wrong_lang_p(const struct cl_option *);
extern bool lhd_handle_option(size_t, const char *, HOST_WIDE_INT, int, location_t,
...
extern const char *lhd_get_substring_location(const substring_loc &, location_t *out_loc);
...
#define LANG_HOOKS_FOR_TYPES_INITIALIZER                                                           \
        {                                                                                          \
                LANG_HOOKS_MAKE_TYPE, LANG_HOOKS_CLASSIFY_RECORD, LANG_HOOKS_TYPE_FOR_MODE,        \
                        LANG_HOOKS_TYPE_FOR_SIZE, LANG_HOOKS_GENERIC_TYPE_P,                       \
                        LANG_HOOKS_GET_ARGUMENT_PACK_ELEMS, LANG_HOOKS_TYPE_PROMOTES_TO,           \
                        ...
                        LANG_HOOKS_OMP_MAPPABLE_TYPE, LANG_HOOKS_TYPE_HASH_EQ,                     \
                        LANG_HOOKS_COPY_LANG_QUALIFIERS, LANG_HOOKS_GET_ARRAY_DESCR_INFO,          \
                        LANG_HOOKS_GET_SUBRANGE_BOUNDS, LANG_HOOKS_GET_TYPE_BIAS,                  \
                        LANG_HOOKS_DESCRIPTIVE_TYPE, LANG_HOOKS_RECONSTRUCT_COMPLEX_TYPE,          \
                        LANG_HOOKS_ENUM_UNDERLYING_BASE_TYPE, LANG_HOOKS_GET_DEBUG_TYPE,           \
                        LANG_HOOKS_GET_FIXED_POINT_TYPE_INFO, LANG_HOOKS_TYPE_DWARF_ATTRIBUTE,     \
...
#define LANG_HOOKS_DECLS                                                                           \
        {                                                                                          \
                LANG_HOOKS_GLOBAL_BINDINGS_P, LANG_HOOKS_PUSHDECL, LANG_HOOKS_GETDECLS,            \
                        ...
                        LANG_HOOKS_DECL_OK_FOR_SIBCALL, LANG_HOOKS_OMP_PRIVATIZE_BY_REFERENCE,     \
                        ...
                        LANG_HOOKS_OMP_CLAUSE_COPY_CTOR, LANG_HOOKS_OMP_CLAUSE_ASSIGN_OP,          \
                        LANG_HOOKS_OMP_CLAUSE_LINEAR_CTOR, LANG_HOOKS_OMP_CLAUSE_DTOR,             \
                        LANG_HOOKS_OMP_FINISH_CLAUSE, LANG_HOOKS_OMP_SCALAR_P                      \
        }
...
#define LANG_HOOKS_LTO                                                                             \
        {                                                                                          \
                LANG_HOOKS_BEGIN_SECTION, LANG_HOOKS_APPEND_DATA, LANG_HOOKS_END_SECTION           \
        }

/* The whole thing.  The structure is defined in langhooks.h.  */
#define LANG_HOOKS_INITIALIZER                                                                     \
        {                                                                                          \
                LANG_HOOKS_NAME, LANG_HOOKS_IDENTIFIER_SIZE, LANG_HOOKS_FREE_LANG_DATA,            \
                        LANG_HOOKS_TREE_SIZE, LANG_HOOKS_OPTION_LANG_MASK,                         \
                        LANG_HOOKS_INIT_OPTIONS_STRUCT, LANG_HOOKS_INIT_OPTIONS,                   \
                        LANG_HOOKS_INITIALIZE_DIAGNOSTICS, LANG_HOOKS_REGISTER_DUMPS,              \
                        LANG_HOOKS_COMPLAIN_WRONG_LANG_P, LANG_HOOKS_HANDLE_OPTION,                \
                        LANG_HOOKS_POST_OPTIONS, LANG_HOOKS_INIT, LANG_HOOKS_FINISH,               \
                        LANG_HOOKS_PARSE_FILE, LANG_HOOKS_MISSING_NORETURN_OK_P,                   \
                        LANG_HOOKS_GET_ALIAS_SET, LANG_HOOKS_FINISH_INCOMPLETE_DECL,               \
                        LANG_HOOKS_DUP_LANG_SPECIFIC_DECL, LANG_HOOKS_SET_DECL_ASSEMBLER_NAME,     \
                        LANG_HOOKS_OVERWRITE_DECL_ASSEMBLER_NAME, LANG_HOOKS_PRINT_STATISTICS,     \
                        ...
                        LANG_HOOKS_PRINT_ERROR_FUNCTION, LANG_HOOKS_TO_TARGET_CHARSET,             \
                        LANG_HOOKS_ATTRIBUTE_TABLE, LANG_HOOKS_COMMON_ATTRIBUTE_TABLE,             \
                        LANG_HOOKS_FORMAT_ATTRIBUTE_TABLE, LANG_HOOKS_TREE_INLINING_INITIALIZER,   \
                        LANG_HOOKS_TREE_DUMP_INITIALIZER, LANG_HOOKS_DECLS,                        \
                        LANG_HOOKS_FOR_TYPES_INITIALIZER, LANG_HOOKS_LTO,                          \
                        LANG_HOOKS_GET_INNERMOST_GENERIC_PARMS,                                    \
                        LANG_HOOKS_GET_INNERMOST_GENERIC_ARGS,                                     \
                        LANG_HOOKS_FUNCTION_PARAMETER_PACK_P, LANG_HOOKS_GIMPLIFY_EXPR,            \
                        LANG_HOOKS_BUILTIN_FUNCTION, LANG_HOOKS_BUILTIN_FUNCTION_EXT_SCOPE,        \
                        LANG_HOOKS_INIT_TS, LANG_HOOKS_EXPR_TO_DECL, LANG_HOOKS_EH_PERSONALITY,    \
                        LANG_HOOKS_EH_RUNTIME_TYPE, LANG_HOOKS_EH_PROTECT_CLEANUP_ACTIONS,         \
                        LANG_HOOKS_BLOCK_MAY_FALLTHRU, LANG_HOOKS_EH_USE_CXA_END_CLEANUP,          \
                        LANG_HOOKS_DEEP_UNSHARING, LANG_HOOKS_CUSTOM_FUNCTION_DESCRIPTORS,         \
