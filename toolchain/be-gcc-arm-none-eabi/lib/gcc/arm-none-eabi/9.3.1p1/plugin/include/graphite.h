...
static inline bool pdr_read_p(poly_dr_p pdr)
{
...
static inline bool pdr_write_p(poly_dr_p pdr)
{
...
static inline bool pdr_may_write_p(poly_dr_p pdr)
{
...
static inline basic_block pbb_bb(poly_bb_p pbb)
{
        return GBB_BB(PBB_BLACK_BOX(pbb));
}

static inline int pbb_index(poly_bb_p pbb)
{
...
static inline loop_p pbb_loop(poly_bb_p pbb)
{
...
static inline void pbb_set_black_box(poly_bb_p pbb, gimple_poly_bb_p black_box)
{
...
extern gimple_poly_bb_p new_gimple_poly_bb(basic_block, vec<data_reference_p>, vec<scalar_use>,
                                           vec<tree>);
extern bool apply_poly_transforms(scop_p);

/* Set the region of SCOP to REGION.  */

static inline void scop_set_region(scop_p scop, sese_info_p region)
{
...
static inline graphite_dim_t scop_nb_params(scop_p scop)
{
...
static inline void scop_set_nb_params(scop_p scop, graphite_dim_t nb_params)
{
