...
class GTY((for_user)) value_range_base
{
      ...
      protected:
        void check();
        static value_range_base union_helper(const value_range_base *, const value_range_base *);
        ...
        friend void gt_pch_p_16value_range_base(void *, void *, gt_pointer_operator, void *);
...
inline value_range_base::value_range_base()
{
        m_kind = VR_UNDEFINED;
        m_min = m_max = NULL;
}

inline value_range::value_range() : value_range_base()
{
        m_equiv = NULL;
}
...
inline value_range_kind value_range_base::kind() const
{
        return m_kind;
}

inline bitmap value_range::equiv() const
{
        return m_equiv;
}
...
inline tree value_range_base::min() const
{
        return m_min;
}
...
inline tree value_range_base::max() const
{
        return m_max;
}
...
inline bool value_range_base::varying_p() const
{
...
inline bool value_range_base::undefined_p() const
{
...
inline bool value_range_base::zero_p() const
{
        return (m_kind == VR_RANGE && integer_zerop(m_min) && integer_zerop(m_max));
}
...
extern void register_edge_assert_for(tree, edge, enum tree_code, tree, tree, vec<assert_info> &);
...
extern void extract_range_from_unary_expr(value_range_base *vr, enum tree_code code, tree type,
                                          const value_range_base *vr0_, tree op0_type);
extern void extract_range_from_binary_expr(value_range_base *, enum tree_code, tree,
                                           const value_range_base *, const value_range_base *);

extern bool vrp_operand_equal_p(const_tree, const_tree);
extern enum value_range_kind intersect_range_with_nonzero_bits(enum value_range_kind, wide_int *,
                                                               wide_int *, const wide_int &,
                                                               signop);
extern bool vrp_set_zero_nonzero_bits(const tree, const value_range_base *, wide_int *, wide_int *);
...
inline bool range_includes_zero_p(const value_range_base *vr)
{
