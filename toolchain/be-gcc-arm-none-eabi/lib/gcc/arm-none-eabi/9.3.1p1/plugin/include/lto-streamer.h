...
#define DEFINE_DECL_STREAM_FUNCS(UPPER_NAME, name)                                                 \
        static inline tree lto_file_decl_data_get_##name(struct lto_file_decl_data *data,          \
                                                         unsigned int idx)                         \
        {                                                                                          \
                ...
                return (*state->streams[LTO_DECL_STREAM_##UPPER_NAME])[idx];                       \
                                                                                                   ...
                                                                                                   \
        static inline unsigned int lto_file_decl_data_num_##name##s(                               \
                struct lto_file_decl_data *data)                                                   \
        {                                                                                          \
                struct lto_in_decl_state *state = data->current_decl_state;                        \
...
typedef const char *(lto_get_section_data_f)(struct lto_file_decl_data *, enum lto_section_type,
                                             const char *, size_t *);
...
typedef void(lto_free_section_data_f)(struct lto_file_decl_data *, enum lto_section_type,
...
class lto_location_cache
{
      public:
        ...
        void input_location(location_t *loc, struct bitpack_d *bp, struct data_in *data_in);
        lto_location_cache()
...
class lto_input_block
{
      public:
        ...
        lto_input_block(const char *data_, unsigned int len_, const unsigned char *mode_table_)
...
/* In lto-section-in.c  */
extern struct lto_input_block *lto_create_simple_input_block(struct lto_file_decl_data *,
                                                             enum lto_section_type, const char **,
                                                             size_t *);
extern void lto_destroy_simple_input_block(struct lto_file_decl_data *, enum lto_section_type,
                                           struct lto_input_block *, const char *, size_t);
extern void lto_set_in_hooks(struct lto_file_decl_data **, lto_get_section_data_f *,
...
extern const char *lto_get_section_data(struct lto_file_decl_data *, enum lto_section_type,
                                        const char *, size_t *, bool decompress = false);
extern const char *lto_get_raw_section_data(struct lto_file_decl_data *, enum lto_section_type,
                                            const char *, size_t *);
extern void lto_free_section_data(struct lto_file_decl_data *, enum lto_section_type, const char *,
                                  const char *, size_t, bool decompress = false);
extern void lto_free_raw_section_data(struct lto_file_decl_data *, enum lto_section_type,
                                      const char *, const char *, size_t);
extern htab_t lto_create_renaming_table(void);
extern void lto_record_renamed_decl(struct lto_file_decl_data *, const char *, const char *);
extern const char *lto_get_decl_name_mapping(struct lto_file_decl_data *, const char *);
extern struct lto_in_decl_state *lto_new_in_decl_state(void);
extern void lto_delete_in_decl_state(struct lto_in_decl_state *);
extern struct lto_in_decl_state *lto_get_function_in_decl_state(struct lto_file_decl_data *, tree);
...
extern void lto_value_range_error(const char *, HOST_WIDE_INT, HOST_WIDE_INT,
...
extern bool lto_output_decl_index(struct lto_output_stream *, struct lto_tree_ref_encoder *, tree,
                                  unsigned int *);
extern void lto_output_field_decl_index(struct lto_out_decl_state *, struct lto_output_stream *,
                                        tree);
extern void lto_output_fn_decl_index(struct lto_out_decl_state *, struct lto_output_stream *, tree);
extern void lto_output_namespace_decl_index(struct lto_out_decl_state *, struct lto_output_stream *,
                                            tree);
extern void lto_output_var_decl_index(struct lto_out_decl_state *, struct lto_output_stream *,
                                      tree);
extern void lto_output_type_decl_index(struct lto_out_decl_state *, struct lto_output_stream *,
                                       tree);
extern void lto_output_type_ref_index(struct lto_out_decl_state *, struct lto_output_stream *,
                                      tree);
extern struct lto_simple_output_block *lto_create_simple_output_block(enum lto_section_type);
...
extern void lto_record_function_out_decl_state(tree, struct lto_out_decl_state *);
...
extern void lto_input_function_body(struct lto_file_decl_data *, struct cgraph_node *,
                                    const char *);
extern void lto_input_variable_constructor(struct lto_file_decl_data *, struct varpool_node *,
                                           const char *);
extern void lto_input_constructors_and_inits(struct lto_file_decl_data *, const char *);
...
extern struct data_in *lto_data_in_create(struct lto_file_decl_data *, const char *, unsigned,
                                          vec<ld_plugin_symbol_resolution_t>);
extern void lto_data_in_delete(struct data_in *);
extern void lto_input_data_block(struct lto_input_block *, void *, size_t);
void lto_input_location(location_t *, struct bitpack_d *, struct data_in *);
location_t stream_input_location_now(struct bitpack_d *bp, struct data_in *data);
tree lto_input_tree_ref(struct lto_input_block *, struct data_in *, struct function *,
                        enum LTO_tags);
...
void lto_output_decl_state_refs(struct output_block *, struct lto_output_stream *,
                                struct lto_out_decl_state *);
...
void cl_optimization_stream_out(struct output_block *, struct bitpack_d *,
                                struct cl_optimization *);

void cl_optimization_stream_in(struct data_in *, struct bitpack_d *, struct cl_optimization *);
...
static inline bool lto_tag_is_tree_code_p(enum LTO_tags tag)
{
        return tag > LTO_tree_pickle_reference && (unsigned)tag <= MAX_TREE_CODES;
}

/* Return true if LTO tag TAG corresponds to a gimple code.  */
static inline bool lto_tag_is_gimple_code_p(enum LTO_tags tag)
{
...
static inline enum LTO_tags lto_gimple_code_to_tag(enum gimple_code code)
{
...
static inline enum gimple_code lto_tag_to_gimple_code(enum LTO_tags tag)
{
...
/* Return the LTO tag corresponding to tree code CODE.  See enum
   LTO_tags for details on the conversion.  */
static inline enum LTO_tags lto_tree_code_to_tag(enum tree_code code)
{
...
/* Return the tree code corresponding to TAG.  See enum LTO_tags for
   details on the conversion.  */
static inline enum tree_code lto_tag_to_tree_code(enum LTO_tags tag)
{
...
static inline void lto_tag_check(enum LTO_tags actual, enum LTO_tags expected)
{
        if (actual != expected) {
...
static inline void lto_tag_check_range(enum LTO_tags actual, enum LTO_tags tag1, enum LTO_tags tag2)
{
        if (actual < tag1 || actual > tag2) {
                internal_error("bytecode stream: tag %s is not in the expected range "
                               "[%s, %s]",
                               lto_tag_name(actual), lto_tag_name(tag1), lto_tag_name(tag2));
        }
}

/* Initialize an lto_out_decl_buffer ENCODER.  */
static inline void lto_init_tree_ref_encoder(struct lto_tree_ref_encoder *encoder)
{
...
static inline void lto_destroy_tree_ref_encoder(struct lto_tree_ref_encoder *encoder)
{
...
static inline unsigned int lto_tree_ref_encoder_size(struct lto_tree_ref_encoder *encoder)
{
        return encoder->trees.length();
}

/* Return the IDX-th tree in ENCODER. */
static inline tree lto_tree_ref_encoder_get_tree(struct lto_tree_ref_encoder *encoder,
                                                 unsigned int idx)
{
...
/* Return the node pointed to by LSI.  */
static inline struct cgraph_node *lsei_cgraph_node(lto_symtab_encoder_iterator lsei)
{
