...
static inline enum br_predictor gimple_predict_predictor(gimple *gs)
{
...
static inline void gimple_predict_set_predictor(gimple *gs, enum br_predictor predictor)
{
        GIMPLE_CHECK(gs, GIMPLE_PREDICT);
        gs->subcode = (gs->subcode & GF_PREDICT_TAKEN) | (unsigned)predictor;
}

/* Return the outcome of GIMPLE_PREDICT statement GS.  */

static inline enum prediction gimple_predict_outcome(gimple *gs)
{
        GIMPLE_CHECK(gs, GIMPLE_PREDICT);
...
static inline void gimple_predict_set_outcome(gimple *gs, enum prediction outcome)
{
        GIMPLE_CHECK(gs, GIMPLE_PREDICT);
        if (outcome == TAKEN) {
...
inline gimple *gimple_build_predict(enum br_predictor predictor, enum prediction outcome)
{
...
static inline bool is_gimple_predict(const gimple *gs)
{
