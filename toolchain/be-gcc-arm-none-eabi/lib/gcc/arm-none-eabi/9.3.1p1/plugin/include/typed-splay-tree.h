...
template <typename KEY_TYPE, typename VALUE_TYPE> class typed_splay_tree
{
      public:
...
inline typed_splay_tree<KEY_TYPE, VALUE_TYPE>::typed_splay_tree(compare_fn compare_fn,
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline typed_splay_tree<KEY_TYPE, VALUE_TYPE>::~typed_splay_tree()
{
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline VALUE_TYPE typed_splay_tree<KEY_TYPE, VALUE_TYPE>::lookup(key_type key)
{
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline VALUE_TYPE typed_splay_tree<KEY_TYPE, VALUE_TYPE>::predecessor(key_type key)
{
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline VALUE_TYPE typed_splay_tree<KEY_TYPE, VALUE_TYPE>::successor(key_type key)
{
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline void typed_splay_tree<KEY_TYPE, VALUE_TYPE>::insert(key_type key, value_type value)
{
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline void typed_splay_tree<KEY_TYPE, VALUE_TYPE>::remove(key_type key)
{
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline VALUE_TYPE typed_splay_tree<KEY_TYPE, VALUE_TYPE>::max()
{
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline VALUE_TYPE typed_splay_tree<KEY_TYPE, VALUE_TYPE>::min()
{
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline int typed_splay_tree<KEY_TYPE, VALUE_TYPE>::foreach(foreach_fn foreach_fn, void *user_data)
{
...
/* Internal function for converting from splay_tree_node to
   VALUE_TYPE.  */
template <typename KEY_TYPE, typename VALUE_TYPE>
inline VALUE_TYPE typed_splay_tree<KEY_TYPE, VALUE_TYPE>::node_to_value(splay_tree_node node)
{
        if (node) {
                return node->value;
        } else {
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline void typed_splay_tree<KEY_TYPE, VALUE_TYPE>::KDEL(splay_tree_key x)
{
        if (delete_key) {
                (*delete_key)(x);
        }
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline void typed_splay_tree<KEY_TYPE, VALUE_TYPE>::VDEL(splay_tree_value x)
{
        if (delete_value) {
                (*delete_value)(x);
        }
...
template <typename KEY_TYPE, typename VALUE_TYPE>
void typed_splay_tree<KEY_TYPE, VALUE_TYPE>::splay_tree_delete_helper(splay_tree_node node)
{
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline void typed_splay_tree<KEY_TYPE, VALUE_TYPE>::rotate_left(splay_tree_node *pp,
                                                                splay_tree_node p,
                                                                splay_tree_node n)
{
        splay_tree_node tmp;
...
template <typename KEY_TYPE, typename VALUE_TYPE>
inline void typed_splay_tree<KEY_TYPE, VALUE_TYPE>::rotate_right(splay_tree_node *pp,
                                                                 splay_tree_node p,
                                                                 splay_tree_node n)
{
        splay_tree_node tmp;
...
typed_splay_tree<KEY_TYPE, VALUE_TYPE>::splay_tree_insert(splay_tree_key key,
                                                          splay_tree_value value)
{
        int comparison = 0;
...
template <typename KEY_TYPE, typename VALUE_TYPE>
typename typed_splay_tree<KEY_TYPE, VALUE_TYPE>::splay_tree_node
typed_splay_tree<KEY_TYPE, VALUE_TYPE>::splay_tree_predecessor(splay_tree_key key)
{
        int comparison;
        splay_tree_node node;
...
template <typename KEY_TYPE, typename VALUE_TYPE>
typename typed_splay_tree<KEY_TYPE, VALUE_TYPE>::splay_tree_node
typed_splay_tree<KEY_TYPE, VALUE_TYPE>::splay_tree_successor(splay_tree_key key)
{
        int comparison;
        splay_tree_node node;
