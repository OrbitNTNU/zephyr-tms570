...
extern tree fold_build1_loc(location_t, enum tree_code, tree, tree CXX_MEM_STAT_INFO);
...
extern tree fold_build3_loc(location_t, enum tree_code, tree, tree, tree, tree CXX_MEM_STAT_INFO);
...
extern enum tree_code fold_div_compare(enum tree_code, tree, tree, tree *, tree *, bool *);
...
extern tree fold_bit_and_mask(tree, tree, enum tree_code, tree, enum tree_code, tree, tree, tree,
                              enum tree_code, tree, tree, tree *);
extern tree fold_read_from_constant_string(tree);
extern bool wide_int_binop(wide_int &res, enum tree_code, const wide_int &arg1,
                           const wide_int &arg2, signop, wi::overflow_type *);
...
extern bool tree_binary_nonzero_warnv_p(enum tree_code, tree, tree, tree op1, bool *);
extern bool tree_single_nonzero_warnv_p(tree, bool *);
extern bool tree_unary_nonnegative_warnv_p(enum tree_code, tree, tree, bool *, int);
extern bool tree_binary_nonnegative_warnv_p(enum tree_code, tree, tree, tree, bool *, int);
extern bool tree_single_nonnegative_warnv_p(tree, bool *, int);
extern bool tree_call_nonnegative_warnv_p(tree, combined_fn, tree, tree, bool *, int);
...
extern tree combine_comparisons(location_t, enum tree_code, enum tree_code, enum tree_code, tree,
                                tree, tree);
...
extern tree make_range_step(location_t, enum tree_code, tree, tree, tree, tree *, tree *, int *,
                            bool *);
extern tree range_check_type(tree);
extern tree build_range_check(location_t, tree, tree, int, tree, tree);
extern bool merge_ranges(int *, tree *, tree *, int, tree, tree, int, tree, tree);
