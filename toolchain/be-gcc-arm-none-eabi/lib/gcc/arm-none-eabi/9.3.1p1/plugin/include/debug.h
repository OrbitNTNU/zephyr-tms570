...
struct gcc_debug_hooks {
        ...
        void (*source_line)(unsigned int line, unsigned int column, const char *file,
...
extern void debug_nothing_int_int_charstar(unsigned int, unsigned int, const char *);
extern void debug_nothing_int_charstar(unsigned int, const char *);
extern void debug_nothing_int_int_charstar_int_bool(unsigned int, unsigned int, const char *, int,
                                                    bool);
...
extern void debug_nothing_tree_tree_tree_bool_bool(tree, tree, tree, bool, bool);
extern bool debug_true_const_tree(const_tree);
extern void debug_nothing_rtx_insn(rtx_insn *);
extern void debug_nothing_rtx_code_label(rtx_code_label *);
extern bool debug_false_tree_charstarstar_uhwistar(tree, const char **, unsigned HOST_WIDE_INT *);
extern void debug_nothing_tree_charstar_uhwi(tree, const char *, unsigned HOST_WIDE_INT);
...
extern void dwarf2out_begin_prologue(unsigned int, unsigned int, const char *);
...
extern const struct gcc_debug_hooks *dump_go_spec_init(const char *,
...
static inline decl_to_instance_map_t *maybe_create_decl_to_instance_map(int count = 13)
{
