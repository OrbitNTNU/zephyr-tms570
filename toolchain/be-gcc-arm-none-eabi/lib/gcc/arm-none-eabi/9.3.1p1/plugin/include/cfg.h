...
template <class T> class auto_flag
{
      public:
...
{
      public:
        auto_edge_flag(function *fun) : auto_flag<int>(&fun->cfg->edge_flags_allocated)
        {
        }
};
...
{
      public:
        auto_bb_flag(function *fun) : auto_flag<int>(&fun->cfg->bb_flags_allocated)
        {
        }
};
