...
enum sel_dump_cfg_def {
        ...
        SEL_DUMP_CFG_FLAGS = (SEL_DUMP_CFG_CURRENT_REGION | SEL_DUMP_CFG_BB_NOTES_LIST |
                              SEL_DUMP_CFG_AV_SET | SEL_DUMP_CFG_LV_SET | SEL_DUMP_CFG_BB_INSNS |
                              SEL_DUMP_CFG_FENCES | SEL_DUMP_CFG_INSN_SEQNO | SEL_DUMP_CFG_BB_LOOP)
};
...
enum dump_insn_rtx_def {
        ...
        DUMP_INSN_RTX_ALL = (DUMP_INSN_RTX_UID | DUMP_INSN_RTX_PATTERN | DUMP_INSN_RTX_BBN)
};
...
enum dump_vinsn_def {
        ...
        /* Dump all of the above.  */
        DUMP_VINSN_ALL =
                (DUMP_VINSN_INSN_RTX | DUMP_VINSN_TYPE | DUMP_VINSN_COUNT | DUMP_VINSN_COST)
};
...
enum dump_expr_def {
        ...
        /* Dump all of the above.  */
        DUMP_EXPR_ALL =
                (DUMP_EXPR_VINSN | DUMP_EXPR_SPEC | DUMP_EXPR_PRIORITY | DUMP_EXPR_SCHED_TIMES |
                 DUMP_EXPR_SPEC_DONE_DS | DUMP_EXPR_ORIG_BB | DUMP_EXPR_USEFULNESS)
};
...
enum dump_insn_def {
        ...
        /* Dump all of the above.  */
        DUMP_INSN_ALL = (DUMP_INSN_EXPR | DUMP_INSN_SEQNO | DUMP_INSN_BBN | DUMP_INSN_SCHED_CYCLE |
                         DUMP_INSN_UID | DUMP_INSN_PATTERN)
};
