...
extern machine_mode promote_function_mode(const_tree, machine_mode, int *, const_tree, int);
...
extern void compute_stack_clash_protection_loop_data(rtx *, rtx *, rtx *, HOST_WIDE_INT *, rtx);
extern void emit_stack_clash_protection_probe_loop_start(rtx *, rtx *, rtx, bool);
extern void emit_stack_clash_protection_probe_loop_end(rtx, rtx, rtx, bool);
...
extern rtx allocate_dynamic_stack_space(rtx, unsigned, unsigned, HOST_WIDE_INT, bool);
