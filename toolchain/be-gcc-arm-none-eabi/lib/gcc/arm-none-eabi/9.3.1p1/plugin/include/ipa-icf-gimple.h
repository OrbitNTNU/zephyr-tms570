...
#define FPUTS_SPACES(file, space_count, string) fprintf(file, "%*s" string, space_count, " ");
...
static inline void dump_message_1(const char *message, const char *func, unsigned int line)
{
...
static inline bool return_false_with_message_1(const char *message, const char *func,
                                               unsigned int line)
{
        if (dump_file && (dump_flags & TDF_DETAILS)) {
...
#define return_false_with_msg(message) return_false_with_message_1(message, __func__, __LINE__)
...
static inline bool return_with_result(bool result, const char *func, unsigned int line)
{
...
static inline bool return_different_stmts_1(gimple *s1, gimple *s2, const char *code,
...
class func_checker
{
      public:
        ...
        func_checker(tree source_func_decl, tree target_func_decl, bool compare_polymorphic,
