...
vec<cgraph_node *> possible_polymorphic_call_targets(tree, HOST_WIDE_INT,
...
void dump_possible_polymorphic_call_targets(FILE *, tree, HOST_WIDE_INT,
                                            ...
                                            bool verbose = true);
bool possible_polymorphic_call_target_p(tree, HOST_WIDE_INT, const ipa_polymorphic_call_context &,
                                        struct cgraph_node *);
...
inline vec<cgraph_node *> possible_polymorphic_call_targets(struct cgraph_edge *e,
                                                            bool *completep = NULL,
                                                            void **cache_token = NULL,
                                                            bool speculative = false)
{
        ...
        return possible_polymorphic_call_targets(e->indirect_info->otr_type,
                                                 e->indirect_info->otr_token, context, completep,
                                                 cache_token, speculative);
}

/* Same as above but taking OBJ_TYPE_REF as an parameter.  */

inline vec<cgraph_node *> possible_polymorphic_call_targets(tree ref, gimple *call,
                                                            bool *completep = NULL,
                                                            void **cache_token = NULL)
{
        ...
        return possible_polymorphic_call_targets(obj_type_ref_class(ref),
                                                 tree_to_uhwi(OBJ_TYPE_REF_TOKEN(ref)), context,
                                                 completep, cache_token);
}

/* Dump possible targets of a polymorphic call E into F.  */

inline void dump_possible_polymorphic_call_targets(FILE *f, struct cgraph_edge *e,
                                                   bool verbose = true)
{
        ipa_polymorphic_call_context context(e);

        dump_possible_polymorphic_call_targets(f, e->indirect_info->otr_type,
                                               e->indirect_info->otr_token, context, verbose);
}

/* Return true if N can be possibly target of a polymorphic call of
   E.  */

inline bool possible_polymorphic_call_target_p(struct cgraph_edge *e, struct cgraph_node *n)
{
        ipa_polymorphic_call_context context(e);

        return possible_polymorphic_call_target_p(e->indirect_info->otr_type,
                                                  e->indirect_info->otr_token, context, n);
}
...
inline bool polymorphic_type_binfo_p(const_tree binfo)
{
...
inline bool type_with_linkage_p(const_tree t)
{
        ...
        /* To support -fno-lto-odr-type-merigng recognize types with vtables
           to have linkage.  */
        if (RECORD_OR_UNION_TYPE_P(t) && TYPE_BINFO(t) && BINFO_VTABLE(TYPE_BINFO(t))) {
                return true;
        }
...
inline bool type_in_anonymous_namespace_p(const_tree t)
{
        ...
        /* free_lang_data clears TYPE_STUB_DECL but sets assembler name to
           "<anon>"  */
        if (DECL_ASSEMBLER_NAME_SET_P(TYPE_NAME(t))) {
                return !strcmp("<anon>", IDENTIFIER_POINTER(DECL_ASSEMBLER_NAME(TYPE_NAME(t))));
...
inline bool odr_type_p(const_tree t)
{
        ...
        if (TYPE_NAME(t) && DECL_ASSEMBLER_NAME_SET_P(TYPE_NAME(t))) {
                ...
                gcc_checking_assert(
                        strcmp("<anon>", IDENTIFIER_POINTER(DECL_ASSEMBLER_NAME(TYPE_NAME(t)))));
                return true;
        }
        return false;
}
