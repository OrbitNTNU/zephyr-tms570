...
extern void set_param_value(const char *name, int value, int *params, int *params_set);
...
extern void maybe_set_param_value(compiler_param num, int value, int *params, int *params_set);
...
#define PREFETCH_DYNAMIC_STRIDES            PARAM_VALUE(PARAM_PREFETCH_DYNAMIC_STRIDES)
#define PREFETCH_MINIMUM_STRIDE             PARAM_VALUE(PARAM_PREFETCH_MINIMUM_STRIDE)
...
#define LRA_MAX_CONSIDERED_RELOAD_PSEUDOS   PARAM_VALUE(PARAM_LRA_MAX_CONSIDERED_RELOAD_PSEUDOS)
...
#define ASAN_STACK                     PARAM_VALUE(PARAM_ASAN_STACK)
#define ASAN_PROTECT_ALLOCAS           PARAM_VALUE(PARAM_ASAN_PROTECT_ALLOCAS)
#define ASAN_GLOBALS                   PARAM_VALUE(PARAM_ASAN_GLOBALS)
#define ASAN_INSTRUMENT_READS          PARAM_VALUE(PARAM_ASAN_INSTRUMENT_READS)
#define ASAN_INSTRUMENT_WRITES         PARAM_VALUE(PARAM_ASAN_INSTRUMENT_WRITES)
#define ASAN_MEMINTRIN                 PARAM_VALUE(PARAM_ASAN_MEMINTRIN)
#define ASAN_USE_AFTER_RETURN          PARAM_VALUE(PARAM_ASAN_USE_AFTER_RETURN)
