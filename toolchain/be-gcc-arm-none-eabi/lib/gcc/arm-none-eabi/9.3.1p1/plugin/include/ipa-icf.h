...
class sem_item
{
      ...
      protected:
        ...
        static bool compare_referenced_symbol_properties(symtab_node *used_by, symtab_node *n1,
                                                         symtab_node *n2, bool address);
        ...
        bool compare_symbol_references(hash_map<symtab_node *, sem_item *> &ignored_nodes,
...
class sem_function : public sem_item
{
      public:
        ...
        virtual bool equals_wpa(sem_item *item, hash_map<symtab_node *, sem_item *> &ignored_nodes);
        virtual hashval_t get_hash(void);
        virtual bool equals(sem_item *item, hash_map<symtab_node *, sem_item *> &ignored_nodes);
