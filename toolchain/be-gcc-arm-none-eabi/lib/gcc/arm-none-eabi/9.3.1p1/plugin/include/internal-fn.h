...
#define IFN_UNIQUE_CODES                                                                           \
        DEF(UNSPEC), DEF(OACC_FORK), DEF(OACC_JOIN), DEF(OACC_HEAD_MARK), DEF(OACC_TAIL_MARK)
...
static inline const char *internal_fn_name(enum internal_fn fn)
{
...
static inline int internal_fn_flags(enum internal_fn fn)
{
...
static inline const_tree internal_fn_fnspec(enum internal_fn fn)
{
...
extern bool direct_internal_fn_supported_p(internal_fn, tree_pair, optimization_type);
extern bool direct_internal_fn_supported_p(internal_fn, tree, optimization_type);
...
inline bool direct_internal_fn_supported_p(internal_fn fn, tree type0, tree type1,
...
extern bool can_interpret_as_conditional_op_p(gimple *, tree *, tree_code *, tree (&)[3], tree *);
...
extern bool internal_gather_scatter_fn_supported_p(internal_fn, tree, tree, signop, int);
