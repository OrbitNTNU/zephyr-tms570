...
extern void assert_rtl_dump_eq(const location &loc, const char *expected_dump, rtx x,
...
#define ASSERT_RTX_EQ(EXPECTED, ACTUAL)                                                            \
        ...
        ::selftest::assert_rtx_eq_at(SELFTEST_LOCATION, desc_, (EXPECTED), (ACTUAL));              \
        SELFTEST_END_STMT
...
#define ASSERT_RTX_PTR_EQ(EXPECTED, ACTUAL)                                                        \
        ...
        ::selftest::assert_rtx_ptr_eq_at(SELFTEST_LOCATION, desc_, (EXPECTED), (ACTUAL));          \
        SELFTEST_END_STMT
...
extern void assert_rtx_ptr_eq_at(const location &loc, const char *msg, rtx expected, rtx actual);
