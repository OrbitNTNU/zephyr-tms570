...
extern bool hook_bool_insn_uint_mode_false(rtx_insn *, unsigned int, machine_mode);
...
extern bool hook_bool_const_tree_hwi_hwi_const_tree_false(const_tree, HOST_WIDE_INT, HOST_WIDE_INT,
                                                          const_tree);
extern bool hook_bool_const_tree_hwi_hwi_const_tree_true(const_tree, HOST_WIDE_INT, HOST_WIDE_INT,
                                                         const_tree);
...
extern bool hook_bool_mode_mode_reg_class_t_true(machine_mode, machine_mode, reg_class_t);
extern bool hook_bool_mode_reg_class_t_reg_class_t_false(machine_mode, reg_class_t, reg_class_t);
extern bool hook_bool_rtx_mode_int_int_intp_bool_false(rtx, machine_mode, int, int, int *, bool);
extern bool hook_bool_tree_tree_false(tree, tree);
extern bool hook_bool_tree_tree_true(tree, tree);
extern bool hook_bool_tree_bool_false(tree, bool);
extern bool hook_bool_wint_wint_uint_bool_true(const widest_int &, const widest_int &, unsigned int,
                                               bool);
...
extern void hook_void_FILEptr_constcharptr_const_tree(FILE *, const char *, const_tree);
...
extern int hook_int_rtx_mode_as_bool_0(rtx, machine_mode, addr_space_t, bool);
...
extern bool default_can_output_mi_thunk_no_vcall(const_tree, HOST_WIDE_INT, HOST_WIDE_INT,
                                                 const_tree);
...
extern opt_machine_mode hook_optmode_mode_uhwi_none(machine_mode, unsigned HOST_WIDE_INT);
#endif
