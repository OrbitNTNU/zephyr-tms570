...
#define NUM_MODE_PARTIAL_INT                                                                       \
        (MIN_MODE_PARTIAL_INT == E_VOIDmode ? 0 : MAX_MODE_PARTIAL_INT - MIN_MODE_PARTIAL_INT + 1)
#define NUM_MODE_VECTOR_INT                                                                        \
        (MIN_MODE_VECTOR_INT == E_VOIDmode ? 0 : MAX_MODE_VECTOR_INT - MIN_MODE_VECTOR_INT + 1)
...
static inline struct alg_hash_entry *alg_hash_entry_ptr(int idx)
{
...
static inline bool alg_hash_used_p(void)
{
...
static inline void set_alg_hash_used_p(bool usedp)
{
...
static inline int expmed_mode_index(machine_mode mode)
{
...
static inline bool *expmed_op_cheap_ptr(struct expmed_op_cheap *eoc, bool speed, machine_mode mode)
{
...
static inline int *expmed_op_cost_ptr(struct expmed_op_costs *costs, bool speed, machine_mode mode)
{
        int idx = expmed_mode_index(mode);
...
static inline bool *sdiv_pow2_cheap_ptr(bool speed, machine_mode mode)
{
        return expmed_op_cheap_ptr(&this_target_expmed->x_sdiv_pow2_cheap, speed, mode);
}

/* Set whether a signed division by a power of 2 is cheap in MODE
   when optimizing for SPEED.  */

static inline void set_sdiv_pow2_cheap(bool speed, machine_mode mode, bool cheap_p)
{
...
static inline bool sdiv_pow2_cheap(bool speed, machine_mode mode)
{
...
static inline bool *smod_pow2_cheap_ptr(bool speed, machine_mode mode)
{
        return expmed_op_cheap_ptr(&this_target_expmed->x_smod_pow2_cheap, speed, mode);
}

/* Set whether a signed modulo by a power of 2 is CHEAP in MODE when
   optimizing for SPEED.  */

static inline void set_smod_pow2_cheap(bool speed, machine_mode mode, bool cheap)
{
...
static inline bool smod_pow2_cheap(bool speed, machine_mode mode)
{
...
static inline int *zero_cost_ptr(bool speed)
{
...
static inline void set_zero_cost(bool speed, int cost)
{
...
static inline int zero_cost(bool speed)
{
...
static inline int *add_cost_ptr(bool speed, machine_mode mode)
{
...
static inline void set_add_cost(bool speed, machine_mode mode, int cost)
{
...
static inline int add_cost(bool speed, machine_mode mode)
{
...
static inline int *neg_cost_ptr(bool speed, machine_mode mode)
{
...
static inline void set_neg_cost(bool speed, machine_mode mode, int cost)
{
...
static inline int neg_cost(bool speed, machine_mode mode)
{
...
static inline int *shift_cost_ptr(bool speed, machine_mode mode, int bits)
{
        return expmed_op_cost_ptr(&this_target_expmed->x_shift_cost[bits], speed, mode);
}

/* Set the COST of doing a shift in MODE by BITS when optimizing for SPEED.  */

static inline void set_shift_cost(bool speed, machine_mode mode, int bits, int cost)
{
...
static inline int shift_cost(bool speed, machine_mode mode, int bits)
{
...
static inline int *shiftadd_cost_ptr(bool speed, machine_mode mode, int bits)
{
        return expmed_op_cost_ptr(&this_target_expmed->x_shiftadd_cost[bits], speed, mode);
}

/* Set the COST of doing a shift in MODE by BITS followed by an add when
   optimizing for SPEED.  */

static inline void set_shiftadd_cost(bool speed, machine_mode mode, int bits, int cost)
{
...
static inline int shiftadd_cost(bool speed, machine_mode mode, int bits)
{
...
static inline int *shiftsub0_cost_ptr(bool speed, machine_mode mode, int bits)
{
        return expmed_op_cost_ptr(&this_target_expmed->x_shiftsub0_cost[bits], speed, mode);
}

/* Set the COST of doing a shift in MODE by BITS and then subtracting a
   value when optimizing for SPEED.  */

static inline void set_shiftsub0_cost(bool speed, machine_mode mode, int bits, int cost)
{
...
static inline int shiftsub0_cost(bool speed, machine_mode mode, int bits)
{
...
static inline int *shiftsub1_cost_ptr(bool speed, machine_mode mode, int bits)
{
        return expmed_op_cost_ptr(&this_target_expmed->x_shiftsub1_cost[bits], speed, mode);
}

/* Set the COST of subtracting a shift in MODE by BITS from a value when
   optimizing for SPEED.  */

static inline void set_shiftsub1_cost(bool speed, machine_mode mode, int bits, int cost)
{
...
static inline int shiftsub1_cost(bool speed, machine_mode mode, int bits)
{
...
static inline int *mul_cost_ptr(bool speed, machine_mode mode)
{
...
static inline void set_mul_cost(bool speed, machine_mode mode, int cost)
{
...
static inline int mul_cost(bool speed, machine_mode mode)
{
...
static inline int *sdiv_cost_ptr(bool speed, machine_mode mode)
{
...
static inline void set_sdiv_cost(bool speed, machine_mode mode, int cost)
{
...
static inline int sdiv_cost(bool speed, machine_mode mode)
{
...
static inline int *udiv_cost_ptr(bool speed, machine_mode mode)
{
...
static inline void set_udiv_cost(bool speed, machine_mode mode, int cost)
{
...
static inline int udiv_cost(bool speed, machine_mode mode)
{
...
static inline int *mul_widen_cost_ptr(bool speed, machine_mode mode)
{
...
static inline void set_mul_widen_cost(bool speed, machine_mode mode, int cost)
{
...
static inline int mul_widen_cost(bool speed, machine_mode mode)
{
...
static inline int *mul_highpart_cost_ptr(bool speed, machine_mode mode)
{
        gcc_assert(GET_MODE_CLASS(mode) == MODE_INT);
...
static inline void set_mul_highpart_cost(bool speed, machine_mode mode, int cost)
{
...
static inline int mul_highpart_cost(bool speed, machine_mode mode)
{
...
static inline int *convert_cost_ptr(machine_mode to_mode, machine_mode from_mode, bool speed)
{
...
static inline void set_convert_cost(machine_mode to_mode, machine_mode from_mode, bool speed,
                                    int cost)
{
...
static inline int convert_cost(machine_mode to_mode, machine_mode from_mode, bool speed)
{
        return *convert_cost_ptr(to_mode, from_mode, speed);
}

extern int mult_by_coeff_cost(HOST_WIDE_INT, machine_mode, bool);
extern rtx emit_cstore(rtx target, enum insn_code icode, enum rtx_code code, machine_mode mode,
                       machine_mode compare_mode, int unsignedp, rtx x, rtx y, int normalizep,
...
extern rtx emit_store_flag(rtx, enum rtx_code, rtx, rtx, machine_mode, int, int);

/* Like emit_store_flag, but always succeeds.  */
extern rtx emit_store_flag_force(rtx, enum rtx_code, rtx, rtx, machine_mode, int, int);
...
extern unsigned HOST_WIDE_INT choose_multiplier(unsigned HOST_WIDE_INT, int, int,
                                                unsigned HOST_WIDE_INT *, int *, int *);

#ifdef TREE_CODE
extern rtx expand_variable_shift(enum tree_code, machine_mode, rtx, tree, rtx, int);
extern rtx expand_shift(enum tree_code, machine_mode, rtx, poly_int64, rtx, int);
extern rtx expand_divmod(int, enum tree_code, machine_mode, rtx, rtx, rtx, int);
#endif

extern void store_bit_field(rtx, poly_uint64, poly_uint64, poly_uint64, poly_uint64, machine_mode,
                            rtx, bool);
extern rtx extract_bit_field(rtx, poly_uint64, poly_uint64, int, rtx, machine_mode, machine_mode,
                             bool, rtx *);
extern rtx extract_low_bits(machine_mode, machine_mode, rtx);
extern rtx expand_mult(machine_mode, rtx, rtx, rtx, int, bool = false);
extern rtx expand_mult_highpart_adjust(scalar_int_mode, rtx, rtx, rtx, rtx, int);
