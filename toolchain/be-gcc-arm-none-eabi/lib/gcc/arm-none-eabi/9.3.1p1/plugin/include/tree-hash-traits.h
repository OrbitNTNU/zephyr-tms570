...
inline bool tree_operand_hash::equal(const value_type &t1, const compare_type &t2)
{
...
inline hashval_t tree_decl_hash::hash(tree t)
{
        return DECL_UID(t);
}
...
inline hashval_t tree_ssa_name_hash::hash(tree t)
{
...
inline hashval_t tree_hash::hash(tree t)
{
        return TREE_HASH(t);
}
