...
static inline _Unwind_Word _Unwind_decode_typeinfo_ptr(_Unwind_Word base __attribute__((unused)),
                                                       _Unwind_Word ptr)
{
        _Unwind_Word tmp;
...
static inline _Unwind_Reason_Code __gnu_unwind_24bit(_Unwind_Context *context
