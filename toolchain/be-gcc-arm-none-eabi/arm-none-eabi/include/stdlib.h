...
__malloc_like __result_use_check __alloc_size2(1, 2) _NOTHROW;
...
void *malloc(size_t)
__malloc_like __result_use_check __alloc_size(1) _NOTHROW;
...
__result_use_check __alloc_size2(2, 3);
...
unsigned long _strtoul_r(struct _reent *, const char *__restrict __n, char **__restrict __end_PTR,
                         int __base);
...
#endif
long long _strtoll_r(struct _reent *, const char *__restrict __n, char **__restrict __end_PTR,
                     int __base);
#if __ISO_C_VISIBLE >= 1999
...
int posix_memalign(void **, size_t, size_t) __nonnull((1)) __result_use_check;
#endif
