...
int pthread_mutex_getprioceiling(const pthread_mutex_t *__restrict __mutex, int *__prioceiling);
...
int pthread_setaffinity_np(pthread_t __id, size_t __cpusetsize, const cpu_set_t *__cpuset);
int pthread_getaffinity_np(const pthread_t __id, size_t __cpusetsize, cpu_set_t *__cpuset);
...
void _pthread_cleanup_push(struct _pthread_cleanup_context *_context, void (*_routine)(void *),
                           void *_arg);
...
void _pthread_cleanup_pop_restore(struct _pthread_cleanup_context *_context, int _execute);
...
int pthread_barrier_init(pthread_barrier_t *__barrier, const pthread_barrierattr_t *__attr,
                         unsigned __count);
