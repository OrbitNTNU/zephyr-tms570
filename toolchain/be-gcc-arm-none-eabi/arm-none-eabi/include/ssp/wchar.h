...
#define __ssp_bos_wicheck3(fun)                                                                    \
        __ssp_redirect_wc(wchar_t *, fun, (wchar_t * __buf, const wchar_t *__src, size_t __wlen),  \
...
#endif
        __ssp_bos_wicheck2_restrict(wcscpy) __ssp_bos_wicheck2_restrict(
                wcscat) __ssp_bos_wicheck3_restrict(wcsncpy) __ssp_bos_wicheck3_restrict(wcsncat)
...
__ssp_redirect_wc(size_t, mbsrtowcs,
        ...
        __ssp_redirect_raw(size_t, wcsrtombs,
                ...
                __ssp_redirect_wc(size_t, mbsnrtowcs,
                                  (wchar_t * __buf, const char **__src, size_t __nms, size_t __wlen,
                                   mbstate_t *__ps),
