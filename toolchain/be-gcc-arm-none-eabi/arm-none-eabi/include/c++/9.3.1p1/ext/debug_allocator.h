 ...
 */
template <typename _Alloc> class debug_allocator
{
      ...
      public:
        ...
        template <typename _Up> class rebind
        {
      ...
      private:
        ...
        template <typename _Alloc2, typename = typename _Alloc2::template rebind<value_type>::other>
        struct __convertible {
        };

        template <typename _Alloc2> struct __convertible<_Alloc2, _Alloc> {
                typedef void *__type;
        };
