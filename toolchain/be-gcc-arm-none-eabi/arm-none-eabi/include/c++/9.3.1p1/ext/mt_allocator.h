...
struct __pool_base {
        ...
        struct _Tune {
                ...
                explicit _Tune(size_t __align, size_t __maxb, size_t __minbin, size_t __chunk,
        ...
        explicit __pool_base() : _M_options(_Tune()), _M_binmap(0), _M_init(false)
        {
        }
...
template <> class __pool<false> : public __pool_base
{
      public:
        union _Block_record {
...
template <> class __pool<true> : public __pool_base
{
      public:
        ...
        explicit __pool(const __pool_base::_Tune &__tune)
                : __pool_base(__tune), _M_bin(0), _M_bin_size(1), _M_thread_freelist(0)
        {
        }
...
template <template <bool> class _PoolTp, bool _Thread> struct __common_pool {
...
template <template <bool> class _PoolTp, bool _Thread> struct __common_pool_base;

template <template <bool> class _PoolTp>
struct __common_pool_base<_PoolTp, false> : public __common_pool<_PoolTp, false> {
...
#ifdef __GTHREADS
template <template <bool> class _PoolTp>
struct __common_pool_base<_PoolTp, true> : public __common_pool<_PoolTp, true> {
...
template <typename _Tp, template <bool> class _PoolTp, bool _Thread> struct __per_type_pool {
...
template <typename _Tp, template <bool> class _PoolTp, bool _Thread> struct __per_type_pool_base;

template <typename _Tp, template <bool> class _PoolTp>
struct __per_type_pool_base<_Tp, _PoolTp, false> : public __per_type_pool<_Tp, _PoolTp, false> {
...
#ifdef __GTHREADS
template <typename _Tp, template <bool> class _PoolTp>
struct __per_type_pool_base<_Tp, _PoolTp, true> : public __per_type_pool<_Tp, _PoolTp, true> {
...
struct __per_type_pool_policy : public __per_type_pool_base<_Tp, _PoolTp, _Thread> {
        template <typename _Tp1, template <bool> class _PoolTp1 = _PoolTp, bool _Thread1 = _Thread>
        struct _M_rebind {
...
template <typename _Tp, typename _Poolp>
inline bool operator==(const __mt_alloc<_Tp, _Poolp> &, const __mt_alloc<_Tp, _Poolp> &)
{
        return true;
}
