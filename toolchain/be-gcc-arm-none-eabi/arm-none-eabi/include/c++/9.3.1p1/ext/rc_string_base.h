...
class __rc_string_base : protected __vstring_utility<_CharT, _Traits, _Alloc>
{
      public:
      ...
      private:
        ...
        enum {
                _S_max_size =
                        (((static_cast<size_type>(-1) - 2 * sizeof(_Rep) + 1) / sizeof(_CharT)) -
                         1) /
                        2
        };
        ...
        void _M_dispose()
        {
                ...
                if (__exchange_and_add_dispatch(&_M_rep()->_M_info._M_refcount, -1) <= 0) {
      ...
      public:
        ...
        __rc_string_base(__rc_string_base &&__rcs) : _M_dataplus(__rcs._M_dataplus)
        {
...
__rc_string_base<_CharT, _Traits, _Alloc>::_Rep::_S_create(size_type __capacity,
                                                           ...
                                                           const _Alloc &__alloc)
{
        ...
        size_type __size = ((__capacity + 1) * sizeof(_CharT) + 2 * sizeof(_Rep) - 1);
...
template <typename _CharT, typename _Traits, typename _Alloc>
void __rc_string_base<_CharT, _Traits, _Alloc>::_Rep::_M_destroy(const _Alloc &__a) throw()
{
...
template <typename _CharT, typename _Traits, typename _Alloc>
_CharT *__rc_string_base<_CharT, _Traits, _Alloc>::_Rep::_M_clone(const _Alloc &__alloc,
                                                                  size_type __res)
{
...
template <typename _CharT, typename _Traits, typename _Alloc>
__rc_string_base<_CharT, _Traits, _Alloc>::__rc_string_base(const __rc_string_base &__rcs)
        : _M_dataplus(__rcs._M_get_allocator(), __rcs._M_grab(__rcs._M_get_allocator()))
{
}

template <typename _CharT, typename _Traits, typename _Alloc>
__rc_string_base<_CharT, _Traits, _Alloc>::__rc_string_base(size_type __n, _CharT __c,
                                                            const _Alloc &__a)
...
template <typename _CharT, typename _Traits, typename _Alloc>
template <typename _InputIterator>
__rc_string_base<_CharT, _Traits, _Alloc>::__rc_string_base(_InputIterator __beg,
...
template <typename _InIterator>
_CharT *
__rc_string_base<_CharT, _Traits, _Alloc>::_S_construct(_InIterator __beg, _InIterator __end,
...
template <typename _CharT, typename _Traits, typename _Alloc>
_CharT *__rc_string_base<_CharT, _Traits, _Alloc>::_S_construct(size_type __n, _CharT __c,
                                                                const _Alloc &__a)
{
        if (__n == 0 && __a == _Alloc()) {
                return _S_empty_rep._M_refcopy();
...
template <typename _CharT, typename _Traits, typename _Alloc>
void __rc_string_base<_CharT, _Traits, _Alloc>::_M_swap(__rc_string_base &__rcs)
{
        if (_M_is_leaked()) {
                _M_set_sharable();
        }
        ...
        std::__alloc_swap<allocator_type>::_S_do_it(_M_get_allocator(), __rcs._M_get_allocator());
}

template <typename _CharT, typename _Traits, typename _Alloc>
void __rc_string_base<_CharT, _Traits, _Alloc>::_M_assign(const __rc_string_base &__rcs)
{
...
template <typename _CharT, typename _Traits, typename _Alloc>
void __rc_string_base<_CharT, _Traits, _Alloc>::_M_mutate(size_type __pos, size_type __len1,
                                                          const _CharT *__s, size_type __len2)
{
        const size_type __how_much = _M_length() - __pos - __len1;

        _Rep *__r =
                _Rep::_S_create(_M_length() + __len2 - __len1, _M_capacity(), _M_get_allocator());
        ...
        if (__how_much) {
                this->_S_copy(__r->_M_refdata() + __pos + __len2, _M_data() + __pos + __len1,
                              __how_much);
        }
...
template <typename _CharT, typename _Traits, typename _Alloc>
void __rc_string_base<_CharT, _Traits, _Alloc>::_M_erase(size_type __pos, size_type __n)
{
        ...
        if (_M_is_shared()) {
                // Must reallocate.
                _Rep *__r = _Rep::_S_create(__new_size, _M_capacity(), _M_get_allocator());
...
template <>
inline bool __rc_string_base<char, std::char_traits<char>, std::allocator<char>>::_M_compare(
...
template <>
inline bool
__rc_string_base<wchar_t, std::char_traits<wchar_t>, std::allocator<wchar_t>>::_M_compare(
        const __rc_string_base &__rcs) const
{
        if (_M_rep() == __rcs._M_rep()) {
                return true;
