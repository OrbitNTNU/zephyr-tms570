...
template <typename Typelist, template <typename T> class Transform> struct transform;
...
template <typename T1, typename T2, typename T3, typename T4, typename T5> struct create5;
...
template <typename Fn, typename Hd, typename Tl> struct apply_<Fn, chain<Hd, Tl>> {
        void operator()(Fn &f)
        {
                f.operator()(Hd());
                apply_<Fn, Tl> next;
...
template <typename Gn, typename Hd, typename Tl> struct apply_generator1_<Gn, chain<Hd, Tl>> {
        void operator()(Gn &g)
        {
...
template <typename Gn, typename TypelistT_Chain, typename TypelistV_Chain> struct apply_generator2_;
...
template <typename Hd, typename Tl> struct append_<chain<Hd, Tl>, null_type> {
...
template <typename Hd, typename Tl, typename T> struct contains_<chain<Hd, Tl>, T> {
        enum {
                value = contains_ < Tl,
                T > ::value
        };
...
template <typename Typelist_Chain, template <typename T> class Pred> struct chain_filter_;

template <template <typename T> class Pred> struct chain_filter_<null_type, Pred> {
        typedef null_type type;
};
...
template <typename Hd, typename Tl, int i> struct chain_at_index_<chain<Hd, Tl>, i> {
        typedef typename chain_at_index_<Tl, i - 1>::type type;
};

template <class Typelist_Chain, template <typename T> class Transform> struct chain_transform_;

template <template <typename T> class Transform> struct chain_transform_<null_type, Transform> {
        typedef null_type type;
};
...
#define _GLIBCXX_TYPELIST_CHAIN11(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10)                     \
        __gnu_cxx::typelist::chain<X0, _GLIBCXX_TYPELIST_CHAIN10(X1, X2, X3, X4, X5, X6, X7, X8,   \
                                                                 X9, X10)>
#define _GLIBCXX_TYPELIST_CHAIN12(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11)                \
        __gnu_cxx::typelist::chain<X0, _GLIBCXX_TYPELIST_CHAIN11(X1, X2, X3, X4, X5, X6, X7, X8,   \
                                                                 X9, X10, X11)>
#define _GLIBCXX_TYPELIST_CHAIN13(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12)           \
        __gnu_cxx::typelist::chain<X0, _GLIBCXX_TYPELIST_CHAIN12(X1, X2, X3, X4, X5, X6, X7, X8,   \
                                                                 X9, X10, X11, X12)>
#define _GLIBCXX_TYPELIST_CHAIN14(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13)      \
        __gnu_cxx::typelist::chain<X0, _GLIBCXX_TYPELIST_CHAIN13(X1, X2, X3, X4, X5, X6, X7, X8,   \
                                                                 X9, X10, X11, X12, X13)>
#define _GLIBCXX_TYPELIST_CHAIN15(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14) \
        __gnu_cxx::typelist::chain<X0, _GLIBCXX_TYPELIST_CHAIN14(X1, X2, X3, X4, X5, X6, X7, X8,   \
                                                                 X9, X10, X11, X12, X13, X14)>
#define _GLIBCXX_TYPELIST_CHAIN16(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, \
                                  X15)                                                             \
        __gnu_cxx::typelist::chain<X0,                                                             \
                                   _GLIBCXX_TYPELIST_CHAIN15(X1, X2, X3, X4, X5, X6, X7, X8, X9,   \
                                                             X10, X11, X12, X13, X14, X15)>
#define _GLIBCXX_TYPELIST_CHAIN17(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, \
                                  X15, X16)                                                        \
        __gnu_cxx::typelist::chain<X0,                                                             \
                                   _GLIBCXX_TYPELIST_CHAIN16(X1, X2, X3, X4, X5, X6, X7, X8, X9,   \
                                                             X10, X11, X12, X13, X14, X15, X16)>
#define _GLIBCXX_TYPELIST_CHAIN18(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, \
                                  X15, X16, X17)                                                   \
        __gnu_cxx::typelist::chain<X0, _GLIBCXX_TYPELIST_CHAIN17(X1, X2, X3, X4, X5, X6, X7, X8,   \
                                                                 X9, X10, X11, X12, X13, X14, X15, \
                                                                 X16, X17)>
#define _GLIBCXX_TYPELIST_CHAIN19(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, \
                                  X15, X16, X17, X18)                                              \
        __gnu_cxx::typelist::chain<X0, _GLIBCXX_TYPELIST_CHAIN18(X1, X2, X3, X4, X5, X6, X7, X8,   \
                                                                 X9, X10, X11, X12, X13, X14, X15, \
                                                                 X16, X17, X18)>
#define _GLIBCXX_TYPELIST_CHAIN20(X0, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X14, \
                                  X15, X16, X17, X18, X19)                                         \
        __gnu_cxx::typelist::chain<X0, _GLIBCXX_TYPELIST_CHAIN19(X1, X2, X3, X4, X5, X6, X7, X8,   \
                                                                 X9, X10, X11, X12, X13, X14, X15, \
                                                                 X16, X17, X18, X19)>

template <typename Fn, typename Typelist> void apply(Fn &fn, Typelist)
{
...
template <typename Typelist, typename T> struct contains {
      ...
      public:
        enum {
                value = detail::contains_ < root_type,
                T > ::value
        };
};
