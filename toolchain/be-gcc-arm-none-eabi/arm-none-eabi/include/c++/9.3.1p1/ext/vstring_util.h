...
template <typename _CharT, typename _Traits, typename _Alloc> struct __vstring_utility {
        ...
        typedef __gnu_cxx::__normal_iterator<
                pointer, __gnu_cxx::__versa_string<_CharT, _Traits, _Alloc, __sso_string_base>>
                __sso_iterator;
        typedef __gnu_cxx::__normal_iterator<
                const_pointer,
        ...
        // For __rc_string.
        typedef __gnu_cxx::__normal_iterator<
                pointer, __gnu_cxx::__versa_string<_CharT, _Traits, _Alloc, __rc_string_base>>
                __rc_iterator;
        typedef __gnu_cxx::__normal_iterator<
                const_pointer, __gnu_cxx::__versa_string<_CharT, _Traits, _Alloc, __rc_string_base>>
                __const_rc_iterator;
        ...
        template <typename _Alloc1> struct _Alloc_hider : public _Alloc1 {
                ...
                _Alloc_hider(const _Alloc1 &__a, _CharT *__ptr) : _Alloc1(__a), _M_p(__ptr)
                {
                }
