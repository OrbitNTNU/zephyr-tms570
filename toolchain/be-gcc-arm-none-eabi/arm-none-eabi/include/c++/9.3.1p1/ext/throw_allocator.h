...
struct annotate_base {
      ...
      public:
        ...
        void insert(void *p, size_t size)
        {
                ...
                std::pair<map_alloc_type::iterator, bool> inserted = map_alloc().insert(entry);
                if (!inserted.second) {
 ...
 */
template <typename _Cond> struct throw_value_base : public _Cond {
...
inline void swap(throw_value_base<_Cond> &__a, throw_value_base<_Cond> &__b)
{
...
template <typename _Cond>
inline bool operator==(const throw_value_base<_Cond> &__a, const throw_value_base<_Cond> &__b)
{
        typedef throw_value_base<_Cond> throw_value;
        throw_value::throw_conditionally();
...
struct throw_allocator_limit : public throw_allocator_base<_Tp, limit_condition> {
