 ...
 */
template <typename _Type> class _Not_equal_to
{
        _Type __value;
...
template <typename _Type> class _Equal_to
{
        _Type __value;
...
template <typename _Iterator> class _After_nth_from
{
 ...
 */
template <typename _Sequence> class _Safe_sequence : public _Safe_sequence_base
{
      public:
...
template <typename _Sequence> class _Safe_node_sequence : public _Safe_sequence<_Sequence>
{
      protected:
