...
#define _GLIBCXX_DEBUG_VERIFY(_Cond, _ErrMsg)                                                      \
        _GLIBCXX_DEBUG_VERIFY_AT_F(_Cond, _ErrMsg, __FILE__, __LINE__, __PRETTY_FUNCTION__)
...
#define __glibcxx_check_valid_constructor_range(_First, _Last)                                     \
        __gnu_debug::__check_valid_range(_First, _Last, __FILE__, __LINE__, __PRETTY_FUNCTION__)

// Verify that [_First, _Last) forms a non-empty iterator range.
#define __glibcxx_check_non_empty_range(_First, _Last)                                             \
        _GLIBCXX_DEBUG_VERIFY(_First != _Last, _M_message(__gnu_debug::__msg_non_empty_range)      \
                                                       ._M_iterator(_First, #_First)               \
                                                       ._M_iterator(_Last, #_Last))
...
#define __glibcxx_check_can_increment_range(_First1, _Last1, _First2)                              \
        do {                                                                                       \
                ...
                _GLIBCXX_DEBUG_VERIFY_COND_AT(__gnu_debug::__valid_range(_First1, _Last1, __dist), \
                                              _M_message(__gnu_debug::__msg_valid_range)           \
                                                      ._M_iterator(_First1, #_First1)              \
                                                      ._M_iterator(_Last1, #_Last1),               \
                                              __FILE__, __LINE__, __PRETTY_FUNCTION__);            \
                _GLIBCXX_DEBUG_VERIFY_COND_AT(__gnu_debug::__can_advance(_First2, __dist.first),   \
                                              _M_message(__gnu_debug::__msg_iter_subscript_oob)    \
...
#define __glibcxx_check_erase_range_after(_First, _Last)                                           \
        ...
        _GLIBCXX_DEBUG_VERIFY(_First._M_attached_to(this),                                         \
                              _M_message(__gnu_debug::__msg_erase_different)                       \
                                      ._M_sequence(*this, "this")                                  \
                                      ._M_iterator(_First, #_First));                              \
        _GLIBCXX_DEBUG_VERIFY(_First != _Last, _M_message(__gnu_debug::__msg_valid_range2)         \
                                                       ._M_sequence(*this, "this")                 \
                                                       ._M_iterator(_First, #_First)               \
                                                       ._M_iterator(_Last, #_Last));               \
...
#define __glibcxx_check_subscript(_N)                                                              \
        _GLIBCXX_DEBUG_VERIFY(_N < this->size(), _M_message(__gnu_debug::__msg_subscript_oob)      \
                                                         ._M_sequence(*this, "this")               \
                                                         ._M_integer(_N, #_N)                      \
...
#define __glibcxx_check_heap_pred(_First, _Last, _Pred)                                            \
        _GLIBCXX_DEBUG_VERIFY(                                                                     \
                std::__is_heap(__gnu_debug::__base(_First), __gnu_debug::__base(_Last), _Pred),    \
...
#define __glibcxx_check_self_move_assign(_Other)                                                   \
        _GLIBCXX_DEBUG_VERIFY(                                                                     \
                this != &_Other,                                                                   \
                _M_message(__gnu_debug::__msg_self_move_assign)._M_sequence(*this, "this"))

// Verify that load factor is positive
#define __glibcxx_check_max_load_factor(_F)                                                        \
        _GLIBCXX_DEBUG_VERIFY(                                                                     \
                _F > 0.0f,                                                                         \
                _M_message(__gnu_debug::__msg_valid_load_factor)._M_sequence(*this, "this"))
...
#define __glibcxx_check_irreflexive2(_First, _Last)                                                \
        _GLIBCXX_DEBUG_VERIFY(_First == _Last || __gnu_debug::__is_irreflexive(_First),            \
                              _M_message(__gnu_debug::__msg_irreflexive_ordering)                  \
                                      ._M_iterator_value_type(_First, "< operator type"))
#else
#define __glibcxx_check_irreflexive2(_First, _Last)
