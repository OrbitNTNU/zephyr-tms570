...
#define _GLIBCXX_DEBUG_VERIFY_OPERANDS(_Lhs, _Rhs)                                                 \
        ...
        _GLIBCXX_DEBUG_VERIFY(_Lhs._M_can_compare(_Rhs), _M_message(__msg_compare_different)       \
                                                                 ._M_iterator(_Lhs, "lhs")         \
                                                                 ._M_iterator(_Rhs, "rhs"));       \
...
class _Safe_local_iterator : private _Iterator, public _Safe_local_iterator_base
{
        ...
        typedef std::__are_same<typename _Sequence::_Base::const_local_iterator, _Iterator>
                _IsConstant;
        ...
        _Safe_local_iterator(_Iterator __i, _Safe_sequence_base *__cont, _Attach_single) noexcept
                : _Iter_base(__i)
        {
      ...
      public:
         ...
         */
        _Safe_local_iterator(const _Safe_local_iterator &__x) noexcept : _Iter_base(__x.base())
        {
        ...
        bool _M_valid_range(const _Safe_local_iterator &__rhs,
        ...
        friend inline bool operator==(const _Self &__lhs, const _OtherSelf &__rhs) noexcept
        {
                _GLIBCXX_DEBUG_VERIFY_OPERANDS(__lhs, __rhs);
                return __lhs.base() == __rhs.base();
        }

        friend inline bool operator==(const _Self &__lhs, const _Self &__rhs) noexcept
        {
                _GLIBCXX_DEBUG_VERIFY_OPERANDS(__lhs, __rhs);
                return __lhs.base() == __rhs.base();
        }
...
template <typename _Iterator, typename _Sequence>
inline _Iterator __unsafe(const _Safe_local_iterator<_Iterator, _Sequence> &__it)
{
        return __it.base();
}
