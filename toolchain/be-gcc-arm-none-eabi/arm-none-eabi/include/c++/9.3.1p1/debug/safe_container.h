...
template <typename _SafeContainer, typename _Alloc, template <typename> class _SafeBase,
...
class _Safe_container : public _SafeBase<_SafeContainer>
{
      ...
      protected:
        ...
        _Safe_container(_Safe_container &&__x, const _Alloc &__a) : _Safe_container()
        {
