...
class map : public __gnu_debug::_Safe_container<map<_Key, _Tp, _Compare, _Allocator>, _Allocator,
                                                __gnu_debug::_Safe_node_sequence>,
            public _GLIBCXX_STD_C::map<_Key, _Tp, _Compare, _Allocator>
{
        typedef _GLIBCXX_STD_C::map<_Key, _Tp, _Compare, _Allocator> _Base;
        typedef __gnu_debug::_Safe_container<map, _Allocator, __gnu_debug::_Safe_node_sequence>
                _Safe;
      ...
      public:
        ...
        map(initializer_list<value_type> __l, const allocator_type &__a) : _Base(__l, __a)
        {
        }
        ...
        template <typename _InputIterator>
        map(_InputIterator __first, _InputIterator __last, const _Compare &__comp = _Compare(),
        ...
        std::pair<iterator, bool> insert(const value_type &__x)
        {
                ...
                return std::pair<iterator, bool>(iterator(__res.first, this), __res.second);
        }
        ...
        template <typename _Pair, typename = typename std::enable_if<
        ...
        {
                auto __res = _Base::try_emplace(std::move(__k), std::forward<_Args>(__args)...);
                return {{__res.first, this}, __res.second};
        }
        ...
        iterator try_emplace(const_iterator __hint, const key_type &__k, _Args &&...__args)
        {
                ...
                return {_Base::try_emplace(__hint.base(), __k, std::forward<_Args>(__args)...),
                        this};
        }
        ...
        {
                auto __res = _Base::insert_or_assign(std::move(__k), std::forward<_Obj>(__obj));
                return {{__res.first, this}, __res.second};
        }
        ...
        {
                __glibcxx_check_insert(__hint);
                return {_Base::insert_or_assign(__hint.base(), __k, std::forward<_Obj>(__obj)),
                        this};
        }
        ...
        void swap(map &__x) _GLIBCXX_NOEXCEPT_IF(noexcept(declval<_Base &>().swap(__x)))
        {
                _Safe::_M_swap(__x);
                _Base::swap(__x);
        }
