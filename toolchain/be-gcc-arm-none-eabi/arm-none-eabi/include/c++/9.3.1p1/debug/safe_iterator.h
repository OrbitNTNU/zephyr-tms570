...
#define _GLIBCXX_DEBUG_VERIFY_OPERANDS(_Lhs, _Rhs, _BadMsgId, _DiffMsgId)                          \
        _GLIBCXX_DEBUG_VERIFY(                                                                     \
                !_Lhs._M_singular() && !_Rhs._M_singular(),                                        \
                _M_message(_BadMsgId)._M_iterator(_Lhs, #_Lhs)._M_iterator(_Rhs, #_Rhs));          \
        _GLIBCXX_DEBUG_VERIFY(                                                                     \
                _Lhs._M_can_compare(_Rhs),                                                         \
                _M_message(_DiffMsgId)._M_iterator(_Lhs, #_Lhs)._M_iterator(_Rhs, #_Rhs))

#define _GLIBCXX_DEBUG_VERIFY_EQ_OPERANDS(_Lhs, _Rhs)                                              \
        _GLIBCXX_DEBUG_VERIFY_OPERANDS(_Lhs, _Rhs, __msg_iter_compare_bad, __msg_compare_different)

#define _GLIBCXX_DEBUG_VERIFY_REL_OPERANDS(_Lhs, _Rhs)                                             \
        _GLIBCXX_DEBUG_VERIFY_OPERANDS(_Lhs, _Rhs, __msg_iter_order_bad, __msg_order_different)

#define _GLIBCXX_DEBUG_VERIFY_DIST_OPERANDS(_Lhs, _Rhs)                                            \
        _GLIBCXX_DEBUG_VERIFY_OPERANDS(_Lhs, _Rhs, __msg_distance_bad, __msg_distance_different)
 ...
 *  iterator.
 **/
template <typename _Sequence> struct _BeforeBeginHelper {
...
template <typename _Sequence> struct _Sequence_traits {
...
class _Safe_iterator : private _Iterator, public _Safe_iterator_base
{
      ...
      protected:
        ...
        _Safe_iterator(_Iterator __i, _Safe_sequence_base *__seq, _Attach_single) _GLIBCXX_NOEXCEPT
                : _Iter_base(__i)
        {
      ...
      public:
         ...
         */
        _Safe_iterator(_Iterator __i, const _Safe_sequence_base *__seq) _GLIBCXX_NOEXCEPT
                : _Iter_base(__i),
         ...
         */
        _Safe_iterator(const _Safe_iterator &__x) _GLIBCXX_NOEXCEPT : _Iter_base(__x.base())
        {
        ...
        _Safe_iterator(const _Safe_iterator<
                       _MutableIterator, _Sequence,
                       typename __gnu_cxx::__enable_if<
                               _IsConstant::__value &&
                                       std::__are_same<_MutableIterator, _OtherIterator>::__value,
                               _Category>::__type> &__x) _GLIBCXX_NOEXCEPT : _Iter_base(__x.base())
        {
                // _GLIBCXX_RESOLVE_LIB_DEFECTS
                // DR 408. Is vector<reverse_iterator<char*> > forbidden?
                _GLIBCXX_DEBUG_VERIFY(!__x._M_singular() || __x.base() == _MutableIterator(),
        ...
        static _GLIBCXX_CONSTEXPR bool _S_constant()
        {
        ...
        bool _M_can_advance(difference_type __n) const;
        ...
        typename _Distance_traits<_Iterator>::__type _M_get_distance_from_begin() const;
        ...
        friend bool operator==(const _Self &__lhs, const _Self &__rhs) _GLIBCXX_NOEXCEPT
        {
...
{
        typedef _Safe_iterator<_Iterator, _Sequence, std::forward_iterator_tag> _Safe_base;
      ...
      public:
         ...
         * @brief Copy construction.
         */
        _Safe_iterator(const _Safe_iterator &__x) _GLIBCXX_NOEXCEPT : _Safe_base(__x)
        {
        }
...
class _Safe_iterator<_Iterator, _Sequence, std::random_access_iterator_tag>
        : public _Safe_iterator<_Iterator, _Sequence, std::bidirectional_iterator_tag>
{
        typedef _Safe_iterator<_Iterator, _Sequence, std::bidirectional_iterator_tag> _Safe_base;
        typedef typename _Safe_base::_OtherIterator _OtherIterator;

        typedef typename _Safe_base::_Self _Self;
        typedef _Safe_iterator<_OtherIterator, _Sequence, std::random_access_iterator_tag>
                _OtherSelf;
      ...
      public:
        ...
        reference operator[](difference_type __n) const _GLIBCXX_NOEXCEPT
        {
                _GLIBCXX_DEBUG_VERIFY(
                        ...
                        _M_message(__msg_iter_subscript_oob)._M_iterator(*this)._M_integer(__n));
        ...
        friend bool operator<(const _Self &__lhs, const _OtherSelf &__rhs) _GLIBCXX_NOEXCEPT
        {
                _GLIBCXX_DEBUG_VERIFY_REL_OPERANDS(__lhs, __rhs);
                return __lhs.base() < __rhs.base();
        }
        ...
        friend difference_type operator-(const _Self &__lhs, const _Self &__rhs) _GLIBCXX_NOEXCEPT
        {
                _GLIBCXX_DEBUG_VERIFY_DIST_OPERANDS(__lhs, __rhs);
                return __lhs.base() - __rhs.base();
        }

        friend _Self operator+(const _Self &__x, difference_type __n) _GLIBCXX_NOEXCEPT
        {
                _GLIBCXX_DEBUG_VERIFY(
        ...
        friend _Self operator+(difference_type __n, const _Self &__x) _GLIBCXX_NOEXCEPT
        {
                _GLIBCXX_DEBUG_VERIFY(
                        __x._M_can_advance(__n),
                        _M_message(__msg_advance_oob)._M_iterator(__x)._M_integer(__n));
...
inline bool __valid_range(const _Safe_iterator<_Iterator, _Sequence, _Category> &__first,
...
inline bool __can_advance(const _Safe_iterator<_Iterator, _Sequence, _Category> &__it, _Size __n)
{
