...
template <typename _Iterator> bool __check_singular(const _Iterator &);
...
class _Error_formatter
{
      ...
      public:
        ...
        struct _Parameter {
                ...
                template <typename _Iterator, typename _Sequence, typename _Category>
                _Parameter(
                        std::reverse_iterator<_Safe_iterator<_Iterator, _Sequence, _Category>> const
                                &__it,
                        const char *__name, _Is_iterator)
                        : _Parameter(__it.base(), __name, _Is_iterator{})
                {
                ...
                template <typename _Iterator, typename _Sequence, typename _Category>
                _Parameter(std::move_iterator<_Safe_iterator<_Iterator, _Sequence, _Category>> const
                                   &__it,
                           const char *__name, _Is_iterator)
                        : _Parameter(__it.base(), __name, _Is_iterator{})
                {
              ...
              public:
                        ...
                        : _M_kind(__iterator_value_type), _M_variant()
                {
                        ...
                        _M_variant._M_iterator_value_type._M_type = _GLIBCXX_TYPEID(
                ...
                void
                _M_print_description(const _Error_formatter *__formatter) const _GLIBCXX_DEPRECATED;
#endif
        };
        ...
        template <typename _Iterator>
        _Error_formatter &_M_iterator_value_type(const _Iterator &__it, const char *__name = 0)
        {
        ...
        template <typename _Sequence>
        _Error_formatter &_M_sequence(const _Sequence &__seq, const char *__name = 0)
        {
                if (_M_num_parameters < __max_parameters) {
                        _M_parameters[_M_num_parameters++] =
        ...
        void _M_format_word(char *, int, const char *, _Tp) const throw() _GLIBCXX_DEPRECATED;
      ...
      private:
        _Error_formatter(const char *__file, unsigned int __line, const char *__function)
