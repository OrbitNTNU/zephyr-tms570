...
class multimap : public __gnu_debug::_Safe_container<multimap<_Key, _Tp, _Compare, _Allocator>,
                                                     _Allocator, __gnu_debug::_Safe_node_sequence>,
                 public _GLIBCXX_STD_C::multimap<_Key, _Tp, _Compare, _Allocator>
{
        typedef _GLIBCXX_STD_C::multimap<_Key, _Tp, _Compare, _Allocator> _Base;
        typedef __gnu_debug::_Safe_container<multimap, _Allocator, __gnu_debug::_Safe_node_sequence>
                _Safe;
      ...
      public:
        ...
        multimap(const multimap &__m, const allocator_type &__a) : _Base(__m, __a)
        {
        }
        ...
        multimap(initializer_list<value_type> __l, const allocator_type &__a) : _Base(__l, __a)
        {
        }
        ...
        template <typename _InputIterator>
        multimap(_InputIterator __first, _InputIterator __last, const _Compare &__comp = _Compare(),
        ...
        void swap(multimap &__x) _GLIBCXX_NOEXCEPT_IF(noexcept(declval<_Base &>().swap(__x)))
        {
                _Safe::_M_swap(__x);
                _Base::swap(__x);
        }
...
multimap(_InputIterator, _InputIterator, _Compare = _Compare(), _Allocator = _Allocator())
        -> multimap<__iter_key_t<_InputIterator>, __iter_val_t<_InputIterator>, _Compare,
                    _Allocator>;
...
inline bool operator==(const multimap<_Key, _Tp, _Compare, _Allocator> &__lhs,
