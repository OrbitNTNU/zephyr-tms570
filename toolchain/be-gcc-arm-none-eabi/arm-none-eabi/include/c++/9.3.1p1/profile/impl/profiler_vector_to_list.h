      ...
      public:
        __vector2list_info(__stack_t __stack)
                : __object_info_base(__stack), _M_shift_count(0), _M_iterate(0), _M_resize(0),
                  _M_list_cost(0), _M_vector_cost(0)
        {
        }
...
{
      public:
        __vector2list_stack_info(const __vector2list_info &__o) : __vector2list_info(__o)
        {
        }
};

/** @brief Vector-to-list instrumentation producer.  */
class __trace_vector_to_list : public __trace_base<__vector2list_info, __vector2list_stack_info>
{
      public:
        __trace_vector_to_list() : __trace_base<__vector2list_info, __vector2list_stack_info>()
        {
                __id = "vector-to-list";
        }
...
inline void __trace_vector_to_list_free()
{
        delete _GLIBCXX_PROFILE_DATA(_S_vector_to_list);
}

inline void __trace_vector_to_list_report(FILE *__f, __warning_vector_t &__warnings)
{
        __trace_report(_GLIBCXX_PROFILE_DATA(_S_vector_to_list), __f, __warnings);
}

inline __vector2list_info *__trace_vector_to_list_construct()
{
        if (!__profcxx_init()) {
                return 0;
        }
        ...
        return _GLIBCXX_PROFILE_DATA(_S_vector_to_list)->__add_object(__get_stack());
}

inline void __trace_vector_to_list_insert(__vector2list_info *__obj_info, std::size_t __pos,
                                          std::size_t __num)
{
        if (!__obj_info) {
                return;
...
inline void __trace_vector_to_list_iterate(__vector2list_info *__obj_info, int)
{
        if (!__obj_info) {
                return;
        }
...
inline void __trace_vector_to_list_invalid_operator(__vector2list_info *__obj_info)
{
        if (!__obj_info) {
                return;
        }
...
inline void __trace_vector_to_list_resize(__vector2list_info *__obj_info, std::size_t __from,
                                          std::size_t __to)
{
        if (!__obj_info) {
                return;
...
inline void __trace_vector_to_list_destruct(__vector2list_info *__obj_info)
{
        if (!__obj_info) {
                return;
        }
