...
class map : public _GLIBCXX_STD_C::map<_Key, _Tp, _Compare, _Allocator>,
            public _Ordered_profile<map<_Key, _Tp, _Compare, _Allocator>>
{
      ...
      public:
        ...
        explicit map(const _Allocator &__a) : _Base(__a)
        {
        }

        map(const map &__x, const _Allocator &__a) : _Base(__x, __a)
        {
        }
        ...
        map(initializer_list<value_type> __l, const _Allocator &__a) : _Base(__l, __a)
        {
        }
        ...
        template <typename... _Args> std::pair<iterator, bool> emplace(_Args &&...__args)
        {
                ...
                return std::make_pair(iterator(__base_ret.first, this), __base_ret.second);
        }
