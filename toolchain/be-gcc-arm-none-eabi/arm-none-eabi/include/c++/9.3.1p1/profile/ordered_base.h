...
namespace __profile
{
template <typename _Cont> class _Ordered_profile
{
      public:
      ...
      protected:
        ...
        _Ordered_profile(const _Ordered_profile &) noexcept : _Ordered_profile()
        {
        }
        ...
        _Ordered_profile &operator=(const _Ordered_profile &) noexcept
        {
                _M_profile_destruct();
                _M_profile_construct();
        }

        _Ordered_profile &operator=(_Ordered_profile &&__other) noexcept
        {
                _M_swap(__other);
        ...
        void _M_profile_destruct() _GLIBCXX_NOEXCEPT
        {
