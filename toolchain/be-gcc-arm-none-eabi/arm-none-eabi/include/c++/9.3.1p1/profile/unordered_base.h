...
struct _Bucket_index_helper<_UnorderedCont, _Value, true> {
        static std::size_t bucket(const _UnorderedCont &__uc,
...
struct _Bucket_index_helper<_UnorderedCont, std::pair<const _Key, _Mapped>, false> {
...
template <typename _UnorderedCont, typename _Value, bool _Cache_hash_code>
std::size_t __get_bucket_index(const _UnorderedCont &__uc,
...
template <typename _UnorderedCont, typename _Value, bool _Cache_hash_code> struct _Equal_helper;

template <typename _UnorderedCont, typename _Value>
struct _Equal_helper<_UnorderedCont, _Value, true> {
        static std::size_t are_equal(const _UnorderedCont &__uc,
...
template <typename _UnorderedCont, typename _Value, bool _Cache_hash_code>
bool __are_equal(const _UnorderedCont &__uc,
                 const __detail::_Hash_node<_Value, _Cache_hash_code> *__lhs,
                 const __detail::_Hash_node<_Value, _Cache_hash_code> *__rhs)
{
        using __equal_helper = _Equal_helper<_UnorderedCont, _Value, _Cache_hash_code>;
        return __equal_helper::are_equal(__uc, __lhs, __rhs);
}

template <typename _UnorderedCont, bool _Unique_keys> class _Unordered_profile
{
        _UnorderedCont &_M_conjure()
        {
      ...
      protected:
        ...
        _Unordered_profile(const _Unordered_profile &) noexcept : _Unordered_profile()
        {
        }

        _Unordered_profile(_Unordered_profile &&__other) noexcept : _Unordered_profile()
        {
                _M_swap(__other);
        }
        ...
        _Unordered_profile &operator=(const _Unordered_profile &) noexcept
        {
        ...
        _Unordered_profile &operator=(_Unordered_profile &&__other) noexcept
        {
        ...
        {
                auto &__uc = _M_conjure();
                __profcxx_hashtable_size_destruct(_M_size_info, __uc.bucket_count(), __uc.size());
                _M_size_info = 0;
      ...
      private:
        void _M_profile_destruct(std::true_type);

        void _M_profile_destruct(std::false_type);
};

template <typename _UnorderedCont, bool _Unique_keys>
void _Unordered_profile<_UnorderedCont, _Unique_keys>::_M_profile_destruct(std::true_type)
{
        auto &__uc = _M_conjure();
        ...
        __profcxx_hash_func_destruct(_M_hashfunc_info, __lc, __uc.size(), __hops);
}

template <typename _UnorderedCont, bool _Unique_keys>
void _Unordered_profile<_UnorderedCont, _Unique_keys>::_M_profile_destruct(std::false_type)
{
        auto &__uc = _M_conjure();
        ...
        __profcxx_hash_func_destruct(_M_hashfunc_info, __lc, __unique_size, __hops);
}
