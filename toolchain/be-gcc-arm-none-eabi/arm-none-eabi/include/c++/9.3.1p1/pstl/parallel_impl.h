...
_Index __parallel_find(_ExecutionPolicy &&__exec, _Index __first, _Index __last, _Brick __f,
        ...
        __par_backend::__parallel_for(
                ...
                [__comp, __f, __first, &__extremum](_Index __i, _Index __j) {
                        ...
                        if (__comp(__i - __first, __extremum)) {
                                ...
                                // If not '__last' returned then we found what we want so put this
                                // to extremum
                                if (__res != __j) {
...
bool __parallel_or(_ExecutionPolicy &&__exec, _Index __first, _Index __last, _Brick __f)
{
