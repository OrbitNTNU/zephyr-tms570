...
auto __is_vectorization_preferred(_ExecutionPolicy &&__exec) -> decltype(__internal::__lazy_and(
...
template <typename _ExecutionPolicy, typename... _IteratorTypes>
auto __is_parallelization_preferred(_ExecutionPolicy &&__exec) -> decltype(__internal::__lazy_and(
...
template <typename policy, typename... _IteratorTypes> struct __prefer_unsequenced_tag {
        static constexpr bool value =
...
template <typename policy, typename... _IteratorTypes> struct __prefer_parallel_tag {
        static constexpr bool value =
