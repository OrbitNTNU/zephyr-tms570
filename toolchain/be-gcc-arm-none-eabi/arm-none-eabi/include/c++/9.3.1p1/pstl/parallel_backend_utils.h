...
//! Merge sequences [__xs,__xe) and [__ys,__ye) to output sequence [__zs,(__xe-__xs)+(__ye-__ys)),
//! using std::move
template <class _MoveValues, class _MoveSequences> struct __serial_move_merge {
        ...
        explicit __serial_move_merge(std::size_t __nmerge, _MoveValues __move_values,
                ...
                : _M_nmerge(__nmerge), _M_move_values(__move_values),
...
void __init_buf(_RandomAccessIterator1 __xs, _RandomAccessIterator1 __xe, _OutputIterator __zs,
                bool __bMove)
{
...
template <typename _Buf> class __stack
{
