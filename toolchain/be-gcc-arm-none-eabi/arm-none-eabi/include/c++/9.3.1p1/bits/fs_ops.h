...
void copy(const path &__from, const path &__to, copy_options __options, error_code &__ec);
...
inline bool copy_file(const path &__from, const path &__to, error_code &__ec)
{
        return copy_file(__from, __to, copy_options::none, __ec);
}

bool copy_file(const path &__from, const path &__to, copy_options __option);
bool copy_file(const path &__from, const path &__to, copy_options __option, error_code &__ec);
...
inline bool exists(const path &__p)
{
...
inline void permissions(const path &__p, perms __prms, error_code &__ec) noexcept
{
        permissions(__p, __prms, perm_options::replace, __ec);
}

void permissions(const path &__p, perms __prms, perm_options __opts, error_code &__ec) noexcept;
