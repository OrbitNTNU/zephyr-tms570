...
class directory_entry
{
      public:
        ...
        directory_entry(const filesystem::path &__p, error_code &__ec) : _M_path(__p)
        {
                refresh(__ec);
                if (__ec) {
                        _M_path.clear();
      ...
      private:
        ...
        friend basic_ostream<_CharT, _Traits> &operator<<(basic_ostream<_CharT, _Traits> &__os,
                                                          const directory_entry &__d)
        {
                return __os << __d.path();
        }

        directory_entry(const filesystem::path &__p, file_type __t) : _M_path(__p), _M_type(__t)
        {
        }
...
struct __directory_iterator_proxy {
      ...
      private:
        ...
        explicit __directory_iterator_proxy(const directory_entry &__e) : _M_entry(__e)
        {
        }
...
inline recursive_directory_iterator begin(recursive_directory_iterator __iter) noexcept
{
        return __iter;
}
