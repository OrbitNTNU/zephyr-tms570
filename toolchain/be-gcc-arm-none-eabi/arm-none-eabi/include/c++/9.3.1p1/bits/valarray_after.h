...
template <class _Dom> class _GBase
{
      public:
        ...
        _GBase(const _Dom &__e, const valarray<size_t> &__i) : _M_expr(__e), _M_index(__i)
        {
        }
...
template <typename _Tp> class _GBase<_Array<_Tp>>
{
      public:
        ...
        _GBase(_Array<_Tp> __a, const valarray<size_t> &__i) : _M_array(__a), _M_index(__i)
        {
        }
...
template <typename _Tp> struct _GClos<_ValArray, _Tp> : _GBase<_Array<_Tp>> {
...
template <class _Dom> class _IBase
{
      public:
        ...
        _IBase(const _Dom &__e, const valarray<size_t> &__i) : _M_expr(__e), _M_index(__i)
        {
        }
...
template <typename _Tp> struct _IClos<_ValArray, _Tp> : _IBase<valarray<_Tp>> {
        typedef _IBase<valarray<_Tp>> _Base;
        typedef _Tp value_type;

        _IClos(const valarray<_Tp> &__a, const valarray<size_t> &__i) : _Base(__a, __i)
        {
        }
};
} // namespace __detail
...
template <class _Clos, typename _Tp> inline const _Clos &_Expr<_Clos, _Tp>::operator()() const
{
        return _M_closure;
}

template <class _Clos, typename _Tp> inline _Tp _Expr<_Clos, _Tp>::operator[](size_t __i) const
{
...
template <class _Clos, typename _Tp> inline size_t _Expr<_Clos, _Tp>::size() const
{
        return _M_closure.size();
}

template <class _Clos, typename _Tp> inline valarray<_Tp> _Expr<_Clos, _Tp>::shift(int __n) const
{
        valarray<_Tp> __v = valarray<_Tp>(*this).shift(__n);
        return __v;
}

template <class _Clos, typename _Tp> inline valarray<_Tp> _Expr<_Clos, _Tp>::cshift(int __n) const
{
...
template <class _Clos, typename _Tp> inline _Tp _Expr<_Clos, _Tp>::sum() const
{
...
template <class _Clos, typename _Tp> inline _Tp _Expr<_Clos, _Tp>::min() const
{
        return __valarray_min(_M_closure);
}

template <class _Clos, typename _Tp> inline _Tp _Expr<_Clos, _Tp>::max() const
{
...
#define _DEFINE_EXPR_UNARY_OPERATOR(_Op, _Name)                                                    \
        template <class _Dom, typename _Tp>                                                        \
        inline _Expr<_UnClos<_Name, std::_Expr, _Dom>, _Tp> _Expr<_Dom, _Tp>::operator _Op() const \
        {                                                                                          \
...
#define _DEFINE_EXPR_UNARY_FUNCTION(_Name, _UName)                                                 \
        ...
        inline _Expr<_UnClos<_UName, _ValArray, _Tp>, _Tp> _Name(const valarray<_Tp> &__v)         \
        {                                                                                          \
...
#define _DEFINE_EXPR_BINARY_FUNCTION(_Fun, _UFun)                                                  \
        template <class _Dom1, class _Dom2>                                                        \
        inline _Expr<_BinClos<_UFun, _Expr, _Expr, _Dom1, _Dom2>, typename _Dom1::value_type>      \
        ...
        {                                                                                          \
                ...
                return _Expr<_Closure, _Tp>(_Closure(__e1(), __e2()));                             \
                                                                                                   ...
                                                                                                   \
        template <class _Dom>                                                                      \
        inline _Expr<_BinClos<_UFun, _Expr, _ValArray, _Dom, typename _Dom::value_type>,           \
        ...
        {                                                                                          \
                ...
                return _Expr<_Closure, _Tp>(_Closure(__e(), __v));                                 \
                                                                                                   ...
                                                                                                   \
        template <class _Dom>                                                                      \
        inline _Expr<_BinClos<_UFun, _ValArray, _Expr, typename _Dom::value_type, _Dom>,           \
                     typename _Dom::value_type>                                                    \
        ...
        {                                                                                          \
                ...
                return _Expr<_Closure, _Tp>(_Closure(__v, __e()));                                 \
                                                                                                   ...
                                                                                                   \
        template <class _Dom>                                                                      \
        inline _Expr<_BinClos<_UFun, _Expr, _Constant, _Dom, typename _Dom::value_type>,           \
                     typename _Dom::value_type>                                                    \
        _Fun(const _Expr<_Dom, typename _Dom::value_type> &__e,                                    \
             const typename _Dom::value_type &__t)                                                 \
        {                                                                                          \
                ...
                return _Expr<_Closure, _Tp>(_Closure(__e(), __t));                                 \
                                                                                                   ...
                                                                                                   \
        template <class _Dom>                                                                      \
        inline _Expr<_BinClos<_UFun, _Constant, _Expr, typename _Dom::value_type, _Dom>,           \
                     typename _Dom::value_type>                                                    \
        ...
        inline _Expr<_BinClos<_UFun, _ValArray, _Constant, _Tp, _Tp>, _Tp> _Fun(                   \
                const valarray<_Tp> &__v, const typename valarray<_Tp>::value_type &__t)           \
        {                                                                                          \
        ...
        inline _Expr<_BinClos<_UFun, _Constant, _ValArray, _Tp, _Tp>, _Tp> _Fun(                   \
                const typename valarray<_Tp>::value_type &__t, const valarray<_Tp> &__v)           \
        {                                                                                          \
