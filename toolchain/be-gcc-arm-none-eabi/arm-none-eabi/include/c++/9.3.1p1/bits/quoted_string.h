 ...
 */
template <typename _String, typename _CharT> struct _Quoted_string {
...
struct _Quoted_string<basic_string_view<_CharT, _Traits>, _CharT> {
        _Quoted_string(basic_string_view<_CharT, _Traits> __str, _CharT __del, _CharT __esc)
                : _M_string(__str), _M_delim{__del}, _M_escape{__esc}
        {
        }
           ...
           const _Quoted_string<basic_string<_CharT, _Traits, _Alloc> &, _CharT> &__str)
{
        ...
        std::ios_base::fmtflags __flags = __is.flags(__is.flags() & ~std::ios_base::skipws);
        do {
                __is >> __c;
                if (!__is.good()) {
                        break;
