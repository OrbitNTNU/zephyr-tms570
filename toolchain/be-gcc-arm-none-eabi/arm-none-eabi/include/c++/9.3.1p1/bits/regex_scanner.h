...
struct _ScannerBase {
      ...
      protected:
        _ScannerBase(_FlagT __flags)
                : _M_state(_S_state_normal), _M_flags(__flags),
                  ...
                  _M_spec_char(_M_is_ecma()                           ? _M_ecma_spec_char
                               ...
                               : _M_flags & regex_constants::extended ? _M_extended_spec_char
      ...
      protected:
        ...
        {
                return _M_flags &
                       (regex_constants::extended | regex_constants::egrep | regex_constants::awk);
        }
      ...
      protected:
        ...
        const std::pair<char, _TokenT> _M_token_tbl[9] = {
                {'^', _S_token_line_begin}, {'$', _S_token_line_end}, {'.', _S_token_anychar},
                {'*', _S_token_closure0},   {'+', _S_token_closure1}, {'?', _S_token_opt},
 ...
 */
template <typename _CharT> class _Scanner : public _ScannerBase
{
      public:
