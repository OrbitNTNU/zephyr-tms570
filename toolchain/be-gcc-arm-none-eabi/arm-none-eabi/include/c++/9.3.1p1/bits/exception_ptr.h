...
template <typename _Ex> exception_ptr make_exception_ptr(_Ex) _GLIBCXX_USE_NOEXCEPT;
...
class exception_ptr
{
      ...
      public:
        ...
        friend bool operator==(const exception_ptr &, const exception_ptr &) _GLIBCXX_USE_NOEXCEPT
...
bool operator==(const exception_ptr &, const exception_ptr &) _GLIBCXX_USE_NOEXCEPT
        __attribute__((__pure__));
...
template <typename _Ex> exception_ptr make_exception_ptr(_Ex __ex) _GLIBCXX_USE_NOEXCEPT
{
