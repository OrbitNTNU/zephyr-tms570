...
template <typename _Tp> inline bool _Power_of_2(_Tp __x)
{
        return ((__x - 1) & __x) == 0;
}
} // namespace __detail
...
template <typename _IntType = int> class uniform_int_distribution
{
      ...
      public:
        ...
        struct param_type {
                ...
                explicit param_type(_IntType __a, _IntType __b = numeric_limits<_IntType>::max())
                        : _M_a(__a), _M_b(__b)
                {
      ...
      public:
         ...
         * @brief Constructs a uniform distribution object.
         */
        explicit uniform_int_distribution(_IntType __a,
...
uniform_int_distribution<_IntType>::operator()(_UniformRandomNumberGenerator &__urng,
        ...
        if (__urngrange > __urange) {
                ...
                */
                ...
                do {
                        ...
                        __tmp = (__uerngrange * operator()(__urng,
...
template <typename _IntType>
template <typename _ForwardIterator, typename _UniformRandomNumberGenerator>
void uniform_int_distribution<_IntType>::__generate_impl(_ForwardIterator __f, _ForwardIterator __t,
                                                         _UniformRandomNumberGenerator &__urng,
                                                         const param_type &__param)
{
        __glibcxx_function_requires(_ForwardIteratorConcept<_ForwardIterator>) typedef
