...
_GLIBCXX14_CONSTEXPR const _Tp &clamp(const _Tp &, const _Tp &, const _Tp &, _Compare);
#endif
...
template <typename _FIter1, typename _FIter2> bool is_permutation(_FIter1, _FIter1, _FIter2);
...
template <typename _Tp> _GLIBCXX14_CONSTEXPR const _Tp &max(const _Tp &, const _Tp &);
...
template <typename _Tp> _GLIBCXX14_CONSTEXPR const _Tp &min(const _Tp &, const _Tp &);
...
template <typename _Tp, typename _Compare>
_GLIBCXX14_CONSTEXPR pair<const _Tp &, const _Tp &> minmax(const _Tp &, const _Tp &, _Compare);

template <typename _FIter> _GLIBCXX14_CONSTEXPR pair<_FIter, _FIter> minmax_element(_FIter, _FIter);

template <typename _FIter, typename _Compare>
_GLIBCXX14_CONSTEXPR pair<_FIter, _FIter> minmax_element(_FIter, _FIter, _Compare);

template <typename _Tp> _GLIBCXX14_CONSTEXPR _Tp min(initializer_list<_Tp>);

template <typename _Tp, typename _Compare>
_GLIBCXX14_CONSTEXPR _Tp min(initializer_list<_Tp>, _Compare);

template <typename _Tp> _GLIBCXX14_CONSTEXPR _Tp max(initializer_list<_Tp>);

template <typename _Tp, typename _Compare>
_GLIBCXX14_CONSTEXPR _Tp max(initializer_list<_Tp>, _Compare);

template <typename _Tp> _GLIBCXX14_CONSTEXPR pair<_Tp, _Tp> minmax(initializer_list<_Tp>);
...
template <typename _Tp, size_t _Nm> inline void swap(_Tp &__a, _Tp &__b);
...
template <typename _FIter> _GLIBCXX14_CONSTEXPR _FIter max_element(_FIter, _FIter);
...
template <typename _FIter> _GLIBCXX14_CONSTEXPR _FIter min_element(_FIter, _FIter);
