...
class _Node_handle : public _Node_handle_common<_Value, _NodeAlloc>
{
      public:
        ...
        friend void swap(_Node_handle &__x, _Node_handle &__y) noexcept(noexcept(__x.swap(__y)))
        {
                __x.swap(__y);
        }
      ...
      private:
        ...
        const key_type &_M_key() const noexcept
        {
                return key();
        }
...
class _Node_handle<_Value, _Value, _NodeAlloc> : public _Node_handle_common<_Value, _NodeAlloc>
{
      ...
      private:
        ...
        const value_type &_M_key() const noexcept
        {
                return value();
        }
