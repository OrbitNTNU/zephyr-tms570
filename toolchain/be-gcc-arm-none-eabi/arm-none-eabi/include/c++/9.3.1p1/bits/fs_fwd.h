...
constexpr copy_options operator&(copy_options __x, copy_options __y) noexcept
{
        ...
        return static_cast<copy_options>(static_cast<__utype>(__x) & static_cast<__utype>(__y));
}
...
inline copy_options &operator&=(copy_options &__x, copy_options __y) noexcept
{
        return __x = __x & __y;
}
...
constexpr perms operator&(perms __x, perms __y) noexcept
{
        ...
        return static_cast<perms>(static_cast<__utype>(__x) & static_cast<__utype>(__y));
}
...
constexpr perm_options operator&(perm_options __x, perm_options __y) noexcept
{
        ...
        return static_cast<perm_options>(static_cast<__utype>(__x) & static_cast<__utype>(__y));
}
...
inline perm_options &operator&=(perm_options &__x, perm_options __y) noexcept
{
        return __x = __x & __y;
}
...
inline directory_options &operator&=(directory_options &__x, directory_options __y) noexcept
{
        return __x = __x & __y;
}
...
struct __file_clock {
      ...
      protected:
        ...
        static chrono::time_point<__file_clock, _Dur>
        ...
        // For internal use only
        template <typename _Dur>
        static chrono::time_point<__sys_clock, _Dur>
