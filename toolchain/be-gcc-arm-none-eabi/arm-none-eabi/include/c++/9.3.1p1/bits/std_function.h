 ...
 */
template <typename _Tp> struct __is_location_invariant : is_trivially_copyable<_Tp>::type {
};
              ...
              protected:
                static const bool __stored_locally =
                        (__is_location_invariant<_Functor>::value &&
                         sizeof(_Functor) <= _M_max_size && __alignof__(_Functor) <= _M_max_align &&
                                     ...
                                     private _Function_base
{
      ...
      public:
        ...
        /// @overload
        template <typename _Functor> function &operator=(reference_wrapper<_Functor> __f) noexcept
        {
...
template <typename _Functor, typename _Signature = typename __function_guide_helper<
