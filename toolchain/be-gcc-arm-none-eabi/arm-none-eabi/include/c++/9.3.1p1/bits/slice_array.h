...
inline slice::slice(size_t __o, size_t __d, size_t __s) : _M_off(__o), _M_sz(__d), _M_st(__s)
{
}
...
template <typename _Tp> inline void slice_array<_Tp>::operator=(const _Tp &__t) const
{
        std::__valarray_fill(_M_array, _M_sz, _M_stride, __t);
}

template <typename _Tp> inline void slice_array<_Tp>::operator=(const valarray<_Tp> &__v) const
{
...
#define _DEFINE_VALARRAY_OPERATOR(_Op, _Name)                                                      \
        template <typename _Tp>                                                                    \
        inline void slice_array<_Tp>::operator _Op##=(const valarray<_Tp> &__v) const              \
        {                                                                                          \
        ...
        template <typename _Tp>                                                                    \
        template <class _Dom>                                                                      \
        inline void slice_array<_Tp>::operator _Op##=(const _Expr<_Dom, _Tp> &__e) const           \
        {                                                                                          \
