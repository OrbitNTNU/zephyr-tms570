...
{
        std::__valarray_copy(_Array<_Tp>(__a._M_array), _Array<size_t>(__a._M_index),
                             _M_index.size(), _M_array, _Array<size_t>(_M_index));
        return *this;
}

template <typename _Tp> inline void gslice_array<_Tp>::operator=(const _Tp &__t) const
{
        std::__valarray_fill(_M_array, _Array<size_t>(_M_index), _M_index.size(), __t);
}

template <typename _Tp> inline void gslice_array<_Tp>::operator=(const valarray<_Tp> &__v) const
{
...
#define _DEFINE_VALARRAY_OPERATOR(_Op, _Name)                                                      \
        template <typename _Tp>                                                                    \
        inline void gslice_array<_Tp>::operator _Op##=(const valarray<_Tp> &__v) const             \
        {                                                                                          \
                _Array_augmented_##_Name(_M_array, _Array<size_t>(_M_index), _Array<_Tp>(__v),     \
                                         __v.size());                                              \
        }                                                                                          \
                                                                                                   \
        template <typename _Tp>                                                                    \
        template <class _Dom>                                                                      \
        inline void gslice_array<_Tp>::operator _Op##=(const _Expr<_Dom, _Tp> &__e) const          \
        {                                                                                          \
