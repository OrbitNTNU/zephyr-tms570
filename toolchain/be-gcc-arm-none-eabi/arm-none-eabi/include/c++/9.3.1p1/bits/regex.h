...
template <typename, typename> class basic_regex;
...
bool __regex_algo_impl(_BiIter __s, _BiIter __e, match_results<_BiIter, _Alloc> &__m,
 ...
 */
template <typename _Ch_type> struct regex_traits {
      public:
 ...
 */
template <typename _Ch_type, typename _Rx_traits = regex_traits<_Ch_type>> class basic_regex
{
      public:
        ...
        explicit basic_regex(const std::basic_string<_Ch_type, _Ch_traits, _Ch_alloc> &__s,
        ...
        void _M_dot(std::ostream &__ostr)
        {
      ...
      private:
        ...
        template <typename _FwdIter>
        basic_regex(_FwdIter __first, _FwdIter __last, locale_type __loc, flag_type __f)
        ...
        template <typename, typename, typename, bool> friend class __detail::_Executor;
...
template <typename _Ch, typename _Tr>
constexpr regex_constants::syntax_option_type basic_regex<_Ch, _Tr>::ECMAScript;
...
basic_regex(_ForwardIterator, _ForwardIterator, regex_constants::syntax_option_type = {})
...
inline void swap(basic_regex<_Ch_type, _Rx_traits> &__lhs, basic_regex<_Ch_type, _Rx_traits> &__rhs)
{
        __lhs.swap(__rhs);
}
 ...
 */
template <typename _BiIter> class sub_match : public std::pair<_BiIter, _BiIter>
{
...
inline bool operator==(const sub_match<_BiIter> &__lhs, const sub_match<_BiIter> &__rhs)
{
...
using __sub_match_string =
        basic_string<typename iterator_traits<_Bi_iter>::value_type, _Ch_traits, _Ch_alloc>;
 ...
 */
template <typename _Bi_iter, typename _Ch_traits, typename _Ch_alloc>
inline bool operator==(const __sub_match_string<_Bi_iter, _Ch_traits, _Ch_alloc> &__lhs,
 ...
 */
template <typename _Bi_iter, typename _Ch_traits, typename _Ch_alloc>
inline bool operator==(const sub_match<_Bi_iter> &__lhs,
...
inline bool operator==(typename iterator_traits<_Bi_iter>::value_type const *__lhs,
                       const sub_match<_Bi_iter> &__rhs)
{
...
inline basic_ostream<_Ch_type, _Ch_traits> &operator<<(basic_ostream<_Ch_type, _Ch_traits> &__os,
...
class match_results : private std::vector<sub_match<_Bi_iter>, _Alloc>
{
      ...
      public:
        ...
        const_reference operator[](size_type __sub) const
        {
                ...
                return __sub < size() ? _Base_type::operator[](__sub) : _M_unmatched_sub();
        }
        ...
        _Out_iter format(_Out_iter __out, const char_type *__fmt_first, const char_type *__fmt_last,
        ...
        _Out_iter format(_Out_iter __out, const basic_string<char_type, _St, _Sa> &__fmt,
                         match_flag_type __flags = regex_constants::format_default) const
        {
      ...
      private:
        ...
        template <typename, typename, typename> friend class regex_iterator;
                       ...
                       const match_results<_Bi_iter, _Alloc> &__m2) noexcept
{
        ...
        return __m1.prefix() == __m2.prefix() && __m1.size() == __m2.size() &&
               std::equal(__m1.begin(), __m1.end(), __m2.begin()) && __m1.suffix() == __m2.suffix();
}
...
inline bool regex_match(_Bi_iter __s, _Bi_iter __e, match_results<_Bi_iter, _Alloc> &__m,
...
inline bool regex_match(const _Ch_type *__s, match_results<const _Ch_type *, _Alloc> &__m,
                        const basic_regex<_Ch_type, _Rx_traits> &__re,
 ...
 * @throws an exception of type regex_error.
 */
template <typename _Ch_traits, typename _Ch_alloc, typename _Alloc, typename _Ch_type,
          typename _Rx_traits>
inline bool
...
inline bool regex_match(const _Ch_type *__s, const basic_regex<_Ch_type, _Rx_traits> &__re,
                        regex_constants::match_flag_type __f = regex_constants::match_default)
{
...
inline bool regex_match(const basic_string<_Ch_type, _Ch_traits, _Str_allocator> &__s,
                        const basic_regex<_Ch_type, _Rx_traits> &__re,
                        regex_constants::match_flag_type __flags = regex_constants::match_default)
{
 ...
 */
template <typename _Bi_iter, typename _Alloc, typename _Ch_type, typename _Rx_traits>
inline bool regex_search(_Bi_iter __s, _Bi_iter __e, match_results<_Bi_iter, _Alloc> &__m,
                         const basic_regex<_Ch_type, _Rx_traits> &__re,
                         regex_constants::match_flag_type __flags = regex_constants::match_default)
{
        return __detail::__regex_algo_impl<_Bi_iter, _Alloc, _Ch_type, _Rx_traits,
...
inline bool regex_search(const _Ch_type *__s, match_results<const _Ch_type *, _Alloc> &__m,
 ...
 */
template <typename _Ch_type, typename _Rx_traits>
inline bool regex_search(const _Ch_type *__s, const basic_regex<_Ch_type, _Rx_traits> &__e,
                         regex_constants::match_flag_type __f = regex_constants::match_default)
{
...
inline bool regex_search(const basic_string<_Ch_type, _Ch_traits, _String_allocator> &__s,
                         const basic_regex<_Ch_type, _Rx_traits> &__e,
                         regex_constants::match_flag_type __flags = regex_constants::match_default)
{
...
regex_replace(const _Ch_type *__s, const basic_regex<_Ch_type, _Rx_traits> &__e,
              const basic_string<_Ch_type, _St, _Sa> &__fmt,
              regex_constants::match_flag_type __flags = regex_constants::match_default)
{
        basic_string<_Ch_type> __result;
        regex_replace(std::back_inserter(__result), __s, __s + char_traits<_Ch_type>::length(__s),
                      __e, __fmt, __flags);
        return __result;
}
...
class regex_token_iterator
{
      ...
      public:
        ...
        regex_token_iterator(_Bi_iter __a, _Bi_iter __b, const regex_type &__re,
                             ...
                             regex_constants::match_flag_type __m = regex_constants::match_default)
                : _M_position(__a, __b, __re, __m), _M_subs(__submatches, __submatches + _Nm),
                  _M_n(0)
        {
                _M_init(__a, __b);
        }
        ...
        regex_token_iterator(_Bi_iter, _Bi_iter, const regex_type &&, int = 0,
                ...
                delete;
        regex_token_iterator(_Bi_iter, _Bi_iter, const regex_type &&, const std::vector<int> &,
                             regex_constants::match_flag_type = regex_constants::match_default) =
                delete;
        regex_token_iterator(_Bi_iter, _Bi_iter, const regex_type &&, initializer_list<int>,
                             regex_constants::match_flag_type = regex_constants::match_default) =
                delete;
        template <std::size_t _Nm>
        regex_token_iterator(_Bi_iter, _Bi_iter, const regex_type &&, const int (&)[_Nm],
                             regex_constants::match_flag_type = regex_constants::match_default) =
                delete;
      ...
      private:
        ...
        constexpr bool _M_end_of_seq() const
        {
