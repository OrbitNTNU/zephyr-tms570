 ...
 */
_GLIBCXX17_INLINE constexpr syntax_option_type awk = static_cast<syntax_option_type>(1 << _S_awk);
 ...
 * as whitespace.
 */
_GLIBCXX17_INLINE constexpr syntax_option_type grep = static_cast<syntax_option_type>(1 << _S_grep);
...
constexpr inline syntax_option_type operator&(syntax_option_type __a, syntax_option_type __b)
{
...
inline syntax_option_type &operator&=(syntax_option_type &__a, syntax_option_type __b)
{
        return __a = __a & __b;
}
 ...
 */
_GLIBCXX17_INLINE constexpr match_flag_type match_default = static_cast<match_flag_type>(0);
 ...
 * result.
 */
_GLIBCXX17_INLINE constexpr match_flag_type match_any = static_cast<match_flag_type>(1 << _S_any);
 ...
 */
_GLIBCXX17_INLINE constexpr match_flag_type format_default = static_cast<match_flag_type>(0);
 ...
 */
_GLIBCXX17_INLINE constexpr match_flag_type format_sed = static_cast<match_flag_type>(1 << _S_sed);
...
constexpr inline match_flag_type operator&(match_flag_type __a, match_flag_type __b)
{
        return (match_flag_type)(static_cast<unsigned int>(__a) & static_cast<unsigned int>(__b));
}
...
inline match_flag_type &operator&=(match_flag_type &__a, match_flag_type __b)
{
        return __a = __a & __b;
}
