...
class locale
{
      ...
      private:
        ...
        enum {
                _S_categories_size = 6 + _GLIBCXX_NUM_CATEGORIES
        };
 ...
 *  collate facet.
 */
template <typename _CharT> class _GLIBCXX_NAMESPACE_CXX11 collate : public locale::facet
{
      public:
        // Types:
        //@{
...
template <typename _CharT> class _GLIBCXX_NAMESPACE_CXX11 collate_byname : public collate<_CharT>
{
      public:
        //@{
        /// Public typedefs
