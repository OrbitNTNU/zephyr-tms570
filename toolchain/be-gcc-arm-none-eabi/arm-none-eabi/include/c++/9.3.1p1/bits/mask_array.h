...
template <typename _Tp> inline void mask_array<_Tp>::operator=(const _Tp &__t) const
{
        std::__valarray_fill(_M_array, _M_sz, _M_mask, __t);
}

template <typename _Tp> inline void mask_array<_Tp>::operator=(const valarray<_Tp> &__v) const
{
...
#define _DEFINE_VALARRAY_OPERATOR(_Op, _Name)                                                      \
        template <typename _Tp>                                                                    \
        inline void mask_array<_Tp>::operator _Op##=(const valarray<_Tp> &__v) const               \
        {                                                                                          \
        ...
        template <typename _Tp>                                                                    \
        template <class _Dom>                                                                      \
        inline void mask_array<_Tp>::operator _Op##=(const _Expr<_Dom, _Tp> &__e) const            \
        {                                                                                          \
