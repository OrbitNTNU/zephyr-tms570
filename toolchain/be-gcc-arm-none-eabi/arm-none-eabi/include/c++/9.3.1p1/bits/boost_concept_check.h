...
#define _GLIBCXX_CLASS_REQUIRES(_type_var, _ns, _concept)                                          \
        ...
        template <_func##_type_var##_concept _Tp1> struct _concept_checking##_type_var##_concept { \
        };                                                                                         \
        typedef _concept_checking##_type_var##_concept<&_ns::_concept<_type_var>::__constraints>   \
...
#define _GLIBCXX_CLASS_REQUIRES4(_type_var1, _type_var2, _type_var3, _type_var4, _ns, _concept)    \
        typedef void (_ns::_concept<_type_var1, _type_var2, _type_var3, _type_var4>::*             \
...
template <class _Tp1, class _Tp2> struct _Aux_require_same {
};

template <class _Tp> struct _Aux_require_same<_Tp, _Tp> {
        typedef _Tp _Type;
};

template <class _Tp1, class _Tp2> struct _SameTypeConcept {
        void __constraints()
        {
...
template <class _Tp> struct _IntegerConcept {
        void __constraints()
        {
...
template <class _Tp> struct _SignedIntegerConcept {
        void __constraints()
        {
...
template <class _Tp> struct _UnsignedIntegerConcept {
        void __constraints()
        {
...
template <class _Tp> struct _DefaultConstructibleConcept {
        void __constraints()
        {
...
template <class _Tp> struct _AssignableConcept {
        void __constraints()
        {
...
template <class _Tp> struct _CopyConstructibleConcept {
        void __constraints()
        {
...
template <class _Tp> struct _SGIAssignableConcept {
        void __constraints()
        {
...
template <class _From, class _To> struct _ConvertibleConcept {
        void __constraints()
        {
...
// FIXME
template <class _Tp> struct _EqualityComparableConcept {
        void __constraints()
        {
...
template <class _Tp> struct _LessThanComparableConcept {
        void __constraints()
        {
                __aux_require_boolean_expr(__a < __b);
        }
...
template <class _Tp> struct _ComparableConcept {
        void __constraints()
        {
                __aux_require_boolean_expr(__a < __b);
                __aux_require_boolean_expr(__a > __b);
...
#define _GLIBCXX_DEFINE_BINARY_PREDICATE_OP_CONSTRAINT(_OP, _NAME)                                 \
        template <class _First, class _Second> struct _NAME {                                      \
                void __constraints()                                                               \
                {                                                                                  \
                        (void)__constraints_();                                                    \
                }                                                                                  \
...
#define _GLIBCXX_DEFINE_BINARY_OPERATOR_CONSTRAINT(_OP, _NAME)                                     \
        template <class _Ret, class _First, class _Second> struct _NAME {                          \
                void __constraints()                                                               \
                {                                                                                  \
                        (void)__constraints_();                                                    \
                }                                                                                  \
...
template <class _Func, class _Return> struct _GeneratorConcept {
        void __constraints()
        {
...
template <class _Func> struct _GeneratorConcept<_Func, void> {
        void __constraints()
        {
...
template <class _Func, class _Return, class _Arg> struct _UnaryFunctionConcept {
        void __constraints()
        {
...
template <class _Func, class _Arg> struct _UnaryFunctionConcept<_Func, void, _Arg> {
        void __constraints()
        {
...
template <class _Func, class _Return, class _First, class _Second> struct _BinaryFunctionConcept {
        void __constraints()
        {
...
template <class _Func, class _Arg> struct _UnaryPredicateConcept {
        void __constraints()
        {
...
template <class _Func, class _First, class _Second> struct _BinaryPredicateConcept {
        void __constraints()
        {
...
template <class _Func, class _First, class _Second> struct _Const_BinaryPredicateConcept {
        void __constraints()
        {
...
template <class _Tp> struct _TrivialIteratorConcept {
        void __constraints()
        {
...
template <class _Tp> struct _Mutable_TrivialIteratorConcept {
        void __constraints()
        {
...
template <class _Tp> struct _InputIteratorConcept {
        void __constraints()
        {
                __function_requires<_TrivialIteratorConcept<_Tp>>();
                ...
                __function_requires<
                        _ConvertibleConcept<typename std::iterator_traits<_Tp>::iterator_category,
...
template <class _Tp, class _ValueT> struct _OutputIteratorConcept {
        void __constraints()
        {
                __function_requires<_AssignableConcept<_Tp>>();
                ++__i;        // require preincrement operator
...
template <class _Tp> struct _ForwardIteratorConcept {
        void __constraints()
        {
...
template <class _Tp> struct _Mutable_ForwardIteratorConcept {
        void __constraints()
        {
...
template <class _Tp> struct _BidirectionalIteratorConcept {
        void __constraints()
        {
                __function_requires<_ForwardIteratorConcept<_Tp>>();
                __function_requires<
...
template <class _Tp> struct _Mutable_BidirectionalIteratorConcept {
        void __constraints()
        {
...
template <class _Tp> struct _RandomAccessIteratorConcept {
        void __constraints()
        {
                __function_requires<_BidirectionalIteratorConcept<_Tp>>();
...
template <class _Tp> struct _Mutable_RandomAccessIteratorConcept {
        void __constraints()
        {
...
template <class _Container> struct _ContainerConcept {
...
template <class _Container> struct _Mutable_ContainerConcept {
        typedef typename _Container::value_type _Value_type;
...
template <class _ForwardContainer> struct _ForwardContainerConcept {
        void __constraints()
        {
...
template <class _ForwardContainer> struct _Mutable_ForwardContainerConcept {
        void __constraints()
        {
...
template <class _ReversibleContainer> struct _ReversibleContainerConcept {
...
template <class _ReversibleContainer> struct _Mutable_ReversibleContainerConcept {
...
template <class _RandomAccessContainer> struct _RandomAccessContainerConcept {
...
template <class _RandomAccessContainer> struct _Mutable_RandomAccessContainerConcept {
        typedef typename _RandomAccessContainer::size_type _Size_type;
...
template <class _Sequence> struct _SequenceConcept {
...
template <class _FrontInsertionSequence> struct _FrontInsertionSequenceConcept {
        void __constraints()
        {
...
template <class _BackInsertionSequence> struct _BackInsertionSequenceConcept {
