...
class multimap
{
      ...
      public:
         ...
         */
        void swap(multimap &__x) _GLIBCXX_NOEXCEPT_IF(__is_nothrow_swappable<_Compare>::value)
        {
                _M_t.swap(__x._M_t);
        }
...
struct _Rb_tree_merge_helper<_GLIBCXX_STD_C::multimap<_Key, _Val, _Cmp1, _Alloc>, _Cmp2> {
      private:
