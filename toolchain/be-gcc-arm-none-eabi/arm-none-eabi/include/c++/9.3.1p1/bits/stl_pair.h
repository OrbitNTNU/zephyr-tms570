...
/// piecewise_construct
_GLIBCXX17_INLINE constexpr piecewise_construct_t piecewise_construct = piecewise_construct_t();
...
template <bool, typename _T1, typename _T2> struct _PCC {
        ...
        template <bool __implicit, typename _U1, typename _U2> static constexpr bool _CopyMovePair()
        {
                ...
                return __and_<is_constructible<_T1, const _U1 &>, is_constructible<_T2, _U2 &&>,
                              __converts>::value;
        }
        ...
        template <bool __implicit, typename _U1, typename _U2> static constexpr bool _MoveCopyPair()
        {
                ...
                using __converts = typename conditional<__implicit, __do_converts,
                                                        __not_<__do_converts>>::type;
                return __and_<is_constructible<_T1, _U1 &&>, is_constructible<_T2, const _U2 &&>,
                              __converts>::value;
        }
};
...
template <typename _T1, typename _T2> struct pair : private __pair_base<_T1, _T2> {
        ...
        template <typename _U1, typename _U2,
                  typename enable_if<
                          _PCCFP<_U1, _U2>::template _MoveConstructiblePair<_U1, _U2>() &&
                                  _PCCFP<_U1, _U2>::template _ImplicitlyMoveConvertiblePair<_U1,
                                                                                            _U2>(),
                          bool>::type = true>
        ...
        pair &operator=(typename conditional<
                        __and_<is_move_assignable<_T1>, is_move_assignable<_T2>>::value, pair &&,
        ...
        template <typename _U1, typename _U2>
        typename enable_if<
                __and_<is_assignable<_T1 &, const _U1 &>, is_assignable<_T2 &, const _U2 &>>::value,
                pair &>::type
...
inline _GLIBCXX_CONSTEXPR bool operator==(const pair<_T1, _T2> &__x, const pair<_T1, _T2> &__y)
{
...
#else
template <typename _T1, typename _T2> inline pair<_T1, _T2> make_pair(_T1 __x, _T2 __y)
{
