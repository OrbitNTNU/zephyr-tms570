...
template <typename _CharT> struct char_traits {
        ...
        static _GLIBCXX_CONSTEXPR bool eq(const char_type &__c1, const char_type &__c2)
        {
                return __c1 == __c2;
        }

        static _GLIBCXX_CONSTEXPR bool lt(const char_type &__c1, const char_type &__c2)
        {
                return __c1 < __c2;
        }
        ...
        static _GLIBCXX_CONSTEXPR bool eq_int_type(const int_type &__c1, const int_type &__c2)
        {
                return __c1 == __c2;
        }
...
_GLIBCXX14_CONSTEXPR int char_traits<_CharT>::compare(const char_type *__s1, const char_type *__s2,
                                                      std::size_t __n)
{
...
template <typename _CharT>
_GLIBCXX14_CONSTEXPR std::size_t char_traits<_CharT>::length(const char_type *__p)
{
        std::size_t __i = 0;
...
template <typename _CharT>
typename char_traits<_CharT>::char_type *char_traits<_CharT>::assign(char_type *__s,
 ...
 */
template <typename _CharT>
static _GLIBCXX_ALWAYS_INLINE constexpr bool __constant_string_p(const _CharT *__s)
{
 ...
 */
template <typename _CharT>
static _GLIBCXX_ALWAYS_INLINE constexpr bool __constant_char_array_p(const _CharT *__a, size_t __n)
{
#ifdef _GLIBCXX_HAVE_BUILTIN_IS_CONSTANT_EVALUATED
        (void)__a;
        (void)__n;
...
template <> struct char_traits<char> {
        ...
        static _GLIBCXX17_CONSTEXPR int compare(const char_type *__s1, const char_type *__s2,
                                                size_t __n)
        {
                if (__n == 0) {
                        return 0;
        ...
        static _GLIBCXX17_CONSTEXPR const char_type *find(const char_type *__s, size_t __n,
                                                          const char_type &__a)
        {
                if (__n == 0) {
                        return 0;
        ...
        static _GLIBCXX_CONSTEXPR char_type to_char_type(const int_type &__c) _GLIBCXX_NOEXCEPT
        {
                return static_cast<char_type>(__c);
        }
        ...
        static _GLIBCXX_CONSTEXPR int_type to_int_type(const char_type &__c) _GLIBCXX_NOEXCEPT
        {
        ...
        static _GLIBCXX_CONSTEXPR int_type not_eof(const int_type &__c) _GLIBCXX_NOEXCEPT
        {
