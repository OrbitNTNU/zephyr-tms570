...
template <typename _Tp, typename _Alloc> class _List_base
{
      protected:
        ...
        struct _List_impl : public _Node_alloc_type {
                ...
                _List_impl(const _Node_alloc_type &__a) _GLIBCXX_NOEXCEPT : _Node_alloc_type(__a)
                {
                }
                ...
                _List_impl(_Node_alloc_type &&__a) noexcept : _Node_alloc_type(std::move(__a))
                {
                }
#endif
        };
...
class list : protected _List_base<_Tp, _Alloc>
{
      ...
      private:
        ...
        list(list &&__x, const allocator_type &__a, false_type) : _Base(_Node_alloc_type(__a))
        {
      ...
      public:
        list(list &&__x, const allocator_type &__a) noexcept(_Node_alloc_traits::_S_always_equal())
                : list(std::move(__x), __a, typename _Node_alloc_traits::is_always_equal{})
        {
        }
#endif
...
#define _GLIBCXX_LIST_REMOVE_RETURN_TYPE_TAG __attribute__((__abi_tag__("__cxx20")))
#else
...
inline ptrdiff_t __distance(_GLIBCXX_STD_C::_List_iterator<_Tp> __first,
                            _GLIBCXX_STD_C::_List_iterator<_Tp> __last, input_iterator_tag __tag)
{
...
inline ptrdiff_t __distance(_GLIBCXX_STD_C::_List_const_iterator<_Tp> __first,
                            _GLIBCXX_STD_C::_List_const_iterator<_Tp> __last, input_iterator_tag)
{
