 ...
 */
template <typename _Tp, typename _Compare> class _LoserTreeBase
{
      protected:
...
class _LoserTree : public _LoserTreeBase<_Tp, _Compare>
{
      ...
      public:
        _LoserTree(unsigned int __k, _Compare __comp) : _Base::_LoserTreeBase(__k, __comp)
        {
        }
        ...
        void __delete_min_insert(_Tp __key, bool __sup)
        {
                ...
                for (unsigned int __pos = (_M_k + __source) / 2; __pos > 0; __pos /= 2) {
                        ...
                        if ((__sup &&
                             (!_M_losers[__pos]._M_sup || _M_losers[__pos]._M_source < __source)) ||
...
class _LoserTree</* __stable == */ false, _Tp, _Compare> : public _LoserTreeBase<_Tp, _Compare>
{
        typedef _LoserTreeBase<_Tp, _Compare> _Base;
        using _Base::_M_comp;
        using _Base::_M_first_insert;
      ...
      public:
        ...
        void __delete_min_insert(_Tp __key, bool __sup)
        {
                ...
                for (unsigned int __pos = (_M_k + __source) / 2; __pos > 0; __pos /= 2) {
                        ...
                        if (__sup ||
                            (!_M_losers[__pos]._M_sup && _M_comp(_M_losers[__pos]._M_key, __key))) {
                                // The other one is smaller.
                                std::swap(_M_losers[__pos]._M_sup, __sup);
                                std::swap(_M_losers[__pos]._M_source, __source);
                                swap(_M_losers[__pos]._M_key, __key);
 ...
 */
template <typename _Tp, typename _Compare> class _LoserTreePointerBase
{
      protected:
 ...
 */
template <typename _Tp, typename _Compare> class _LoserTreeUnguardedBase
{
      protected:
        struct _Loser {
                int _M_source;
 ...
 */
template <typename _Tp, typename _Compare> class _LoserTreePointerUnguardedBase
{
      protected:
        struct _Loser {
                int _M_source;
 ...
 */
template <bool __stable /* default == true */, typename _Tp, typename _Compare>
class _LoserTreePointerUnguarded : public _LoserTreePointerUnguardedBase<_Tp, _Compare>
{
