...
inline std::pair<_RAIter1, _RAIter2> __find_template(_RAIter1 __begin1, _RAIter1 __end1,
 ...
 */
template <typename _RAIter1, typename _RAIter2, typename _Pred, typename _Selector>
std::pair<_RAIter1, _RAIter2> __find_template(_RAIter1 __begin1, _RAIter1 __end1, _RAIter2 __begin2,
...
#pragma omp flush(__result)
        ...
        return std::pair<_RAIter1, _RAIter2>(__begin1 + __result, __begin2 + __result);
}
                                              ...
                                              growing_blocks_tag)
{
        ...
        std::pair<_RAIter1, _RAIter2> __find_seq_result = __selector._M_sequential_algorithm(
