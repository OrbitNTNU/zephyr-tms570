...
struct default_parallel_tag : public parallel_tag {
        ...
        default_parallel_tag(_ThreadIndex __num_threads) : parallel_tag(__num_threads)
        {
        }
};
...
struct multiway_mergesort_tag : public parallel_tag {
        ...
        multiway_mergesort_tag(_ThreadIndex __num_threads) : parallel_tag(__num_threads)
        {
        }
};
...
struct multiway_mergesort_exact_tag : public parallel_tag {
        ...
        multiway_mergesort_exact_tag(_ThreadIndex __num_threads) : parallel_tag(__num_threads)
        {
        }
};
...
struct multiway_mergesort_sampling_tag : public parallel_tag {
        ...
        multiway_mergesort_sampling_tag(_ThreadIndex __num_threads) : parallel_tag(__num_threads)
        {
        }
};
...
struct balanced_quicksort_tag : public parallel_tag {
        ...
        balanced_quicksort_tag(_ThreadIndex __num_threads) : parallel_tag(__num_threads)
        {
        }
};
