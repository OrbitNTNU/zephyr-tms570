...
struct __sFILE {
        ...
        _READ_WRITE_RETURN_TYPE (*_read)(struct _reent *, void *, char *, _READ_WRITE_BUFSIZE_TYPE);
...
#define _REENT_INIT(var)                                                                           \
        {                                                                                          \
                0, &__sf[0], &__sf[1], &__sf[2], 0, _NULL, 0, 0, _NULL, _NULL, _NULL, 0, 0, _NULL, \
                        _NULL, _NULL, _NULL, _NULL, _REENT_INIT_ATEXIT{_NULL, 0, _NULL}, _NULL,    \
                        _NULL, _NULL                                                               \
        }
...
#include <assert.h>
#define __reent_assert(x)                                                                          \
        ((x) ? (void)0 : __assert_func(__FILE__, __LINE__, (char *)0, "REENT malloc succeeded"))
#else
...
#define _REENT_INIT(var)                                                                           \
        {                                                                                          \
                0, _REENT_STDIO_STREAM(&(var), 0), _REENT_STDIO_STREAM(&(var), 1),                 \
                        _REENT_STDIO_STREAM(&(var), 2), 0, "", 0, _NULL, 0, _NULL, _NULL, 0,       \
                        _NULL, _NULL, 0, _NULL,                                                    \
                        {{0,                                                                       \
                          _NULL,                                                                   \
                          "",                                                                      \
